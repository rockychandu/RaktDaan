"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - ImmuneComplexRejection (3).
...
class RheumatologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Rheumatology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Rheumatology ImmuneComplexRejection Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Rheumatology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_rheumatology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("rheumatology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("rheumatology_immunecomplexrejection_lab_marker", 10.0)
