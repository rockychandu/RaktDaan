"""
Enterprise Clinical Screening & Medical Rule Engine: Urology - EndemicTravelExposure (3).
...
class UrologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Urology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_UROLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Urology EndemicTravelExposure Screening Rule #3"
    category = "UROLOGY"
