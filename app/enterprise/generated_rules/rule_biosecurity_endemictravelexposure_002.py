"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - EndemicTravelExposure (2).
...
class BiosecurityEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Biosecurity (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Biosecurity EndemicTravelExposure Screening Rule #2"
