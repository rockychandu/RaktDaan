"""
Clinical Rule Processor for Immunology - Scleroderma.
...
class SclerodermaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Scleroderma.
    """
    rule_code = "RULE_IMMUNOLOGY_SCLERODERMA"
    rule_name = "Scleroderma Screening Rule"
    category = "IMMUNOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_scleroderma", False)
        is_active = data.get("is_scleroderma_active", False)
        years_cured = data.get("years_cured_scleroderma", 0.0)
