"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - PathogenTransmissionRisk (3).
...
class HematologyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Hematology PathogenTransmissionRisk Screening Rule #3"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_hematology_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("hematology_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_pathogentransmissionrisk_lab_marker", 10.0)
