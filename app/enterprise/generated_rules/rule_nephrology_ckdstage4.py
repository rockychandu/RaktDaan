"""
Clinical Rule Processor for Nephrology - CKDStage4.
...
class CKDStage4ClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CKDStage4.
    """
    rule_code = "RULE_NEPHROLOGY_CKDSTAGE4"
    rule_name = "CKDStage4 Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ckdstage4", False)
        is_active = data.get("is_ckdstage4_active", False)
        years_cured = data.get("years_cured_ckdstage4", 0.0)
