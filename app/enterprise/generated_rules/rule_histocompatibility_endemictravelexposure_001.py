"""
Enterprise Clinical Screening & Medical Rule Engine: Histocompatibility - EndemicTravelExposure (1).
...
class HistocompatibilityEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Histocompatibility (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HISTOCOMPATIBILITY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Histocompatibility EndemicTravelExposure Screening Rule #1"
