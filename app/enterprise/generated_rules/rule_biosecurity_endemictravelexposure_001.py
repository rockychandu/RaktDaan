"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - EndemicTravelExposure (1).
...
class BiosecurityEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Biosecurity (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Biosecurity EndemicTravelExposure Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Biosecurity (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_biosecurity_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("biosecurity_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("biosecurity_endemictravelexposure_lab_marker", 10.0)
