"""
Clinical Rule Processor for Infectious - EbolaVirus.
...
class EbolaVirusClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for EbolaVirus.
    """
    rule_code = "RULE_INFECTIOUS_EBOLAVIRUS"
    rule_name = "EbolaVirus Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ebolavirus", False)
        is_active = data.get("is_ebolavirus_active", False)
        years_cured = data.get("years_cured_ebolavirus", 0.0)
