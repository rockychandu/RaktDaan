"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - MedicationTherapy (3).
...
class OphthalmologyMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Ophthalmology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_MEDICATIONTHERAPY_003"
    rule_name = "Ophthalmology MedicationTherapy Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Ophthalmology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_ophthalmology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("ophthalmology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("ophthalmology_medicationtherapy_lab_marker", 10.0)
