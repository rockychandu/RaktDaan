"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - PathogenTransmissionRisk (3).
...
class ClinicalPathologyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating ClinicalPathology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "ClinicalPathology PathogenTransmissionRisk Screening Rule #3"
