"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - ImmuneComplexRejection (1).
...
class OtolaryngologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Otolaryngology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Otolaryngology ImmuneComplexRejection Screening Rule #1"
