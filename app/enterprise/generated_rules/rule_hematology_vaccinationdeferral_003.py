"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - VaccinationDeferral (3).
...
class HematologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Hematology VaccinationDeferral Screening Rule #3"
    category = "HEMATOLOGY"
