"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - PostOperativeRecovery (2).
...
class GastroenterologyPostOperativeRecoveryClinicalProcessor2:
    """
    Detailed decision processor evaluating Gastroenterology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_POSTOPERATIVERECOVERY_002"
    rule_name = "Gastroenterology PostOperativeRecovery Screening Rule #2"
