"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - ImmuneComplexRejection (1).
...
class HemovigilanceImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Hemovigilance (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Hemovigilance ImmuneComplexRejection Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hemovigilance (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_hemovigilance_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("hemovigilance_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hemovigilance_immunecomplexrejection_lab_marker", 10.0)
