"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - SurgicalIntervention (2).
...
class ClinicalPathologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating ClinicalPathology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_SURGICALINTERVENTION_002"
    rule_name = "ClinicalPathology SurgicalIntervention Screening Rule #2"
