"""
Enterprise Clinical Screening & Medical Rule Engine: Toxicology - HemodynamicsAssessment (3).
...
class ToxicologyHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Toxicology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TOXICOLOGY_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Toxicology HemodynamicsAssessment Screening Rule #3"
    category = "TOXICOLOGY"
