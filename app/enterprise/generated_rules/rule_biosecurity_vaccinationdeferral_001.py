"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - VaccinationDeferral (1).
...
class BiosecurityVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Biosecurity (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_VACCINATIONDEFERRAL_001"
    rule_name = "Biosecurity VaccinationDeferral Screening Rule #1"
