"""
Clinical Rule Processor for Hematology - AplasticAnemia.
...
class AplasticAnemiaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for AplasticAnemia.
    """
    rule_code = "RULE_HEMATOLOGY_APLASTICANEMIA"
    rule_name = "AplasticAnemia Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_aplasticanemia", False)
        is_active = data.get("is_aplasticanemia_active", False)
        years_cured = data.get("years_cured_aplasticanemia", 0.0)
