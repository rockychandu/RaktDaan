"""
Clinical Rule Processor for Surgery - TissueGraft.
...
class TissueGraftClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for TissueGraft.
    """
    rule_code = "RULE_SURGERY_TISSUEGRAFT"
    rule_name = "TissueGraft Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_tissuegraft", False)
        is_active = data.get("is_tissuegraft_active", False)
        years_cured = data.get("years_cured_tissuegraft", 0.0)
