"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - MedicationTherapy (2).
...
class ImmunologyMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Immunology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_MEDICATIONTHERAPY_002"
    rule_name = "Immunology MedicationTherapy Screening Rule #2"
    category = "IMMUNOLOGY"
