"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - PediatricSafetyProtocol (3).
...
class OncologyPediatricSafetyProtocolClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_PEDIATRICSAFETYPROTOCOL_003"
    rule_name = "Oncology PediatricSafetyProtocol Screening Rule #3"
    category = "ONCOLOGY"
