"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - EndemicTravelExposure (1).
...
class HemovigilanceEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Hemovigilance (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Hemovigilance EndemicTravelExposure Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hemovigilance (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_hemovigilance_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("hemovigilance_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hemovigilance_endemictravelexposure_lab_marker", 10.0)
