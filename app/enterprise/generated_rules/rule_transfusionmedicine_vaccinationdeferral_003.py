"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - VaccinationDeferral (3).
...
class TransfusionMedicineVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating TransfusionMedicine (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_VACCINATIONDEFERRAL_003"
    rule_name = "TransfusionMedicine VaccinationDeferral Screening Rule #3"
