"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - EndemicTravelExposure (3).
...
class OtolaryngologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Otolaryngology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Otolaryngology EndemicTravelExposure Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Otolaryngology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_otolaryngology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("otolaryngology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("otolaryngology_endemictravelexposure_lab_marker", 10.0)
