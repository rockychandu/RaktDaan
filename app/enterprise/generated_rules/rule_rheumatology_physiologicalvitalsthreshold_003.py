"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - PhysiologicalVitalsThreshold (3).
...
class RheumatologyPhysiologicalVitalsThresholdClinicalProcessor3:
    """
    Detailed decision processor evaluating Rheumatology (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_PHYSIOLOGICALVITALSTHRESHOLD_003"
    rule_name = "Rheumatology PhysiologicalVitalsThreshold Screening Rule #3"
