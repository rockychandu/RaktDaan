"""
Clinical Rule Processor for Pharmacology - Apixaban.
...
class ApixabanClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Apixaban.
    """
    rule_code = "RULE_PHARMACOLOGY_APIXABAN"
    rule_name = "Apixaban Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_apixaban", False)
        is_active = data.get("is_apixaban_active", False)
        years_cured = data.get("years_cured_apixaban", 0.0)
