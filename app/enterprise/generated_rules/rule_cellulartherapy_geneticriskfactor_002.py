"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - GeneticRiskFactor (2).
...
class CellularTherapyGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating CellularTherapy (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_GENETICRISKFACTOR_002"
    rule_name = "CellularTherapy GeneticRiskFactor Screening Rule #2"
