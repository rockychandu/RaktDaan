"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - PostOperativeRecovery (3).
...
class BiosecurityPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Biosecurity (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_POSTOPERATIVERECOVERY_003"
    rule_name = "Biosecurity PostOperativeRecovery Screening Rule #3"
