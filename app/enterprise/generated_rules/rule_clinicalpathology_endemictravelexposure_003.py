"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - EndemicTravelExposure (3).
...
class ClinicalPathologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating ClinicalPathology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "ClinicalPathology EndemicTravelExposure Screening Rule #3"
