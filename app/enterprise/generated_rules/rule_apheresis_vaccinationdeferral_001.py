"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - VaccinationDeferral (1).
...
class ApheresisVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_VACCINATIONDEFERRAL_001"
    rule_name = "Apheresis VaccinationDeferral Screening Rule #1"
    category = "APHERESIS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Apheresis (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_apheresis_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("apheresis_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("apheresis_vaccinationdeferral_lab_marker", 10.0)
