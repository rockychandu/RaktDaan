"""
Enterprise Clinical Screening & Medical Rule Engine: Histocompatibility - EndemicTravelExposure (2).
...
class HistocompatibilityEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Histocompatibility (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HISTOCOMPATIBILITY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Histocompatibility EndemicTravelExposure Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Histocompatibility (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_histocompatibility_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("histocompatibility_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("histocompatibility_endemictravelexposure_lab_marker", 10.0)
