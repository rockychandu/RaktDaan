"""
Clinical Rule Processor for Endocrinology - Type2Diabetes.
...
class Type2DiabetesClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Type2Diabetes.
    """
    rule_code = "RULE_ENDOCRINOLOGY_TYPE2DIABETES"
    rule_name = "Type2Diabetes Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_type2diabetes", False)
        is_active = data.get("is_type2diabetes_active", False)
        years_cured = data.get("years_cured_type2diabetes", 0.0)
