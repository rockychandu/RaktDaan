"""
Enterprise Clinical Screening & Medical Rule Engine: Histocompatibility - EndemicTravelExposure (3).
...
class HistocompatibilityEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Histocompatibility (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HISTOCOMPATIBILITY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Histocompatibility EndemicTravelExposure Screening Rule #3"
