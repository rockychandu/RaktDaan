"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - EndemicTravelExposure (1).
...
class RadiologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Radiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Radiology EndemicTravelExposure Screening Rule #1"
    category = "RADIOLOGY"
