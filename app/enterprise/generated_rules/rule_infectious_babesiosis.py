"""
Clinical Rule Processor for Infectious - Babesiosis.
...
class BabesiosisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Babesiosis.
    """
    rule_code = "RULE_INFECTIOUS_BABESIOSIS"
    rule_name = "Babesiosis Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_babesiosis", False)
        is_active = data.get("is_babesiosis_active", False)
        years_cured = data.get("years_cured_babesiosis", 0.0)
