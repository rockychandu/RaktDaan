"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - DiagnosticLaboratoryMarker (2).
...
class HematologyDiagnosticLaboratoryMarkerClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (DiagnosticLaboratoryMarker) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_DIAGNOSTICLABORATORYMARKER_002"
    rule_name = "Hematology DiagnosticLaboratoryMarker Screening Rule #2"
    category = "HEMATOLOGY"
