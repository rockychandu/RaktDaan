"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - SurgicalIntervention (3).
...
class GeneTherapySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating GeneTherapy (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_SURGICALINTERVENTION_003"
    rule_name = "GeneTherapy SurgicalIntervention Screening Rule #3"
