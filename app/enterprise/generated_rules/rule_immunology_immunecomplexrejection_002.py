"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - ImmuneComplexRejection (2).
...
class ImmunologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Immunology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Immunology ImmuneComplexRejection Screening Rule #2"
    category = "IMMUNOLOGY"
