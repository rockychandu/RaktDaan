"""
Clinical Rule Processor for Infectious - Malaria.
...
class MalariaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Malaria.
    """
    rule_code = "RULE_INFECTIOUS_MALARIA"
    rule_name = "Malaria Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_malaria", False)
        is_active = data.get("is_malaria_active", False)
        years_cured = data.get("years_cured_malaria", 0.0)
