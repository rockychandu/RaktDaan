"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - GeriatricReserveEvaluation (3).
...
class SurgeryGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Surgery GeriatricReserveEvaluation Screening Rule #3"
    category = "SURGERY"
