"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - PostOperativeRecovery (3).
...
class ImmunologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Immunology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Immunology PostOperativeRecovery Screening Rule #3"
    category = "IMMUNOLOGY"
