"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - PostOperativeRecovery (3).
...
class TransfusionMedicinePostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating TransfusionMedicine (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_POSTOPERATIVERECOVERY_003"
    rule_name = "TransfusionMedicine PostOperativeRecovery Screening Rule #3"
