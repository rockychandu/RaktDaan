"""
Clinical Rule Processor for Nephrology - CKDStage3.
...
class CKDStage3ClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CKDStage3.
    """
    rule_code = "RULE_NEPHROLOGY_CKDSTAGE3"
    rule_name = "CKDStage3 Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ckdstage3", False)
        is_active = data.get("is_ckdstage3_active", False)
        years_cured = data.get("years_cured_ckdstage3", 0.0)
