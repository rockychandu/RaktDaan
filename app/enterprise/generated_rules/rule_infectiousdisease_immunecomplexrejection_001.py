"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - ImmuneComplexRejection (1).
...
class InfectiousDiseaseImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating InfectiousDisease (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_IMMUNECOMPLEXREJECTION_001"
    rule_name = "InfectiousDisease ImmuneComplexRejection Screening Rule #1"
