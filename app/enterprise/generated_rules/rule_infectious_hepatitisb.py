"""
Clinical Rule Processor for Infectious - HepatitisB.
...
class HepatitisBClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HepatitisB.
    """
    rule_code = "RULE_INFECTIOUS_HEPATITISB"
    rule_name = "HepatitisB Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hepatitisb", False)
        is_active = data.get("is_hepatitisb_active", False)
        years_cured = data.get("years_cured_hepatitisb", 0.0)
