"""
Enterprise Clinical Screening & Medical Rule Engine: Bioterrorism - VaccinationDeferral (3).
...
class BioterrorismVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Bioterrorism (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOTERRORISM_VACCINATIONDEFERRAL_003"
    rule_name = "Bioterrorism VaccinationDeferral Screening Rule #3"
