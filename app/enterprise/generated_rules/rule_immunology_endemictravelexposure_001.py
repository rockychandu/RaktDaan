"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - EndemicTravelExposure (1).
...
class ImmunologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Immunology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Immunology EndemicTravelExposure Screening Rule #1"
    category = "IMMUNOLOGY"
