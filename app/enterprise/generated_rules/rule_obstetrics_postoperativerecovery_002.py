"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - PostOperativeRecovery (2).
...
class ObstetricsPostOperativeRecoveryClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_POSTOPERATIVERECOVERY_002"
    rule_name = "Obstetrics PostOperativeRecovery Screening Rule #2"
    category = "OBSTETRICS"
