"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - SurgicalIntervention (3).
...
class CardiologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Cardiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Cardiology SurgicalIntervention Screening Rule #3"
    category = "CARDIOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Cardiology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_cardiology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("cardiology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cardiology_surgicalintervention_lab_marker", 10.0)
