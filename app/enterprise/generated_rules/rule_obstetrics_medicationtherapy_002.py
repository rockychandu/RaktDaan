"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - MedicationTherapy (2).
...
class ObstetricsMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_MEDICATIONTHERAPY_002"
    rule_name = "Obstetrics MedicationTherapy Screening Rule #2"
    category = "OBSTETRICS"
