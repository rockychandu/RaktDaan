"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - SurgicalIntervention (1).
...
class RheumatologySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Rheumatology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_SURGICALINTERVENTION_001"
    rule_name = "Rheumatology SurgicalIntervention Screening Rule #1"
