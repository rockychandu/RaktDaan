"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - PediatricSafetyProtocol (3).
...
class RadiologyPediatricSafetyProtocolClinicalProcessor3:
    """
    Detailed decision processor evaluating Radiology (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_PEDIATRICSAFETYPROTOCOL_003"
    rule_name = "Radiology PediatricSafetyProtocol Screening Rule #3"
    category = "RADIOLOGY"
