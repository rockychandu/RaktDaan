"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - SurgicalIntervention (3).
...
class PsychiatrySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_SURGICALINTERVENTION_003"
    rule_name = "Psychiatry SurgicalIntervention Screening Rule #3"
    category = "PSYCHIATRY"
