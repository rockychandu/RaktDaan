"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - GeneticRiskFactor (3).
...
class HematologyGeneticRiskFactorClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_GENETICRISKFACTOR_003"
    rule_name = "Hematology GeneticRiskFactor Screening Rule #3"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (GeneticRiskFactor)."""
        has_primary = donor_payload.get("has_hematology_geneticriskfactor_primary", False)
        severity_score = donor_payload.get("hematology_geneticriskfactor_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_geneticriskfactor_lab_marker", 10.0)
