"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - SurgicalIntervention (3).
...
class ImmunologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Immunology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Immunology SurgicalIntervention Screening Rule #3"
    category = "IMMUNOLOGY"
