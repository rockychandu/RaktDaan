"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - EndemicTravelExposure (3).
...
class InfectiousDiseaseEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating InfectiousDisease (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "InfectiousDisease EndemicTravelExposure Screening Rule #3"
