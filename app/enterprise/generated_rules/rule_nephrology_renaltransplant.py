"""
Clinical Rule Processor for Nephrology - RenalTransplant.
...
class RenalTransplantClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for RenalTransplant.
    """
    rule_code = "RULE_NEPHROLOGY_RENALTRANSPLANT"
    rule_name = "RenalTransplant Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_renaltransplant", False)
        is_active = data.get("is_renaltransplant_active", False)
        years_cured = data.get("years_cured_renaltransplant", 0.0)
