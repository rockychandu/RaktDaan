"""
Clinical Rule Processor for Infectious - LymeDisease.
...
class LymeDiseaseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for LymeDisease.
    """
    rule_code = "RULE_INFECTIOUS_LYMEDISEASE"
    rule_name = "LymeDisease Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_lymedisease", False)
        is_active = data.get("is_lymedisease_active", False)
        years_cured = data.get("years_cured_lymedisease", 0.0)
