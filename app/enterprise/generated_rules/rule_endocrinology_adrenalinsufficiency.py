"""
Clinical Rule Processor for Endocrinology - AdrenalInsufficiency.
...
class AdrenalInsufficiencyClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for AdrenalInsufficiency.
    """
    rule_code = "RULE_ENDOCRINOLOGY_ADRENALINSUFFICIENCY"
    rule_name = "AdrenalInsufficiency Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_adrenalinsufficiency", False)
        is_active = data.get("is_adrenalinsufficiency_active", False)
        years_cured = data.get("years_cured_adrenalinsufficiency", 0.0)
