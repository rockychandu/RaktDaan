"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - SurgicalIntervention (3).
...
class SurgerySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_SURGICALINTERVENTION_003"
    rule_name = "Surgery SurgicalIntervention Screening Rule #3"
    category = "SURGERY"
