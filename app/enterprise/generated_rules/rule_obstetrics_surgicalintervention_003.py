"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - SurgicalIntervention (3).
...
class ObstetricsSurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Obstetrics (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_SURGICALINTERVENTION_003"
    rule_name = "Obstetrics SurgicalIntervention Screening Rule #3"
    category = "OBSTETRICS"
