"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - ImmuneComplexRejection (2).
...
class CardiologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Cardiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Cardiology ImmuneComplexRejection Screening Rule #2"
    category = "CARDIOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Cardiology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_cardiology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("cardiology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cardiology_immunecomplexrejection_lab_marker", 10.0)
