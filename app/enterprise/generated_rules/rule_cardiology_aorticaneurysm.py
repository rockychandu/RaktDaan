"""
Clinical Rule Processor for Cardiology - AorticAneurysm.
...
class AorticAneurysmClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for AorticAneurysm.
    """
    rule_code = "RULE_CARDIOLOGY_AORTICANEURYSM"
    rule_name = "AorticAneurysm Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_aorticaneurysm", False)
        is_active = data.get("is_aorticaneurysm_active", False)
        years_cured = data.get("years_cured_aorticaneurysm", 0.0)
