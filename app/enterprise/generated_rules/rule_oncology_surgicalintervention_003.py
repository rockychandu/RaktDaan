"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - SurgicalIntervention (3).
...
class OncologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Oncology SurgicalIntervention Screening Rule #3"
    category = "ONCOLOGY"
