"""
Clinical Rule Processor for Infectious - HepatitisA.
...
class HepatitisAClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HepatitisA.
    """
    rule_code = "RULE_INFECTIOUS_HEPATITISA"
    rule_name = "HepatitisA Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hepatitisa", False)
        is_active = data.get("is_hepatitisa_active", False)
        years_cured = data.get("years_cured_hepatitisa", 0.0)
