"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - ChronicDisease (2).
...
class HemovigilanceChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating Hemovigilance (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_CHRONICDISEASE_002"
    rule_name = "Hemovigilance ChronicDisease Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hemovigilance (ChronicDisease)."""
        has_primary = donor_payload.get("has_hemovigilance_chronicdisease_primary", False)
        severity_score = donor_payload.get("hemovigilance_chronicdisease_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hemovigilance_chronicdisease_lab_marker", 10.0)
