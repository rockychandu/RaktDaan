"""
Clinical Rule Processor for Cardiology - Angina.
...
class AnginaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Angina.
    """
    rule_code = "RULE_CARDIOLOGY_ANGINA"
    rule_name = "Angina Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_angina", False)
        is_active = data.get("is_angina_active", False)
        years_cured = data.get("years_cured_angina", 0.0)
