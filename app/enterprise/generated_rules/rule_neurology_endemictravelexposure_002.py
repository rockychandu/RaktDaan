"""
Enterprise Clinical Screening & Medical Rule Engine: Neurology - EndemicTravelExposure (2).
...
class NeurologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Neurology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEUROLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Neurology EndemicTravelExposure Screening Rule #2"
    category = "NEUROLOGY"
