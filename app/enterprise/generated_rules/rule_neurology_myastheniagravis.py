"""
Clinical Rule Processor for Neurology - MyastheniaGravis.
...
class MyastheniaGravisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for MyastheniaGravis.
    """
    rule_code = "RULE_NEUROLOGY_MYASTHENIAGRAVIS"
    rule_name = "MyastheniaGravis Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_myastheniagravis", False)
        is_active = data.get("is_myastheniagravis_active", False)
        years_cured = data.get("years_cured_myastheniagravis", 0.0)
