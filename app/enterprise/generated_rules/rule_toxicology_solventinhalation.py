"""
Clinical Rule Processor for Toxicology - SolventInhalation.
...
class SolventInhalationClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for SolventInhalation.
    """
    rule_code = "RULE_TOXICOLOGY_SOLVENTINHALATION"
    rule_name = "SolventInhalation Screening Rule"
    category = "TOXICOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_solventinhalation", False)
        is_active = data.get("is_solventinhalation_active", False)
        years_cured = data.get("years_cured_solventinhalation", 0.0)
