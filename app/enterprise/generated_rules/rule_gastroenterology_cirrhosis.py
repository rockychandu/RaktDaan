"""
Clinical Rule Processor for Gastroenterology - Cirrhosis.
...
class CirrhosisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Cirrhosis.
    """
    rule_code = "RULE_GASTROENTEROLOGY_CIRRHOSIS"
    rule_name = "Cirrhosis Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_cirrhosis", False)
        is_active = data.get("is_cirrhosis_active", False)
        years_cured = data.get("years_cured_cirrhosis", 0.0)
