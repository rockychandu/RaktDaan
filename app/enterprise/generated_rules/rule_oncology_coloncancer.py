"""
Clinical Rule Processor for Oncology - ColonCancer.
...
class ColonCancerClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for ColonCancer.
    """
    rule_code = "RULE_ONCOLOGY_COLONCANCER"
    rule_name = "ColonCancer Screening Rule"
    category = "ONCOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_coloncancer", False)
        is_active = data.get("is_coloncancer_active", False)
        years_cured = data.get("years_cured_coloncancer", 0.0)
