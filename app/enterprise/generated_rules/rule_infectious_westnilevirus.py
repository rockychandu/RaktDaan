"""
Clinical Rule Processor for Infectious - WestNileVirus.
...
class WestNileVirusClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for WestNileVirus.
    """
    rule_code = "RULE_INFECTIOUS_WESTNILEVIRUS"
    rule_name = "WestNileVirus Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_westnilevirus", False)
        is_active = data.get("is_westnilevirus_active", False)
        years_cured = data.get("years_cured_westnilevirus", 0.0)
