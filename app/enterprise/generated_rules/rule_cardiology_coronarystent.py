"""
Clinical Rule Processor for Cardiology - CoronaryStent.
...
class CoronaryStentClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CoronaryStent.
    """
    rule_code = "RULE_CARDIOLOGY_CORONARYSTENT"
    rule_name = "CoronaryStent Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_coronarystent", False)
        is_active = data.get("is_coronarystent_active", False)
        years_cured = data.get("years_cured_coronarystent", 0.0)
