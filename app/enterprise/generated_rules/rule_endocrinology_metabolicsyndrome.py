"""
Clinical Rule Processor for Endocrinology - MetabolicSyndrome.
...
class MetabolicSyndromeClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for MetabolicSyndrome.
    """
    rule_code = "RULE_ENDOCRINOLOGY_METABOLICSYNDROME"
    rule_name = "MetabolicSyndrome Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_metabolicsyndrome", False)
        is_active = data.get("is_metabolicsyndrome_active", False)
        years_cured = data.get("years_cured_metabolicsyndrome", 0.0)
