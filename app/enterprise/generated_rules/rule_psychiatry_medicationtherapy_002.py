"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - MedicationTherapy (2).
...
class PsychiatryMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_MEDICATIONTHERAPY_002"
    rule_name = "Psychiatry MedicationTherapy Screening Rule #2"
    category = "PSYCHIATRY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Psychiatry (MedicationTherapy)."""
        has_primary = donor_payload.get("has_psychiatry_medicationtherapy_primary", False)
        severity_score = donor_payload.get("psychiatry_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("psychiatry_medicationtherapy_lab_marker", 10.0)
