"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - VaccinationDeferral (3).
...
class CardiologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Cardiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Cardiology VaccinationDeferral Screening Rule #3"
    category = "CARDIOLOGY"
