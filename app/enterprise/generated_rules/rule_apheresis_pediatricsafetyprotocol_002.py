"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PediatricSafetyProtocol (2).
...
class ApheresisPediatricSafetyProtocolClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_PEDIATRICSAFETYPROTOCOL_002"
    rule_name = "Apheresis PediatricSafetyProtocol Screening Rule #2"
    category = "APHERESIS"
