"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - SurgicalIntervention (2).
...
class RadiologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Radiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Radiology SurgicalIntervention Screening Rule #2"
    category = "RADIOLOGY"
