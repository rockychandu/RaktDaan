"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - ImmuneComplexRejection (2).
...
class ObstetricsImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Obstetrics ImmuneComplexRejection Screening Rule #2"
    category = "OBSTETRICS"
