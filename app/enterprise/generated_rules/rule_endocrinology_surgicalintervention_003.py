"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - SurgicalIntervention (3).
...
class EndocrinologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Endocrinology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Endocrinology SurgicalIntervention Screening Rule #3"
