"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - HemodynamicsAssessment (2).
...
class HematologyHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_HEMODYNAMICSASSESSMENT_002"
    rule_name = "Hematology HemodynamicsAssessment Screening Rule #2"
    category = "HEMATOLOGY"
