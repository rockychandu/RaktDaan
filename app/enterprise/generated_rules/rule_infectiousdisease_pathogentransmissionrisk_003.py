"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - PathogenTransmissionRisk (3).
...
class InfectiousDiseasePathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating InfectiousDisease (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "InfectiousDisease PathogenTransmissionRisk Screening Rule #3"
