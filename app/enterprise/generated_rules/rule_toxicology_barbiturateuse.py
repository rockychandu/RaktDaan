"""
Clinical Rule Processor for Toxicology - BarbiturateUse.
...
class BarbiturateUseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for BarbiturateUse.
    """
    rule_code = "RULE_TOXICOLOGY_BARBITURATEUSE"
    rule_name = "BarbiturateUse Screening Rule"
    category = "TOXICOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_barbiturateuse", False)
        is_active = data.get("is_barbiturateuse_active", False)
        years_cured = data.get("years_cured_barbiturateuse", 0.0)
