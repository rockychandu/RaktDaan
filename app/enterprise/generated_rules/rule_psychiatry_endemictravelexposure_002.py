"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - EndemicTravelExposure (2).
...
class PsychiatryEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Psychiatry EndemicTravelExposure Screening Rule #2"
    category = "PSYCHIATRY"
