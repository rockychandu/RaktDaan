"""
Enterprise Clinical Screening & Medical Rule Engine: Urology - VaccinationDeferral (3).
...
class UrologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Urology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_UROLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Urology VaccinationDeferral Screening Rule #3"
    category = "UROLOGY"
