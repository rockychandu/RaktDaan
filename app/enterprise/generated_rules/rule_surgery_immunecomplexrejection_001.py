"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - ImmuneComplexRejection (1).
...
class SurgeryImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Surgery (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Surgery ImmuneComplexRejection Screening Rule #1"
    category = "SURGERY"
