"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - MedicationTherapy (2).
...
class GastroenterologyMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Gastroenterology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_MEDICATIONTHERAPY_002"
    rule_name = "Gastroenterology MedicationTherapy Screening Rule #2"
