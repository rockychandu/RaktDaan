"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - AcuteCondition (2).
...
class CellularTherapyAcuteConditionClinicalProcessor2:
    """
    Detailed decision processor evaluating CellularTherapy (AcuteCondition) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_ACUTECONDITION_002"
    rule_name = "CellularTherapy AcuteCondition Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for CellularTherapy (AcuteCondition)."""
        has_primary = donor_payload.get("has_cellulartherapy_acutecondition_primary", False)
        severity_score = donor_payload.get("cellulartherapy_acutecondition_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cellulartherapy_acutecondition_lab_marker", 10.0)
