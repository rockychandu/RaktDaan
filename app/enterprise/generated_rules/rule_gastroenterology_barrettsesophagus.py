"""
Clinical Rule Processor for Gastroenterology - BarrettsEsophagus.
...
class BarrettsEsophagusClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for BarrettsEsophagus.
    """
    rule_code = "RULE_GASTROENTEROLOGY_BARRETTSESOPHAGUS"
    rule_name = "BarrettsEsophagus Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_barrettsesophagus", False)
        is_active = data.get("is_barrettsesophagus_active", False)
        years_cured = data.get("years_cured_barrettsesophagus", 0.0)
