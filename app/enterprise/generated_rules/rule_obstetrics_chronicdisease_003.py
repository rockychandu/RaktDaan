"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - ChronicDisease (3).
...
class ObstetricsChronicDiseaseClinicalProcessor3:
    """
    Detailed decision processor evaluating Obstetrics (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_CHRONICDISEASE_003"
    rule_name = "Obstetrics ChronicDisease Screening Rule #3"
    category = "OBSTETRICS"
