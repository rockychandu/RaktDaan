"""
Clinical Rule Processor for Nephrology - CKDStage5.
...
class CKDStage5ClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CKDStage5.
    """
    rule_code = "RULE_NEPHROLOGY_CKDSTAGE5"
    rule_name = "CKDStage5 Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ckdstage5", False)
        is_active = data.get("is_ckdstage5_active", False)
        years_cured = data.get("years_cured_ckdstage5", 0.0)
