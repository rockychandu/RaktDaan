"""
Clinical Rule Processor for Infectious - ChagasDisease.
...
class ChagasDiseaseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for ChagasDisease.
    """
    rule_code = "RULE_INFECTIOUS_CHAGASDISEASE"
    rule_name = "ChagasDisease Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_chagasdisease", False)
        is_active = data.get("is_chagasdisease_active", False)
        years_cured = data.get("years_cured_chagasdisease", 0.0)
