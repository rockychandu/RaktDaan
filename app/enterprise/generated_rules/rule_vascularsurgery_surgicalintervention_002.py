"""
Enterprise Clinical Screening & Medical Rule Engine: VascularSurgery - SurgicalIntervention (2).
...
class VascularSurgerySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating VascularSurgery (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_VASCULARSURGERY_SURGICALINTERVENTION_002"
    rule_name = "VascularSurgery SurgicalIntervention Screening Rule #2"
