"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - VaccinationDeferral (2).
...
class RadiologyVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Radiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_VACCINATIONDEFERRAL_002"
    rule_name = "Radiology VaccinationDeferral Screening Rule #2"
    category = "RADIOLOGY"
