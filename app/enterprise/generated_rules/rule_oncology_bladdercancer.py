"""
Clinical Rule Processor for Oncology - BladderCancer.
...
class BladderCancerClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for BladderCancer.
    """
    rule_code = "RULE_ONCOLOGY_BLADDERCANCER"
    rule_name = "BladderCancer Screening Rule"
    category = "ONCOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_bladdercancer", False)
        is_active = data.get("is_bladdercancer_active", False)
        years_cured = data.get("years_cured_bladdercancer", 0.0)
