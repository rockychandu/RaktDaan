"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - MedicationTherapy (3).
...
class RadiologyMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Radiology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_MEDICATIONTHERAPY_003"
    rule_name = "Radiology MedicationTherapy Screening Rule #3"
    category = "RADIOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Radiology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_radiology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("radiology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("radiology_medicationtherapy_lab_marker", 10.0)
