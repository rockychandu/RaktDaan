"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - HemodynamicsAssessment (3).
...
class GeriatricsHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Geriatrics (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Geriatrics HemodynamicsAssessment Screening Rule #3"
    category = "GERIATRICS"
