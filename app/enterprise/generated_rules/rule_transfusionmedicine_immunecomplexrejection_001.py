"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - ImmuneComplexRejection (1).
...
class TransfusionMedicineImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating TransfusionMedicine (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_IMMUNECOMPLEXREJECTION_001"
    rule_name = "TransfusionMedicine ImmuneComplexRejection Screening Rule #1"
