"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - VaccinationDeferral (1).
...
class HematologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Hematology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Hematology VaccinationDeferral Screening Rule #1"
    category = "HEMATOLOGY"
