"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - SurgicalIntervention (3).
...
class EpidemiologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Epidemiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Epidemiology SurgicalIntervention Screening Rule #3"
