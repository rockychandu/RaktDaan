"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - ImmuneComplexRejection (2).
...
class HematologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Hematology ImmuneComplexRejection Screening Rule #2"
    category = "HEMATOLOGY"
