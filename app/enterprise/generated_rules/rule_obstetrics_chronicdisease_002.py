"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - ChronicDisease (2).
...
class ObstetricsChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_CHRONICDISEASE_002"
    rule_name = "Obstetrics ChronicDisease Screening Rule #2"
    category = "OBSTETRICS"
