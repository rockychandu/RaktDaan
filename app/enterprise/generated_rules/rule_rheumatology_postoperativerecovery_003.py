"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - PostOperativeRecovery (3).
...
class RheumatologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Rheumatology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Rheumatology PostOperativeRecovery Screening Rule #3"
