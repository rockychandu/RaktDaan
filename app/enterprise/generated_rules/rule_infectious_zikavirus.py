"""
Clinical Rule Processor for Infectious - ZikaVirus.
...
class ZikaVirusClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for ZikaVirus.
    """
    rule_code = "RULE_INFECTIOUS_ZIKAVIRUS"
    rule_name = "ZikaVirus Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_zikavirus", False)
        is_active = data.get("is_zikavirus_active", False)
        years_cured = data.get("years_cured_zikavirus", 0.0)
