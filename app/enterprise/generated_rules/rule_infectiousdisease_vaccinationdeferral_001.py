"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - VaccinationDeferral (1).
...
class InfectiousDiseaseVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating InfectiousDisease (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_VACCINATIONDEFERRAL_001"
    rule_name = "InfectiousDisease VaccinationDeferral Screening Rule #1"
