"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - SurgicalIntervention (1).
...
class BiosecuritySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Biosecurity (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_SURGICALINTERVENTION_001"
    rule_name = "Biosecurity SurgicalIntervention Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Biosecurity (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_biosecurity_surgicalintervention_primary", False)
        severity_score = donor_payload.get("biosecurity_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("biosecurity_surgicalintervention_lab_marker", 10.0)
