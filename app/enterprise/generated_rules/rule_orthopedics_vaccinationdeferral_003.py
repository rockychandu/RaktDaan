"""
Enterprise Clinical Screening & Medical Rule Engine: Orthopedics - VaccinationDeferral (3).
...
class OrthopedicsVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Orthopedics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ORTHOPEDICS_VACCINATIONDEFERRAL_003"
    rule_name = "Orthopedics VaccinationDeferral Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Orthopedics (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_orthopedics_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("orthopedics_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("orthopedics_vaccinationdeferral_lab_marker", 10.0)
