"""
Clinical Rule Processor for Hematology - Lymphoma.
...
class LymphomaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Lymphoma.
    """
    rule_code = "RULE_HEMATOLOGY_LYMPHOMA"
    rule_name = "Lymphoma Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_lymphoma", False)
        is_active = data.get("is_lymphoma_active", False)
        years_cured = data.get("years_cured_lymphoma", 0.0)
