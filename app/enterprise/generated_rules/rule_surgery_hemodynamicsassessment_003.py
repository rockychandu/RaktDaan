"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - HemodynamicsAssessment (3).
...
class SurgeryHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Surgery HemodynamicsAssessment Screening Rule #3"
    category = "SURGERY"
