"""
Clinical Rule Processor for Gastroenterology - PepticUlcer.
...
class PepticUlcerClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for PepticUlcer.
    """
    rule_code = "RULE_GASTROENTEROLOGY_PEPTICULCER"
    rule_name = "PepticUlcer Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_pepticulcer", False)
        is_active = data.get("is_pepticulcer_active", False)
        years_cured = data.get("years_cured_pepticulcer", 0.0)
