"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - ImmuneComplexRejection (1).
...
class OphthalmologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Ophthalmology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Ophthalmology ImmuneComplexRejection Screening Rule #1"
