"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - VaccinationDeferral (3).
...
class OncologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Oncology VaccinationDeferral Screening Rule #3"
    category = "ONCOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Oncology (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_oncology_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("oncology_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("oncology_vaccinationdeferral_lab_marker", 10.0)
