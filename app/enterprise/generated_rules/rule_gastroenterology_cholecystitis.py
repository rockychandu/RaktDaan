"""
Clinical Rule Processor for Gastroenterology - Cholecystitis.
...
class CholecystitisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Cholecystitis.
    """
    rule_code = "RULE_GASTROENTEROLOGY_CHOLECYSTITIS"
    rule_name = "Cholecystitis Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_cholecystitis", False)
        is_active = data.get("is_cholecystitis_active", False)
        years_cured = data.get("years_cured_cholecystitis", 0.0)
