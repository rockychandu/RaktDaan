"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - VaccinationDeferral (1).
...
class CryobiologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Cryobiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Cryobiology VaccinationDeferral Screening Rule #1"
