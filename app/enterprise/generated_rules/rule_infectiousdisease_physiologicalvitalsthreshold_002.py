"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - PhysiologicalVitalsThreshold (2).
...
class InfectiousDiseasePhysiologicalVitalsThresholdClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_PHYSIOLOGICALVITALSTHRESHOLD_002"
    rule_name = "InfectiousDisease PhysiologicalVitalsThreshold Screening Rule #2"
