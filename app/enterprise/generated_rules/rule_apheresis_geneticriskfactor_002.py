"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - GeneticRiskFactor (2).
...
class ApheresisGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_GENETICRISKFACTOR_002"
    rule_name = "Apheresis GeneticRiskFactor Screening Rule #2"
    category = "APHERESIS"
