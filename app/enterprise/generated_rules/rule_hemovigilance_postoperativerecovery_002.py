"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - PostOperativeRecovery (2).
...
class HemovigilancePostOperativeRecoveryClinicalProcessor2:
    """
    Detailed decision processor evaluating Hemovigilance (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_POSTOPERATIVERECOVERY_002"
    rule_name = "Hemovigilance PostOperativeRecovery Screening Rule #2"
