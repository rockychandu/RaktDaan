"""
Clinical Rule Processor for Surgery - Splenectomy.
...
class SplenectomyClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Splenectomy.
    """
    rule_code = "RULE_SURGERY_SPLENECTOMY"
    rule_name = "Splenectomy Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_splenectomy", False)
        is_active = data.get("is_splenectomy_active", False)
        years_cured = data.get("years_cured_splenectomy", 0.0)
