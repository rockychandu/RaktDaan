"""
Enterprise Clinical Screening & Medical Rule Engine: Bioterrorism - SurgicalIntervention (2).
...
class BioterrorismSurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Bioterrorism (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOTERRORISM_SURGICALINTERVENTION_002"
    rule_name = "Bioterrorism SurgicalIntervention Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Bioterrorism (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_bioterrorism_surgicalintervention_primary", False)
        severity_score = donor_payload.get("bioterrorism_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("bioterrorism_surgicalintervention_lab_marker", 10.0)
