"""
Clinical Rule Processor for Hematology - Thrombocytopenia.
...
class ThrombocytopeniaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Thrombocytopenia.
    """
    rule_code = "RULE_HEMATOLOGY_THROMBOCYTOPENIA"
    rule_name = "Thrombocytopenia Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_thrombocytopenia", False)
        is_active = data.get("is_thrombocytopenia_active", False)
        years_cured = data.get("years_cured_thrombocytopenia", 0.0)
