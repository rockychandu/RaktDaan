"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - ChronicDisease (2).
...
class GeriatricsChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating Geriatrics (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_CHRONICDISEASE_002"
    rule_name = "Geriatrics ChronicDisease Screening Rule #2"
    category = "GERIATRICS"
