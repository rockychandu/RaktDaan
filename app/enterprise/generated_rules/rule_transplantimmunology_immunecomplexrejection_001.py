"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - ImmuneComplexRejection (1).
...
class TransplantImmunologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating TransplantImmunology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "TransplantImmunology ImmuneComplexRejection Screening Rule #1"
    category = "TRANSPLANTIMMUNOLOGY"
    sub_category = "IMMUNECOMPLEXREJECTION"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for TransplantImmunology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_transplantimmunology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("transplantimmunology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("transplantimmunology_immunecomplexrejection_lab_marker", 10.0)
