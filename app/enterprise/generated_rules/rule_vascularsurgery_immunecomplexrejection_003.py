"""
Enterprise Clinical Screening & Medical Rule Engine: VascularSurgery - ImmuneComplexRejection (3).
...
class VascularSurgeryImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating VascularSurgery (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_VASCULARSURGERY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "VascularSurgery ImmuneComplexRejection Screening Rule #3"
