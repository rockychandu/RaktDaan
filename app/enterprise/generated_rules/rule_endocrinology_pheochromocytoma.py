"""
Clinical Rule Processor for Endocrinology - Pheochromocytoma.
...
class PheochromocytomaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Pheochromocytoma.
    """
    rule_code = "RULE_ENDOCRINOLOGY_PHEOCHROMOCYTOMA"
    rule_name = "Pheochromocytoma Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_pheochromocytoma", False)
        is_active = data.get("is_pheochromocytoma_active", False)
        years_cured = data.get("years_cured_pheochromocytoma", 0.0)
