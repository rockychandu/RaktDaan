"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - EndemicTravelExposure (2).
...
class TransfusionMedicineEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating TransfusionMedicine (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "TransfusionMedicine EndemicTravelExposure Screening Rule #2"
