"""
Clinical Rule Processor for Cardiology - Hypertension.
...
class HypertensionClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Hypertension.
    """
    rule_code = "RULE_CARDIOLOGY_HYPERTENSION"
    rule_name = "Hypertension Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hypertension", False)
        is_active = data.get("is_hypertension_active", False)
        years_cured = data.get("years_cured_hypertension", 0.0)
