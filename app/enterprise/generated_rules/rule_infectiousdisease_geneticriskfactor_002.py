"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - GeneticRiskFactor (2).
...
class InfectiousDiseaseGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_GENETICRISKFACTOR_002"
    rule_name = "InfectiousDisease GeneticRiskFactor Screening Rule #2"
