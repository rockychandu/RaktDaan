"""
Enterprise Clinical Screening & Medical Rule Engine: Genetics - VaccinationDeferral (3).
...
class GeneticsVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Genetics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETICS_VACCINATIONDEFERRAL_003"
    rule_name = "Genetics VaccinationDeferral Screening Rule #3"
    category = "GENETICS"
