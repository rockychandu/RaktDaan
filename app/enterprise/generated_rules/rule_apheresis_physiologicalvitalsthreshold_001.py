"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PhysiologicalVitalsThreshold (1).
...
class ApheresisPhysiologicalVitalsThresholdClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_PHYSIOLOGICALVITALSTHRESHOLD_001"
    rule_name = "Apheresis PhysiologicalVitalsThreshold Screening Rule #1"
    category = "APHERESIS"
