"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - EndemicTravelExposure (2).
...
class OtolaryngologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Otolaryngology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Otolaryngology EndemicTravelExposure Screening Rule #2"
