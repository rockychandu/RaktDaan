"""
Clinical Rule Processor for Gastroenterology - CrohnsDisease.
...
class CrohnsDiseaseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CrohnsDisease.
    """
    rule_code = "RULE_GASTROENTEROLOGY_CROHNSDISEASE"
    rule_name = "CrohnsDisease Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_crohnsdisease", False)
        is_active = data.get("is_crohnsdisease_active", False)
        years_cured = data.get("years_cured_crohnsdisease", 0.0)
