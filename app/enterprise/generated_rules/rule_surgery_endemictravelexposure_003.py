"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - EndemicTravelExposure (3).
...
class SurgeryEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Surgery EndemicTravelExposure Screening Rule #3"
    category = "SURGERY"
