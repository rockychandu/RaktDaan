"""
Clinical Rule Processor for Oncology - Melanoma.
...
class MelanomaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Melanoma.
    """
    rule_code = "RULE_ONCOLOGY_MELANOMA"
    rule_name = "Melanoma Screening Rule"
    category = "ONCOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_melanoma", False)
        is_active = data.get("is_melanoma_active", False)
        years_cured = data.get("years_cured_melanoma", 0.0)
