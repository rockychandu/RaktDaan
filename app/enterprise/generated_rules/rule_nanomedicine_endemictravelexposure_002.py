"""
Enterprise Clinical Screening & Medical Rule Engine: Nanomedicine - EndemicTravelExposure (2).
...
class NanomedicineEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Nanomedicine (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NANOMEDICINE_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Nanomedicine EndemicTravelExposure Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Nanomedicine (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_nanomedicine_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("nanomedicine_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("nanomedicine_endemictravelexposure_lab_marker", 10.0)
