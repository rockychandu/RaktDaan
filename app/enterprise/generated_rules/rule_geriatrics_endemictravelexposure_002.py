"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - EndemicTravelExposure (2).
...
class GeriatricsEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Geriatrics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Geriatrics EndemicTravelExposure Screening Rule #2"
    category = "GERIATRICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Geriatrics (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_geriatrics_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("geriatrics_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("geriatrics_endemictravelexposure_lab_marker", 10.0)
