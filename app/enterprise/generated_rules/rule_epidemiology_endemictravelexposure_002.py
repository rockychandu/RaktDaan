"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - EndemicTravelExposure (2).
...
class EpidemiologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Epidemiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Epidemiology EndemicTravelExposure Screening Rule #2"
