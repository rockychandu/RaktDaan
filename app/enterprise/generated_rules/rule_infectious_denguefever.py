"""
Clinical Rule Processor for Infectious - DengueFever.
...
class DengueFeverClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for DengueFever.
    """
    rule_code = "RULE_INFECTIOUS_DENGUEFEVER"
    rule_name = "DengueFever Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_denguefever", False)
        is_active = data.get("is_denguefever_active", False)
        years_cured = data.get("years_cured_denguefever", 0.0)
