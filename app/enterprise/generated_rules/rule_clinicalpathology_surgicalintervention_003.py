"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - SurgicalIntervention (3).
...
class ClinicalPathologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating ClinicalPathology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_SURGICALINTERVENTION_003"
    rule_name = "ClinicalPathology SurgicalIntervention Screening Rule #3"
