"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - PostOperativeRecovery (1).
...
class HemovigilancePostOperativeRecoveryClinicalProcessor1:
    """
    Detailed decision processor evaluating Hemovigilance (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_POSTOPERATIVERECOVERY_001"
    rule_name = "Hemovigilance PostOperativeRecovery Screening Rule #1"
