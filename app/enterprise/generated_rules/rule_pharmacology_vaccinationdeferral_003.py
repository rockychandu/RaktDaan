"""
Enterprise Clinical Screening & Medical Rule Engine: Pharmacology - VaccinationDeferral (3).
...
class PharmacologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Pharmacology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PHARMACOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Pharmacology VaccinationDeferral Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Pharmacology (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_pharmacology_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("pharmacology_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("pharmacology_vaccinationdeferral_lab_marker", 10.0)
