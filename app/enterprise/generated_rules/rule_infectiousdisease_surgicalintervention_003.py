"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - SurgicalIntervention (3).
...
class InfectiousDiseaseSurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating InfectiousDisease (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_SURGICALINTERVENTION_003"
    rule_name = "InfectiousDisease SurgicalIntervention Screening Rule #3"
