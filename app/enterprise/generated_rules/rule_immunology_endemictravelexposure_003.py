"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - EndemicTravelExposure (3).
...
class ImmunologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Immunology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Immunology EndemicTravelExposure Screening Rule #3"
    category = "IMMUNOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Immunology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_immunology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("immunology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("immunology_endemictravelexposure_lab_marker", 10.0)
