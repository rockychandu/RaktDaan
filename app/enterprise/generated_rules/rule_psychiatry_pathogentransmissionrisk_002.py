"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - PathogenTransmissionRisk (2).
...
class PsychiatryPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Psychiatry PathogenTransmissionRisk Screening Rule #2"
    category = "PSYCHIATRY"
