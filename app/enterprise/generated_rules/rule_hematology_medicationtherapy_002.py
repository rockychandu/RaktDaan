"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - MedicationTherapy (2).
...
class HematologyMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_MEDICATIONTHERAPY_002"
    rule_name = "Hematology MedicationTherapy Screening Rule #2"
    category = "HEMATOLOGY"
