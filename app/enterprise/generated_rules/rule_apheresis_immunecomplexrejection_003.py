"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - ImmuneComplexRejection (3).
...
class ApheresisImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Apheresis ImmuneComplexRejection Screening Rule #3"
    category = "APHERESIS"
