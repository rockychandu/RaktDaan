"""
Enterprise Clinical Screening & Medical Rule Engine: Pulmonology - ImmuneComplexRejection (1).
...
class PulmonologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Pulmonology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PULMONOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Pulmonology ImmuneComplexRejection Screening Rule #1"
