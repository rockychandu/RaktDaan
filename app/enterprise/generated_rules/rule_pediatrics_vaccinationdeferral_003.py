"""
Enterprise Clinical Screening & Medical Rule Engine: Pediatrics - VaccinationDeferral (3).
...
class PediatricsVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Pediatrics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PEDIATRICS_VACCINATIONDEFERRAL_003"
    rule_name = "Pediatrics VaccinationDeferral Screening Rule #3"
    category = "PEDIATRICS"
