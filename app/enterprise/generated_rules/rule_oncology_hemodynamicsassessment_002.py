"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - HemodynamicsAssessment (2).
...
class OncologyHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating Oncology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_HEMODYNAMICSASSESSMENT_002"
    rule_name = "Oncology HemodynamicsAssessment Screening Rule #2"
    category = "ONCOLOGY"
