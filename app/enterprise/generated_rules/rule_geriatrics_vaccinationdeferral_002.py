"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - VaccinationDeferral (2).
...
class GeriatricsVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Geriatrics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_VACCINATIONDEFERRAL_002"
    rule_name = "Geriatrics VaccinationDeferral Screening Rule #2"
    category = "GERIATRICS"
