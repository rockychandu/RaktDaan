"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - PediatricSafetyProtocol (3).
...
class SurgeryPediatricSafetyProtocolClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_PEDIATRICSAFETYPROTOCOL_003"
    rule_name = "Surgery PediatricSafetyProtocol Screening Rule #3"
    category = "SURGERY"
