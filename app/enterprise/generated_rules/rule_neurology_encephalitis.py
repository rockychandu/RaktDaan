"""
Clinical Rule Processor for Neurology - Encephalitis.
...
class EncephalitisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Encephalitis.
    """
    rule_code = "RULE_NEUROLOGY_ENCEPHALITIS"
    rule_name = "Encephalitis Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_encephalitis", False)
        is_active = data.get("is_encephalitis_active", False)
        years_cured = data.get("years_cured_encephalitis", 0.0)
