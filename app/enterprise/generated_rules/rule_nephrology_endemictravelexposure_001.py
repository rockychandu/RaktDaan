"""
Enterprise Clinical Screening & Medical Rule Engine: Nephrology - EndemicTravelExposure (1).
...
class NephrologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Nephrology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEPHROLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Nephrology EndemicTravelExposure Screening Rule #1"
    category = "NEPHROLOGY"
