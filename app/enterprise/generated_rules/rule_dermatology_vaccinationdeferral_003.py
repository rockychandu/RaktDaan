"""
Enterprise Clinical Screening & Medical Rule Engine: Dermatology - VaccinationDeferral (3).
...
class DermatologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Dermatology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DERMATOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Dermatology VaccinationDeferral Screening Rule #3"
