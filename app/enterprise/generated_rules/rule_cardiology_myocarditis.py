"""
Clinical Rule Processor for Cardiology - Myocarditis.
...
class MyocarditisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Myocarditis.
    """
    rule_code = "RULE_CARDIOLOGY_MYOCARDITIS"
    rule_name = "Myocarditis Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_myocarditis", False)
        is_active = data.get("is_myocarditis_active", False)
        years_cured = data.get("years_cured_myocarditis", 0.0)
