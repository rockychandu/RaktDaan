"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - AcuteCondition (2).
...
class ApheresisAcuteConditionClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (AcuteCondition) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_ACUTECONDITION_002"
    rule_name = "Apheresis AcuteCondition Screening Rule #2"
    category = "APHERESIS"
