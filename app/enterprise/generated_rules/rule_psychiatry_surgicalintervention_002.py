"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - SurgicalIntervention (2).
...
class PsychiatrySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_SURGICALINTERVENTION_002"
    rule_name = "Psychiatry SurgicalIntervention Screening Rule #2"
    category = "PSYCHIATRY"
