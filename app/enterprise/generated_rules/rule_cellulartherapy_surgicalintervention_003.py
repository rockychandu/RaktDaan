"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - SurgicalIntervention (3).
...
class CellularTherapySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating CellularTherapy (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_SURGICALINTERVENTION_003"
    rule_name = "CellularTherapy SurgicalIntervention Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for CellularTherapy (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_cellulartherapy_surgicalintervention_primary", False)
        severity_score = donor_payload.get("cellulartherapy_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cellulartherapy_surgicalintervention_lab_marker", 10.0)
