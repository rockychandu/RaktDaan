"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - PediatricSafetyProtocol (2).
...
class ObstetricsPediatricSafetyProtocolClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_PEDIATRICSAFETYPROTOCOL_002"
    rule_name = "Obstetrics PediatricSafetyProtocol Screening Rule #2"
    category = "OBSTETRICS"
