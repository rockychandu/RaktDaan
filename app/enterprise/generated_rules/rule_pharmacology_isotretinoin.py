"""
Clinical Rule Processor for Pharmacology - Isotretinoin.
...
class IsotretinoinClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Isotretinoin.
    """
    rule_code = "RULE_PHARMACOLOGY_ISOTRETINOIN"
    rule_name = "Isotretinoin Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_isotretinoin", False)
        is_active = data.get("is_isotretinoin_active", False)
        years_cured = data.get("years_cured_isotretinoin", 0.0)
