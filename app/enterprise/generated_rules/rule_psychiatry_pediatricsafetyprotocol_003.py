"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - PediatricSafetyProtocol (3).
...
class PsychiatryPediatricSafetyProtocolClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_PEDIATRICSAFETYPROTOCOL_003"
    rule_name = "Psychiatry PediatricSafetyProtocol Screening Rule #3"
    category = "PSYCHIATRY"
