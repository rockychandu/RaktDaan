"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PediatricSafetyProtocol (3).
...
class ApheresisPediatricSafetyProtocolClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_PEDIATRICSAFETYPROTOCOL_003"
    rule_name = "Apheresis PediatricSafetyProtocol Screening Rule #3"
    category = "APHERESIS"
