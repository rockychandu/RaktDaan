"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - ImmuneComplexRejection (1).
...
class GeriatricsImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Geriatrics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Geriatrics ImmuneComplexRejection Screening Rule #1"
    category = "GERIATRICS"
