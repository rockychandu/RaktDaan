"""
Enterprise Clinical Screening & Medical Rule Engine: Histocompatibility - SurgicalIntervention (3).
...
class HistocompatibilitySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Histocompatibility (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HISTOCOMPATIBILITY_SURGICALINTERVENTION_003"
    rule_name = "Histocompatibility SurgicalIntervention Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Histocompatibility (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_histocompatibility_surgicalintervention_primary", False)
        severity_score = donor_payload.get("histocompatibility_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("histocompatibility_surgicalintervention_lab_marker", 10.0)
