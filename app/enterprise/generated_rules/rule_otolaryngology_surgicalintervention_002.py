"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - SurgicalIntervention (2).
...
class OtolaryngologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Otolaryngology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Otolaryngology SurgicalIntervention Screening Rule #2"
