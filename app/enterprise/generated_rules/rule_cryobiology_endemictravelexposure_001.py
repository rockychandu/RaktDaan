"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - EndemicTravelExposure (1).
...
class CryobiologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Cryobiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Cryobiology EndemicTravelExposure Screening Rule #1"
