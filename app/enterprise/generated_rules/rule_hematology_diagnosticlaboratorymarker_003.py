"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - DiagnosticLaboratoryMarker (3).
...
class HematologyDiagnosticLaboratoryMarkerClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (DiagnosticLaboratoryMarker) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_DIAGNOSTICLABORATORYMARKER_003"
    rule_name = "Hematology DiagnosticLaboratoryMarker Screening Rule #3"
    category = "HEMATOLOGY"
