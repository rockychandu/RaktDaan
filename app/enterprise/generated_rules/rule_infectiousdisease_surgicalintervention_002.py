"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - SurgicalIntervention (2).
...
class InfectiousDiseaseSurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_SURGICALINTERVENTION_002"
    rule_name = "InfectiousDisease SurgicalIntervention Screening Rule #2"
