"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - EndemicTravelExposure (1).
...
class OncologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Oncology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Oncology EndemicTravelExposure Screening Rule #1"
    category = "ONCOLOGY"
