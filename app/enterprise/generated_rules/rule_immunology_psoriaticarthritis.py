"""
Clinical Rule Processor for Immunology - PsoriaticArthritis.
...
class PsoriaticArthritisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for PsoriaticArthritis.
    """
    rule_code = "RULE_IMMUNOLOGY_PSORIATICARTHRITIS"
    rule_name = "PsoriaticArthritis Screening Rule"
    category = "IMMUNOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_psoriaticarthritis", False)
        is_active = data.get("is_psoriaticarthritis_active", False)
        years_cured = data.get("years_cured_psoriaticarthritis", 0.0)
