"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - VaccinationDeferral (3).
...
class ClinicalPathologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating ClinicalPathology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "ClinicalPathology VaccinationDeferral Screening Rule #3"
