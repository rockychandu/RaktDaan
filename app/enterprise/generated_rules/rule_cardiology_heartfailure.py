"""
Clinical Rule Processor for Cardiology - HeartFailure.
...
class HeartFailureClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HeartFailure.
    """
    rule_code = "RULE_CARDIOLOGY_HEARTFAILURE"
    rule_name = "HeartFailure Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_heartfailure", False)
        is_active = data.get("is_heartfailure_active", False)
        years_cured = data.get("years_cured_heartfailure", 0.0)
