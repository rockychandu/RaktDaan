"""
Clinical Rule Processor for Oncology - BreastCancer.
...
class BreastCancerClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for BreastCancer.
    """
    rule_code = "RULE_ONCOLOGY_BREASTCANCER"
    rule_name = "BreastCancer Screening Rule"
    category = "ONCOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_breastcancer", False)
        is_active = data.get("is_breastcancer_active", False)
        years_cured = data.get("years_cured_breastcancer", 0.0)
