"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - VaccinationDeferral (2).
...
class ImmunologyVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Immunology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_VACCINATIONDEFERRAL_002"
    rule_name = "Immunology VaccinationDeferral Screening Rule #2"
    category = "IMMUNOLOGY"
