"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - EndemicTravelExposure (3).
...
class CardiologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Cardiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Cardiology EndemicTravelExposure Screening Rule #3"
    category = "CARDIOLOGY"
