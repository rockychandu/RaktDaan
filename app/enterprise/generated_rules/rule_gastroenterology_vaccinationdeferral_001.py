"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - VaccinationDeferral (1).
...
class GastroenterologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Gastroenterology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Gastroenterology VaccinationDeferral Screening Rule #1"
