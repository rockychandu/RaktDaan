"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - MedicationTherapy (3).
...
class ObstetricsMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Obstetrics (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_MEDICATIONTHERAPY_003"
    rule_name = "Obstetrics MedicationTherapy Screening Rule #3"
    category = "OBSTETRICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Obstetrics (MedicationTherapy)."""
        has_primary = donor_payload.get("has_obstetrics_medicationtherapy_primary", False)
        severity_score = donor_payload.get("obstetrics_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("obstetrics_medicationtherapy_lab_marker", 10.0)
