"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - ChronicDisease (2).
...
class ApheresisChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_CHRONICDISEASE_002"
    rule_name = "Apheresis ChronicDisease Screening Rule #2"
    category = "APHERESIS"
