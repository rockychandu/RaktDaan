"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - GeriatricReserveEvaluation (2).
...
class GastroenterologyGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating Gastroenterology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_GERIATRICRESERVEEVALUATION_002"
    rule_name = "Gastroenterology GeriatricReserveEvaluation Screening Rule #2"
