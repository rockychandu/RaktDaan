"""
Clinical Rule Processor for Pharmacology - Rivaroxaban.
...
class RivaroxabanClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Rivaroxaban.
    """
    rule_code = "RULE_PHARMACOLOGY_RIVAROXABAN"
    rule_name = "Rivaroxaban Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_rivaroxaban", False)
        is_active = data.get("is_rivaroxaban_active", False)
        years_cured = data.get("years_cured_rivaroxaban", 0.0)
