"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - ImmuneComplexRejection (1).
...
class ObstetricsImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Obstetrics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Obstetrics ImmuneComplexRejection Screening Rule #1"
    category = "OBSTETRICS"
