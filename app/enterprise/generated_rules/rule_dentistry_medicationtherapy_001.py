"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - MedicationTherapy (1).
...
class DentistryMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating Dentistry (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_MEDICATIONTHERAPY_001"
    rule_name = "Dentistry MedicationTherapy Screening Rule #1"
    category = "DENTISTRY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Dentistry (MedicationTherapy)."""
        has_primary = donor_payload.get("has_dentistry_medicationtherapy_primary", False)
        severity_score = donor_payload.get("dentistry_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("dentistry_medicationtherapy_lab_marker", 10.0)
