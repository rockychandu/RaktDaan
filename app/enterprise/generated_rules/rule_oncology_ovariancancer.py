"""
Clinical Rule Processor for Oncology - OvarianCancer.
...
class OvarianCancerClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for OvarianCancer.
    """
    rule_code = "RULE_ONCOLOGY_OVARIANCANCER"
    rule_name = "OvarianCancer Screening Rule"
    category = "ONCOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ovariancancer", False)
        is_active = data.get("is_ovariancancer_active", False)
        years_cured = data.get("years_cured_ovariancancer", 0.0)
