"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - MedicationTherapy (3).
...
class HematologyMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_MEDICATIONTHERAPY_003"
    rule_name = "Hematology MedicationTherapy Screening Rule #3"
    category = "HEMATOLOGY"
