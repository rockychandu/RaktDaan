"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - VaccinationDeferral (1).
...
class EpidemiologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Epidemiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Epidemiology VaccinationDeferral Screening Rule #1"
