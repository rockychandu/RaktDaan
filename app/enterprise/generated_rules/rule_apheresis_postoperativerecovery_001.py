"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PostOperativeRecovery (1).
...
class ApheresisPostOperativeRecoveryClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_POSTOPERATIVERECOVERY_001"
    rule_name = "Apheresis PostOperativeRecovery Screening Rule #1"
    category = "APHERESIS"
