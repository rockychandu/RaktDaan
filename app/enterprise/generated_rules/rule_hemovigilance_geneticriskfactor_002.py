"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - GeneticRiskFactor (2).
...
class HemovigilanceGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating Hemovigilance (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_GENETICRISKFACTOR_002"
    rule_name = "Hemovigilance GeneticRiskFactor Screening Rule #2"
