"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - EndemicTravelExposure (2).
...
class ImmunologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Immunology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Immunology EndemicTravelExposure Screening Rule #2"
    category = "IMMUNOLOGY"
