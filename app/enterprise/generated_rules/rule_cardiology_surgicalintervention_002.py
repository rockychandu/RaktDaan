"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - SurgicalIntervention (2).
...
class CardiologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Cardiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Cardiology SurgicalIntervention Screening Rule #2"
    category = "CARDIOLOGY"
