"""
Clinical Rule Processor for Pharmacology - Dutasteride.
...
class DutasterideClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Dutasteride.
    """
    rule_code = "RULE_PHARMACOLOGY_DUTASTERIDE"
    rule_name = "Dutasteride Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_dutasteride", False)
        is_active = data.get("is_dutasteride_active", False)
        years_cured = data.get("years_cured_dutasteride", 0.0)
