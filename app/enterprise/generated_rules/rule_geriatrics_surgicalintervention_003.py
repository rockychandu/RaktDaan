"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - SurgicalIntervention (3).
...
class GeriatricsSurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Geriatrics (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_SURGICALINTERVENTION_003"
    rule_name = "Geriatrics SurgicalIntervention Screening Rule #3"
    category = "GERIATRICS"
