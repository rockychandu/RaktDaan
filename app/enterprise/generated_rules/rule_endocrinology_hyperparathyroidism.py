"""
Clinical Rule Processor for Endocrinology - Hyperparathyroidism.
...
class HyperparathyroidismClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Hyperparathyroidism.
    """
    rule_code = "RULE_ENDOCRINOLOGY_HYPERPARATHYROIDISM"
    rule_name = "Hyperparathyroidism Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hyperparathyroidism", False)
        is_active = data.get("is_hyperparathyroidism_active", False)
        years_cured = data.get("years_cured_hyperparathyroidism", 0.0)
