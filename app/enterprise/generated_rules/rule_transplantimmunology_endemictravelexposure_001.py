"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - EndemicTravelExposure (1).
...
class TransplantImmunologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating TransplantImmunology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "TransplantImmunology EndemicTravelExposure Screening Rule #1"
