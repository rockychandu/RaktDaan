"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - MedicationTherapy (3).
...
class PsychiatryMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_MEDICATIONTHERAPY_003"
    rule_name = "Psychiatry MedicationTherapy Screening Rule #3"
    category = "PSYCHIATRY"
