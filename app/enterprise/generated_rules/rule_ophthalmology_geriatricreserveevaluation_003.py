"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - GeriatricReserveEvaluation (3).
...
class OphthalmologyGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Ophthalmology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Ophthalmology GeriatricReserveEvaluation Screening Rule #3"
