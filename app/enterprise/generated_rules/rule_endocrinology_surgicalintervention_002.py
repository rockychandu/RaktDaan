"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - SurgicalIntervention (2).
...
class EndocrinologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Endocrinology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Endocrinology SurgicalIntervention Screening Rule #2"
