"""
Enterprise Clinical Screening & Medical Rule Engine: Pediatrics - EndemicTravelExposure (2).
...
class PediatricsEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Pediatrics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PEDIATRICS_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Pediatrics EndemicTravelExposure Screening Rule #2"
    category = "PEDIATRICS"
