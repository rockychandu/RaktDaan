"""
Clinical Rule Processor for Surgery - Thyroidectomy.
...
class ThyroidectomyClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Thyroidectomy.
    """
    rule_code = "RULE_SURGERY_THYROIDECTOMY"
    rule_name = "Thyroidectomy Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_thyroidectomy", False)
        is_active = data.get("is_thyroidectomy_active", False)
        years_cured = data.get("years_cured_thyroidectomy", 0.0)
