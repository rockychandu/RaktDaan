"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - ChronicDisease (3).
...
class CellularTherapyChronicDiseaseClinicalProcessor3:
    """
    Detailed decision processor evaluating CellularTherapy (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_CHRONICDISEASE_003"
    rule_name = "CellularTherapy ChronicDisease Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for CellularTherapy (ChronicDisease)."""
        has_primary = donor_payload.get("has_cellulartherapy_chronicdisease_primary", False)
        severity_score = donor_payload.get("cellulartherapy_chronicdisease_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cellulartherapy_chronicdisease_lab_marker", 10.0)
