"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - PathogenTransmissionRisk (2).
...
class GeriatricsPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Geriatrics (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Geriatrics PathogenTransmissionRisk Screening Rule #2"
    category = "GERIATRICS"
