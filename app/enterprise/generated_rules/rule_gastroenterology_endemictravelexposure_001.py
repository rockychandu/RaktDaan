"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - EndemicTravelExposure (1).
...
class GastroenterologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Gastroenterology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Gastroenterology EndemicTravelExposure Screening Rule #1"
