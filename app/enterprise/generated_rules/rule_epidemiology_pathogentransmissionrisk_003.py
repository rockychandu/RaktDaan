"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - PathogenTransmissionRisk (3).
...
class EpidemiologyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Epidemiology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Epidemiology PathogenTransmissionRisk Screening Rule #3"
