"""
Clinical Rule Processor for Nephrology - CKDStage2.
...
class CKDStage2ClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CKDStage2.
    """
    rule_code = "RULE_NEPHROLOGY_CKDSTAGE2"
    rule_name = "CKDStage2 Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ckdstage2", False)
        is_active = data.get("is_ckdstage2_active", False)
        years_cured = data.get("years_cured_ckdstage2", 0.0)
