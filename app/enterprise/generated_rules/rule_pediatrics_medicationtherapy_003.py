"""
Enterprise Clinical Screening & Medical Rule Engine: Pediatrics - MedicationTherapy (3).
...
class PediatricsMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Pediatrics (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PEDIATRICS_MEDICATIONTHERAPY_003"
    rule_name = "Pediatrics MedicationTherapy Screening Rule #3"
    category = "PEDIATRICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Pediatrics (MedicationTherapy)."""
        has_primary = donor_payload.get("has_pediatrics_medicationtherapy_primary", False)
        severity_score = donor_payload.get("pediatrics_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("pediatrics_medicationtherapy_lab_marker", 10.0)
