"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - PathogenTransmissionRisk (3).
...
class OncologyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Oncology PathogenTransmissionRisk Screening Rule #3"
    category = "ONCOLOGY"
