"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - HemodynamicsAssessment (3).
...
class ImmunologyHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Immunology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Immunology HemodynamicsAssessment Screening Rule #3"
    category = "IMMUNOLOGY"
