"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - ImmuneComplexRejection (3).
...
class HematologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Hematology ImmuneComplexRejection Screening Rule #3"
    category = "HEMATOLOGY"
