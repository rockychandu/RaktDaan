"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - AcuteCondition (2).
...
class HematologyAcuteConditionClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (AcuteCondition) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_ACUTECONDITION_002"
    rule_name = "Hematology AcuteCondition Screening Rule #2"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (AcuteCondition)."""
        has_primary = donor_payload.get("has_hematology_acutecondition_primary", False)
        severity_score = donor_payload.get("hematology_acutecondition_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_acutecondition_lab_marker", 10.0)
