"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - EndemicTravelExposure (3).
...
class PsychiatryEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Psychiatry EndemicTravelExposure Screening Rule #3"
    category = "PSYCHIATRY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Psychiatry (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_psychiatry_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("psychiatry_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("psychiatry_endemictravelexposure_lab_marker", 10.0)
