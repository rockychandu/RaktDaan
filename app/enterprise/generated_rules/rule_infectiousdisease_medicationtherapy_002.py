"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - MedicationTherapy (2).
...
class InfectiousDiseaseMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_MEDICATIONTHERAPY_002"
    rule_name = "InfectiousDisease MedicationTherapy Screening Rule #2"
