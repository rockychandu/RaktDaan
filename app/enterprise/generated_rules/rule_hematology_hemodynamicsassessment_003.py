"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - HemodynamicsAssessment (3).
...
class HematologyHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Hematology HemodynamicsAssessment Screening Rule #3"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (HemodynamicsAssessment)."""
        has_primary = donor_payload.get("has_hematology_hemodynamicsassessment_primary", False)
        severity_score = donor_payload.get("hematology_hemodynamicsassessment_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_hemodynamicsassessment_lab_marker", 10.0)
