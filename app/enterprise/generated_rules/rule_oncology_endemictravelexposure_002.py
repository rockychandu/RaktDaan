"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - EndemicTravelExposure (2).
...
class OncologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Oncology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Oncology EndemicTravelExposure Screening Rule #2"
    category = "ONCOLOGY"
