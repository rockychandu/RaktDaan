"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - SurgicalIntervention (1).
...
class HematologySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Hematology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_SURGICALINTERVENTION_001"
    rule_name = "Hematology SurgicalIntervention Screening Rule #1"
    category = "HEMATOLOGY"
