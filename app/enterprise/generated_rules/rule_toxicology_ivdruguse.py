"""
Clinical Rule Processor for Toxicology - IVDrugUse.
...
class IVDrugUseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for IVDrugUse.
    """
    rule_code = "RULE_TOXICOLOGY_IVDRUGUSE"
    rule_name = "IVDrugUse Screening Rule"
    category = "TOXICOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ivdruguse", False)
        is_active = data.get("is_ivdruguse_active", False)
        years_cured = data.get("years_cured_ivdruguse", 0.0)
