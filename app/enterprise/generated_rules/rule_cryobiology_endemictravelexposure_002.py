"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - EndemicTravelExposure (2).
...
class CryobiologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Cryobiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Cryobiology EndemicTravelExposure Screening Rule #2"
