"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - ChronicDisease (3).
...
class RheumatologyChronicDiseaseClinicalProcessor3:
    """
    Detailed decision processor evaluating Rheumatology (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_CHRONICDISEASE_003"
    rule_name = "Rheumatology ChronicDisease Screening Rule #3"
