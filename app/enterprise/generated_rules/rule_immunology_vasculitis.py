"""
Clinical Rule Processor for Immunology - Vasculitis.
...
class VasculitisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Vasculitis.
    """
    rule_code = "RULE_IMMUNOLOGY_VASCULITIS"
    rule_name = "Vasculitis Screening Rule"
    category = "IMMUNOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_vasculitis", False)
        is_active = data.get("is_vasculitis_active", False)
        years_cured = data.get("years_cured_vasculitis", 0.0)
