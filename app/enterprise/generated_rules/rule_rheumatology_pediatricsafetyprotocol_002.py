"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - PediatricSafetyProtocol (2).
...
class RheumatologyPediatricSafetyProtocolClinicalProcessor2:
    """
    Detailed decision processor evaluating Rheumatology (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_PEDIATRICSAFETYPROTOCOL_002"
    rule_name = "Rheumatology PediatricSafetyProtocol Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Rheumatology (PediatricSafetyProtocol)."""
        has_primary = donor_payload.get("has_rheumatology_pediatricsafetyprotocol_primary", False)
        severity_score = donor_payload.get("rheumatology_pediatricsafetyprotocol_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("rheumatology_pediatricsafetyprotocol_lab_marker", 10.0)
