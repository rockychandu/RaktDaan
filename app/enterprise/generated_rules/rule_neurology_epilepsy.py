"""
Clinical Rule Processor for Neurology - Epilepsy.
...
class EpilepsyClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Epilepsy.
    """
    rule_code = "RULE_NEUROLOGY_EPILEPSY"
    rule_name = "Epilepsy Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_epilepsy", False)
        is_active = data.get("is_epilepsy_active", False)
        years_cured = data.get("years_cured_epilepsy", 0.0)
