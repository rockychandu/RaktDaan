"""
Clinical Rule Processor for Gastroenterology - UlcerativeColitis.
...
class UlcerativeColitisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for UlcerativeColitis.
    """
    rule_code = "RULE_GASTROENTEROLOGY_ULCERATIVECOLITIS"
    rule_name = "UlcerativeColitis Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ulcerativecolitis", False)
        is_active = data.get("is_ulcerativecolitis_active", False)
        years_cured = data.get("years_cured_ulcerativecolitis", 0.0)
