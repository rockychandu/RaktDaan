"""
Clinical Rule Processor for Neurology - GuillainBarre.
...
class GuillainBarreClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for GuillainBarre.
    """
    rule_code = "RULE_NEUROLOGY_GUILLAINBARRE"
    rule_name = "GuillainBarre Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_guillainbarre", False)
        is_active = data.get("is_guillainbarre_active", False)
        years_cured = data.get("years_cured_guillainbarre", 0.0)
