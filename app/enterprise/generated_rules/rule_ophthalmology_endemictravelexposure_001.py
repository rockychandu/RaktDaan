"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - EndemicTravelExposure (1).
...
class OphthalmologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Ophthalmology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Ophthalmology EndemicTravelExposure Screening Rule #1"
