"""
Enterprise Clinical Screening & Medical Rule Engine: Bioterrorism - VaccinationDeferral (1).
...
class BioterrorismVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Bioterrorism (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOTERRORISM_VACCINATIONDEFERRAL_001"
    rule_name = "Bioterrorism VaccinationDeferral Screening Rule #1"
