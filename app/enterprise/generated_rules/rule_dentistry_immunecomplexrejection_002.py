"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - ImmuneComplexRejection (2).
...
class DentistryImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Dentistry (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Dentistry ImmuneComplexRejection Screening Rule #2"
    category = "DENTISTRY"
