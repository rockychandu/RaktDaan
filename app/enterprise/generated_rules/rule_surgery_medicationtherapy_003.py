"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - MedicationTherapy (3).
...
class SurgeryMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_MEDICATIONTHERAPY_003"
    rule_name = "Surgery MedicationTherapy Screening Rule #3"
    category = "SURGERY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Surgery (MedicationTherapy)."""
        has_primary = donor_payload.get("has_surgery_medicationtherapy_primary", False)
        severity_score = donor_payload.get("surgery_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("surgery_medicationtherapy_lab_marker", 10.0)
