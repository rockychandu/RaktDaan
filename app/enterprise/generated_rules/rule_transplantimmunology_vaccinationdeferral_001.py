"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - VaccinationDeferral (1).
...
class TransplantImmunologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating TransplantImmunology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "TransplantImmunology VaccinationDeferral Screening Rule #1"
