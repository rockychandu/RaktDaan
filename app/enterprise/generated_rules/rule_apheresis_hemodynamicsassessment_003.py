"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - HemodynamicsAssessment (3).
...
class ApheresisHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Apheresis HemodynamicsAssessment Screening Rule #3"
    category = "APHERESIS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Apheresis (HemodynamicsAssessment)."""
        has_primary = donor_payload.get("has_apheresis_hemodynamicsassessment_primary", False)
        severity_score = donor_payload.get("apheresis_hemodynamicsassessment_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("apheresis_hemodynamicsassessment_lab_marker", 10.0)
