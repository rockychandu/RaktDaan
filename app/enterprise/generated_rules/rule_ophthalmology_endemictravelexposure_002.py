"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - EndemicTravelExposure (2).
...
class OphthalmologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Ophthalmology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Ophthalmology EndemicTravelExposure Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Ophthalmology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_ophthalmology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("ophthalmology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("ophthalmology_endemictravelexposure_lab_marker", 10.0)
