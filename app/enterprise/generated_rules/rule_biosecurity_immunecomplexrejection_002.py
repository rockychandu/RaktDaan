"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - ImmuneComplexRejection (2).
...
class BiosecurityImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Biosecurity (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Biosecurity ImmuneComplexRejection Screening Rule #2"
