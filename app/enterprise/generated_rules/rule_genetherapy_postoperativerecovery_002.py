"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - PostOperativeRecovery (2).
...
class GeneTherapyPostOperativeRecoveryClinicalProcessor2:
    """
    Detailed decision processor evaluating GeneTherapy (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_POSTOPERATIVERECOVERY_002"
    rule_name = "GeneTherapy PostOperativeRecovery Screening Rule #2"
