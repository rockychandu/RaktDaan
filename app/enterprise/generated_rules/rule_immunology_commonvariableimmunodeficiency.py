"""
Clinical Rule Processor for Immunology - CommonVariableImmunodeficiency.
...
class CommonVariableImmunodeficiencyClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CommonVariableImmunodeficiency.
    """
    rule_code = "RULE_IMMUNOLOGY_COMMONVARIABLEIMMUNODEFICIENCY"
    rule_name = "CommonVariableImmunodeficiency Screening Rule"
    category = "IMMUNOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_commonvariableimmunodeficiency", False)
        is_active = data.get("is_commonvariableimmunodeficiency_active", False)
        years_cured = data.get("years_cured_commonvariableimmunodeficiency", 0.0)
