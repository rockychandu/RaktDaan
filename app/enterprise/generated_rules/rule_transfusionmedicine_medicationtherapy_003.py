"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - MedicationTherapy (3).
...
class TransfusionMedicineMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating TransfusionMedicine (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_MEDICATIONTHERAPY_003"
    rule_name = "TransfusionMedicine MedicationTherapy Screening Rule #3"
