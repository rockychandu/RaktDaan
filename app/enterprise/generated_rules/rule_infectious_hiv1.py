"""
Clinical Rule Processor for Infectious - HIV1.
...
class HIV1ClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HIV1.
    """
    rule_code = "RULE_INFECTIOUS_HIV1"
    rule_name = "HIV1 Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hiv1", False)
        is_active = data.get("is_hiv1_active", False)
        years_cured = data.get("years_cured_hiv1", 0.0)
