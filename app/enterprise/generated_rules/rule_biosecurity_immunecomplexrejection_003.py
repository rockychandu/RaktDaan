"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - ImmuneComplexRejection (3).
...
class BiosecurityImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Biosecurity (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Biosecurity ImmuneComplexRejection Screening Rule #3"
