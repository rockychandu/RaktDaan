"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - ImmuneComplexRejection (3).
...
class CardiologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Cardiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Cardiology ImmuneComplexRejection Screening Rule #3"
    category = "CARDIOLOGY"
