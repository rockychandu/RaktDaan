"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - MedicationTherapy (3).
...
class ImmunologyMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Immunology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_MEDICATIONTHERAPY_003"
    rule_name = "Immunology MedicationTherapy Screening Rule #3"
    category = "IMMUNOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Immunology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_immunology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("immunology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("immunology_medicationtherapy_lab_marker", 10.0)
