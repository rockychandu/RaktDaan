"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - GeneticRiskFactor (3).
...
class PsychiatryGeneticRiskFactorClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_GENETICRISKFACTOR_003"
    rule_name = "Psychiatry GeneticRiskFactor Screening Rule #3"
    category = "PSYCHIATRY"
