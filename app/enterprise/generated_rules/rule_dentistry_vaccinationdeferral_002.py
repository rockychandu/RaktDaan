"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - VaccinationDeferral (2).
...
class DentistryVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Dentistry (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_VACCINATIONDEFERRAL_002"
    rule_name = "Dentistry VaccinationDeferral Screening Rule #2"
    category = "DENTISTRY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Dentistry (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_dentistry_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("dentistry_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("dentistry_vaccinationdeferral_lab_marker", 10.0)
