"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - PathogenTransmissionRisk (3).
...
class GeriatricsPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Geriatrics (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Geriatrics PathogenTransmissionRisk Screening Rule #3"
    category = "GERIATRICS"
