"""
Clinical Rule Processor for Infectious - HepatitisC.
...
class HepatitisCClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HepatitisC.
    """
    rule_code = "RULE_INFECTIOUS_HEPATITISC"
    rule_name = "HepatitisC Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hepatitisc", False)
        is_active = data.get("is_hepatitisc_active", False)
        years_cured = data.get("years_cured_hepatitisc", 0.0)
