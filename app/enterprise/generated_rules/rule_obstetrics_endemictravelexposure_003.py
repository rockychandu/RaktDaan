"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - EndemicTravelExposure (3).
...
class ObstetricsEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Obstetrics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Obstetrics EndemicTravelExposure Screening Rule #3"
    category = "OBSTETRICS"
