"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - SurgicalIntervention (2).
...
class HematologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Hematology SurgicalIntervention Screening Rule #2"
    category = "HEMATOLOGY"
