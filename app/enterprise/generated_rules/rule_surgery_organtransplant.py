"""
Clinical Rule Processor for Surgery - OrganTransplant.
...
class OrganTransplantClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for OrganTransplant.
    """
    rule_code = "RULE_SURGERY_ORGANTRANSPLANT"
    rule_name = "OrganTransplant Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_organtransplant", False)
        is_active = data.get("is_organtransplant_active", False)
        years_cured = data.get("years_cured_organtransplant", 0.0)
