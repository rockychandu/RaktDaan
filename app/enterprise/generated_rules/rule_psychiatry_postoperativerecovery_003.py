"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - PostOperativeRecovery (3).
...
class PsychiatryPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_POSTOPERATIVERECOVERY_003"
    rule_name = "Psychiatry PostOperativeRecovery Screening Rule #3"
    category = "PSYCHIATRY"
