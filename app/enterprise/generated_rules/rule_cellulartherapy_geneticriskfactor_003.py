"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - GeneticRiskFactor (3).
...
class CellularTherapyGeneticRiskFactorClinicalProcessor3:
    """
    Detailed decision processor evaluating CellularTherapy (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_GENETICRISKFACTOR_003"
    rule_name = "CellularTherapy GeneticRiskFactor Screening Rule #3"
