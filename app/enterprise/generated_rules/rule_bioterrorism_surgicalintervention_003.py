"""
Enterprise Clinical Screening & Medical Rule Engine: Bioterrorism - SurgicalIntervention (3).
...
class BioterrorismSurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Bioterrorism (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOTERRORISM_SURGICALINTERVENTION_003"
    rule_name = "Bioterrorism SurgicalIntervention Screening Rule #3"
