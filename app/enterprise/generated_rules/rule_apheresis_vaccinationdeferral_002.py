"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - VaccinationDeferral (2).
...
class ApheresisVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_VACCINATIONDEFERRAL_002"
    rule_name = "Apheresis VaccinationDeferral Screening Rule #2"
    category = "APHERESIS"
