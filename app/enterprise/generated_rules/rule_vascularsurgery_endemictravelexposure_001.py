"""
Enterprise Clinical Screening & Medical Rule Engine: VascularSurgery - EndemicTravelExposure (1).
...
class VascularSurgeryEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating VascularSurgery (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_VASCULARSURGERY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "VascularSurgery EndemicTravelExposure Screening Rule #1"
