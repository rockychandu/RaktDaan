"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - VaccinationDeferral (3).
...
class ApheresisVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_VACCINATIONDEFERRAL_003"
    rule_name = "Apheresis VaccinationDeferral Screening Rule #3"
    category = "APHERESIS"
