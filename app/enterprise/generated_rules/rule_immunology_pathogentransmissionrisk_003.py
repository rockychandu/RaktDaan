"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - PathogenTransmissionRisk (3).
...
class ImmunologyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Immunology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Immunology PathogenTransmissionRisk Screening Rule #3"
    category = "IMMUNOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Immunology (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_immunology_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("immunology_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("immunology_pathogentransmissionrisk_lab_marker", 10.0)
