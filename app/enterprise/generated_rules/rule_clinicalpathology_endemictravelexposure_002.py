"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - EndemicTravelExposure (2).
...
class ClinicalPathologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating ClinicalPathology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "ClinicalPathology EndemicTravelExposure Screening Rule #2"
