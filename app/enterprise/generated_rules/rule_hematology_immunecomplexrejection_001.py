"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - ImmuneComplexRejection (1).
...
class HematologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Hematology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Hematology ImmuneComplexRejection Screening Rule #1"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_hematology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("hematology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_immunecomplexrejection_lab_marker", 10.0)
