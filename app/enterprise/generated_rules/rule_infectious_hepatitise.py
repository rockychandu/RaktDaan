"""
Clinical Rule Processor for Infectious - HepatitisE.
...
class HepatitisEClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HepatitisE.
    """
    rule_code = "RULE_INFECTIOUS_HEPATITISE"
    rule_name = "HepatitisE Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hepatitise", False)
        is_active = data.get("is_hepatitise_active", False)
        years_cured = data.get("years_cured_hepatitise", 0.0)
