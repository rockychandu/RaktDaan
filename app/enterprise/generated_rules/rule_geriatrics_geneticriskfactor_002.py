"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - GeneticRiskFactor (2).
...
class GeriatricsGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating Geriatrics (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_GENETICRISKFACTOR_002"
    rule_name = "Geriatrics GeneticRiskFactor Screening Rule #2"
    category = "GERIATRICS"
