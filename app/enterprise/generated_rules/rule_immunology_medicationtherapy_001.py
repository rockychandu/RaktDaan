"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - MedicationTherapy (1).
...
class ImmunologyMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating Immunology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_MEDICATIONTHERAPY_001"
    rule_name = "Immunology MedicationTherapy Screening Rule #1"
    category = "IMMUNOLOGY"
