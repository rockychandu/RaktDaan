"""
Clinical Rule Processor for Hematology - Hemochromatosis.
...
class HemochromatosisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Hemochromatosis.
    """
    rule_code = "RULE_HEMATOLOGY_HEMOCHROMATOSIS"
    rule_name = "Hemochromatosis Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hemochromatosis", False)
        is_active = data.get("is_hemochromatosis_active", False)
        years_cured = data.get("years_cured_hemochromatosis", 0.0)
