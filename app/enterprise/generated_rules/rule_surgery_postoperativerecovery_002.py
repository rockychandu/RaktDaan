"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - PostOperativeRecovery (2).
...
class SurgeryPostOperativeRecoveryClinicalProcessor2:
    """
    Detailed decision processor evaluating Surgery (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_POSTOPERATIVERECOVERY_002"
    rule_name = "Surgery PostOperativeRecovery Screening Rule #2"
    category = "SURGERY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Surgery (PostOperativeRecovery)."""
        has_primary = donor_payload.get("has_surgery_postoperativerecovery_primary", False)
        severity_score = donor_payload.get("surgery_postoperativerecovery_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("surgery_postoperativerecovery_lab_marker", 10.0)
