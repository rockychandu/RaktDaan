"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - EndemicTravelExposure (1).
...
class GeneTherapyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating GeneTherapy (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "GeneTherapy EndemicTravelExposure Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for GeneTherapy (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_genetherapy_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("genetherapy_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("genetherapy_endemictravelexposure_lab_marker", 10.0)
