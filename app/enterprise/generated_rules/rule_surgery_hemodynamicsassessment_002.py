"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - HemodynamicsAssessment (2).
...
class SurgeryHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating Surgery (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_HEMODYNAMICSASSESSMENT_002"
    rule_name = "Surgery HemodynamicsAssessment Screening Rule #2"
    category = "SURGERY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Surgery (HemodynamicsAssessment)."""
        has_primary = donor_payload.get("has_surgery_hemodynamicsassessment_primary", False)
        severity_score = donor_payload.get("surgery_hemodynamicsassessment_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("surgery_hemodynamicsassessment_lab_marker", 10.0)
