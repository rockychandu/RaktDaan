"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - MedicationTherapy (2).
...
class SurgeryMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Surgery (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_MEDICATIONTHERAPY_002"
    rule_name = "Surgery MedicationTherapy Screening Rule #2"
    category = "SURGERY"
