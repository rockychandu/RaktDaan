"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - VaccinationDeferral (1).
...
class SurgeryVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Surgery (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_VACCINATIONDEFERRAL_001"
    rule_name = "Surgery VaccinationDeferral Screening Rule #1"
    category = "SURGERY"
