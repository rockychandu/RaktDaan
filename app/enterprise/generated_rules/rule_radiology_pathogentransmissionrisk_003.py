"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - PathogenTransmissionRisk (3).
...
class RadiologyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Radiology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Radiology PathogenTransmissionRisk Screening Rule #3"
    category = "RADIOLOGY"
