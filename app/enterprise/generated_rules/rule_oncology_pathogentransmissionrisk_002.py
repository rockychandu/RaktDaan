"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - PathogenTransmissionRisk (2).
...
class OncologyPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Oncology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Oncology PathogenTransmissionRisk Screening Rule #2"
    category = "ONCOLOGY"
