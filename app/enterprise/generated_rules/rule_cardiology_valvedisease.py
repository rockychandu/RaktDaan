"""
Clinical Rule Processor for Cardiology - ValveDisease.
...
class ValveDiseaseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for ValveDisease.
    """
    rule_code = "RULE_CARDIOLOGY_VALVEDISEASE"
    rule_name = "ValveDisease Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_valvedisease", False)
        is_active = data.get("is_valvedisease_active", False)
        years_cured = data.get("years_cured_valvedisease", 0.0)
