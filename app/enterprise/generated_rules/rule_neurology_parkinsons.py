"""
Clinical Rule Processor for Neurology - Parkinsons.
...
class ParkinsonsClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Parkinsons.
    """
    rule_code = "RULE_NEUROLOGY_PARKINSONS"
    rule_name = "Parkinsons Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_parkinsons", False)
        is_active = data.get("is_parkinsons_active", False)
        years_cured = data.get("years_cured_parkinsons", 0.0)
