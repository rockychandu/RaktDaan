"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - ImmuneComplexRejection (2).
...
class EpidemiologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Epidemiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Epidemiology ImmuneComplexRejection Screening Rule #2"
