"""
Clinical Rule Processor for Cardiology - Arrhythmia.
...
class ArrhythmiaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Arrhythmia.
    """
    rule_code = "RULE_CARDIOLOGY_ARRHYTHMIA"
    rule_name = "Arrhythmia Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_arrhythmia", False)
        is_active = data.get("is_arrhythmia_active", False)
        years_cured = data.get("years_cured_arrhythmia", 0.0)
