"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - AcuteCondition (3).
...
class ObstetricsAcuteConditionClinicalProcessor3:
    """
    Detailed decision processor evaluating Obstetrics (AcuteCondition) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_ACUTECONDITION_003"
    rule_name = "Obstetrics AcuteCondition Screening Rule #3"
    category = "OBSTETRICS"
