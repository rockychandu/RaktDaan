"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - HemodynamicsAssessment (2).
...
class ApheresisHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_HEMODYNAMICSASSESSMENT_002"
    rule_name = "Apheresis HemodynamicsAssessment Screening Rule #2"
    category = "APHERESIS"
