"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - SurgicalIntervention (1).
...
class OncologySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Oncology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_SURGICALINTERVENTION_001"
    rule_name = "Oncology SurgicalIntervention Screening Rule #1"
    category = "ONCOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Oncology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_oncology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("oncology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("oncology_surgicalintervention_lab_marker", 10.0)
