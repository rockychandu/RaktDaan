"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - DiagnosticLaboratoryMarker (3).
...
class ApheresisDiagnosticLaboratoryMarkerClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (DiagnosticLaboratoryMarker) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_DIAGNOSTICLABORATORYMARKER_003"
    rule_name = "Apheresis DiagnosticLaboratoryMarker Screening Rule #3"
    category = "APHERESIS"
