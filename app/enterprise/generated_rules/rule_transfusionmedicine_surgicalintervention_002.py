"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - SurgicalIntervention (2).
...
class TransfusionMedicineSurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating TransfusionMedicine (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_SURGICALINTERVENTION_002"
    rule_name = "TransfusionMedicine SurgicalIntervention Screening Rule #2"
