"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - GeriatricReserveEvaluation (3).
...
class HematologyGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Hematology GeriatricReserveEvaluation Screening Rule #3"
    category = "HEMATOLOGY"
