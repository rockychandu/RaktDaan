"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - PathogenTransmissionRisk (3).
...
class CellularTherapyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating CellularTherapy (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "CellularTherapy PathogenTransmissionRisk Screening Rule #3"
