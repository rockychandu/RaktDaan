"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - EndemicTravelExposure (2).
...
class DentistryEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Dentistry (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Dentistry EndemicTravelExposure Screening Rule #2"
    category = "DENTISTRY"
