"""
Clinical Rule Processor for Surgery - Neurosurgery.
...
class NeurosurgeryClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Neurosurgery.
    """
    rule_code = "RULE_SURGERY_NEUROSURGERY"
    rule_name = "Neurosurgery Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_neurosurgery", False)
        is_active = data.get("is_neurosurgery_active", False)
        years_cured = data.get("years_cured_neurosurgery", 0.0)
