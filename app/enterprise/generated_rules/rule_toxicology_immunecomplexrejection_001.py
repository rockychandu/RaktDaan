"""
Enterprise Clinical Screening & Medical Rule Engine: Toxicology - ImmuneComplexRejection (1).
...
class ToxicologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Toxicology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TOXICOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Toxicology ImmuneComplexRejection Screening Rule #1"
    category = "TOXICOLOGY"
