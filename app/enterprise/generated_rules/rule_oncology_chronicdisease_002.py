"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - ChronicDisease (2).
...
class OncologyChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating Oncology (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_CHRONICDISEASE_002"
    rule_name = "Oncology ChronicDisease Screening Rule #2"
    category = "ONCOLOGY"
