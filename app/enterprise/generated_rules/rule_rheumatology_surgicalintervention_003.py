"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - SurgicalIntervention (3).
...
class RheumatologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Rheumatology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Rheumatology SurgicalIntervention Screening Rule #3"
