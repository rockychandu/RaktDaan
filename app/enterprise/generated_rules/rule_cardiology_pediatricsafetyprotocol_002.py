"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - PediatricSafetyProtocol (2).
...
class CardiologyPediatricSafetyProtocolClinicalProcessor2:
    """
    Detailed decision processor evaluating Cardiology (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_PEDIATRICSAFETYPROTOCOL_002"
    rule_name = "Cardiology PediatricSafetyProtocol Screening Rule #2"
    category = "CARDIOLOGY"
