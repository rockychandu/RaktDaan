"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - EndemicTravelExposure (2).
...
class CardiologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Cardiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Cardiology EndemicTravelExposure Screening Rule #2"
    category = "CARDIOLOGY"
