"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - HemodynamicsAssessment (3).
...
class PsychiatryHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Psychiatry HemodynamicsAssessment Screening Rule #3"
    category = "PSYCHIATRY"
