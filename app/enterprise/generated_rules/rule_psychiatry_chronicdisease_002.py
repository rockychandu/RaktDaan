"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - ChronicDisease (2).
...
class PsychiatryChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_CHRONICDISEASE_002"
    rule_name = "Psychiatry ChronicDisease Screening Rule #2"
    category = "PSYCHIATRY"
