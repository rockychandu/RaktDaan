"""
Enterprise Clinical Screening & Medical Rule Engine: Genetics - EndemicTravelExposure (1).
...
class GeneticsEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Genetics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETICS_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Genetics EndemicTravelExposure Screening Rule #1"
    category = "GENETICS"
