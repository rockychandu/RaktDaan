"""
Enterprise Clinical Screening & Medical Rule Engine: Genetics - EndemicTravelExposure (2).
...
class GeneticsEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Genetics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETICS_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Genetics EndemicTravelExposure Screening Rule #2"
    category = "GENETICS"
