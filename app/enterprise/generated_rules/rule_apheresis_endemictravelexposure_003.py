"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - EndemicTravelExposure (3).
...
class ApheresisEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Apheresis EndemicTravelExposure Screening Rule #3"
    category = "APHERESIS"
