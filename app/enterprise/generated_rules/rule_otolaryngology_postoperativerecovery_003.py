"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - PostOperativeRecovery (3).
...
class OtolaryngologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Otolaryngology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Otolaryngology PostOperativeRecovery Screening Rule #3"
