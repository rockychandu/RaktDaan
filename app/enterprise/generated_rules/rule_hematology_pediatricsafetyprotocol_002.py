"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - PediatricSafetyProtocol (2).
...
class HematologyPediatricSafetyProtocolClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_PEDIATRICSAFETYPROTOCOL_002"
    rule_name = "Hematology PediatricSafetyProtocol Screening Rule #2"
    category = "HEMATOLOGY"
