"""
Enterprise Clinical Screening & Medical Rule Engine: Genetics - ImmuneComplexRejection (3).
...
class GeneticsImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Genetics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETICS_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Genetics ImmuneComplexRejection Screening Rule #3"
    category = "GENETICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Genetics (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_genetics_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("genetics_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("genetics_immunecomplexrejection_lab_marker", 10.0)
