"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - GeriatricReserveEvaluation (1).
...
class HematologyGeriatricReserveEvaluationClinicalProcessor1:
    """
    Detailed decision processor evaluating Hematology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_GERIATRICRESERVEEVALUATION_001"
    rule_name = "Hematology GeriatricReserveEvaluation Screening Rule #1"
    category = "HEMATOLOGY"
