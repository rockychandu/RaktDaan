"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - SurgicalIntervention (3).
...
class ApheresisSurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_SURGICALINTERVENTION_003"
    rule_name = "Apheresis SurgicalIntervention Screening Rule #3"
    category = "APHERESIS"
