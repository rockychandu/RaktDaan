"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - PathogenTransmissionRisk (2).
...
class OphthalmologyPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Ophthalmology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Ophthalmology PathogenTransmissionRisk Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Ophthalmology (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_ophthalmology_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("ophthalmology_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("ophthalmology_pathogentransmissionrisk_lab_marker", 10.0)
