"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - ImmuneComplexRejection (1).
...
class ImmunologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Immunology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Immunology ImmuneComplexRejection Screening Rule #1"
    category = "IMMUNOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Immunology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_immunology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("immunology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("immunology_immunecomplexrejection_lab_marker", 10.0)
