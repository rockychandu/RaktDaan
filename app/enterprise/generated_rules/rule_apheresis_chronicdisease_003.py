"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - ChronicDisease (3).
...
class ApheresisChronicDiseaseClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_CHRONICDISEASE_003"
    rule_name = "Apheresis ChronicDisease Screening Rule #3"
    category = "APHERESIS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Apheresis (ChronicDisease)."""
        has_primary = donor_payload.get("has_apheresis_chronicdisease_primary", False)
        severity_score = donor_payload.get("apheresis_chronicdisease_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("apheresis_chronicdisease_lab_marker", 10.0)
