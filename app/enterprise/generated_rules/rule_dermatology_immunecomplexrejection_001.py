"""
Enterprise Clinical Screening & Medical Rule Engine: Dermatology - ImmuneComplexRejection (1).
...
class DermatologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Dermatology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DERMATOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Dermatology ImmuneComplexRejection Screening Rule #1"
