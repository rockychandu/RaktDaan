"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - VaccinationDeferral (1).
...
class RadiologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Radiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Radiology VaccinationDeferral Screening Rule #1"
    category = "RADIOLOGY"
