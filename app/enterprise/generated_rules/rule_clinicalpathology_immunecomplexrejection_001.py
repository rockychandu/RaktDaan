"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - ImmuneComplexRejection (1).
...
class ClinicalPathologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating ClinicalPathology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "ClinicalPathology ImmuneComplexRejection Screening Rule #1"
