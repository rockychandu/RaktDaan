"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - EndemicTravelExposure (2).
...
class TransplantImmunologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating TransplantImmunology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "TransplantImmunology EndemicTravelExposure Screening Rule #2"
