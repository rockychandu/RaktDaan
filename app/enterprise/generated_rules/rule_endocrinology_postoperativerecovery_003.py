"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - PostOperativeRecovery (3).
...
class EndocrinologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Endocrinology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Endocrinology PostOperativeRecovery Screening Rule #3"
