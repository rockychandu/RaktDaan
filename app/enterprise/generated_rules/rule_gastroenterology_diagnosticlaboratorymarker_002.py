"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - DiagnosticLaboratoryMarker (2).
...
class GastroenterologyDiagnosticLaboratoryMarkerClinicalProcessor2:
    """
    Detailed decision processor evaluating Gastroenterology (DiagnosticLaboratoryMarker) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_DIAGNOSTICLABORATORYMARKER_002"
    rule_name = "Gastroenterology DiagnosticLaboratoryMarker Screening Rule #2"
