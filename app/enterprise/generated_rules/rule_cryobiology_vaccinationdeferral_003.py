"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - VaccinationDeferral (3).
...
class CryobiologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Cryobiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Cryobiology VaccinationDeferral Screening Rule #3"
