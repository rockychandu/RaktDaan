"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - SurgicalIntervention (3).
...
class CryobiologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Cryobiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Cryobiology SurgicalIntervention Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Cryobiology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_cryobiology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("cryobiology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cryobiology_surgicalintervention_lab_marker", 10.0)
