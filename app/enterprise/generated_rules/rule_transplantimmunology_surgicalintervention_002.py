"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - SurgicalIntervention (2).
...
class TransplantImmunologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating TransplantImmunology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_SURGICALINTERVENTION_002"
    rule_name = "TransplantImmunology SurgicalIntervention Screening Rule #2"
