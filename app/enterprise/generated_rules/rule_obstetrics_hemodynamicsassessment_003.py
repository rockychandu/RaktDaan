"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - HemodynamicsAssessment (3).
...
class ObstetricsHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Obstetrics (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Obstetrics HemodynamicsAssessment Screening Rule #3"
    category = "OBSTETRICS"
