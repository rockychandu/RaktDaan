"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - VaccinationDeferral (1).
...
class ImmunologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Immunology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Immunology VaccinationDeferral Screening Rule #1"
    category = "IMMUNOLOGY"
