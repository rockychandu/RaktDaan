"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - MedicationTherapy (2).
...
class RadiologyMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Radiology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_MEDICATIONTHERAPY_002"
    rule_name = "Radiology MedicationTherapy Screening Rule #2"
    category = "RADIOLOGY"
