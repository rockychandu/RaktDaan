"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - PostOperativeRecovery (3).
...
class GeneTherapyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating GeneTherapy (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_POSTOPERATIVERECOVERY_003"
    rule_name = "GeneTherapy PostOperativeRecovery Screening Rule #3"
