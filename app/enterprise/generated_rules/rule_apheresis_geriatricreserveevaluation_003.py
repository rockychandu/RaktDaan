"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - GeriatricReserveEvaluation (3).
...
class ApheresisGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Apheresis GeriatricReserveEvaluation Screening Rule #3"
    category = "APHERESIS"
