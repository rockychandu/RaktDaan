"""
Clinical Rule Processor for Infectious - Syphilis.
...
class SyphilisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Syphilis.
    """
    rule_code = "RULE_INFECTIOUS_SYPHILIS"
    rule_name = "Syphilis Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_syphilis", False)
        is_active = data.get("is_syphilis_active", False)
        years_cured = data.get("years_cured_syphilis", 0.0)
