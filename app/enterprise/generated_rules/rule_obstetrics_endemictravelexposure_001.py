"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - EndemicTravelExposure (1).
...
class ObstetricsEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Obstetrics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Obstetrics EndemicTravelExposure Screening Rule #1"
    category = "OBSTETRICS"
