"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PathogenTransmissionRisk (2).
...
class ApheresisPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Apheresis PathogenTransmissionRisk Screening Rule #2"
    category = "APHERESIS"
