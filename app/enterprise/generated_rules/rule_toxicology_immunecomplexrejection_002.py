"""
Enterprise Clinical Screening & Medical Rule Engine: Toxicology - ImmuneComplexRejection (2).
...
class ToxicologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Toxicology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TOXICOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Toxicology ImmuneComplexRejection Screening Rule #2"
    category = "TOXICOLOGY"
