"""
Enterprise Clinical Screening & Medical Rule Engine: Pediatrics - ImmuneComplexRejection (3).
...
class PediatricsImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Pediatrics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PEDIATRICS_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Pediatrics ImmuneComplexRejection Screening Rule #3"
    category = "PEDIATRICS"
