"""
Clinical Rule Processor for Hematology - Leukemia.
...
class LeukemiaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Leukemia.
    """
    rule_code = "RULE_HEMATOLOGY_LEUKEMIA"
    rule_name = "Leukemia Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_leukemia", False)
        is_active = data.get("is_leukemia_active", False)
        years_cured = data.get("years_cured_leukemia", 0.0)
