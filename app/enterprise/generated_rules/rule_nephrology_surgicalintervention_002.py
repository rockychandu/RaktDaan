"""
Enterprise Clinical Screening & Medical Rule Engine: Nephrology - SurgicalIntervention (2).
...
class NephrologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Nephrology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEPHROLOGY_SURGICALINTERVENTION_002"
    rule_name = "Nephrology SurgicalIntervention Screening Rule #2"
    category = "NEPHROLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Nephrology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_nephrology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("nephrology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("nephrology_surgicalintervention_lab_marker", 10.0)
