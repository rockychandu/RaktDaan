"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - ImmuneComplexRejection (3).
...
class EndocrinologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Endocrinology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Endocrinology ImmuneComplexRejection Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Endocrinology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_endocrinology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("endocrinology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("endocrinology_immunecomplexrejection_lab_marker", 10.0)
