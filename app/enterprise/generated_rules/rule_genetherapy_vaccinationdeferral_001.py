"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - VaccinationDeferral (1).
...
class GeneTherapyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating GeneTherapy (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_VACCINATIONDEFERRAL_001"
    rule_name = "GeneTherapy VaccinationDeferral Screening Rule #1"
