"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - PostOperativeRecovery (2).
...
class InfectiousDiseasePostOperativeRecoveryClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_POSTOPERATIVERECOVERY_002"
    rule_name = "InfectiousDisease PostOperativeRecovery Screening Rule #2"
