"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - SurgicalIntervention (2).
...
class ObstetricsSurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_SURGICALINTERVENTION_002"
    rule_name = "Obstetrics SurgicalIntervention Screening Rule #2"
    category = "OBSTETRICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Obstetrics (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_obstetrics_surgicalintervention_primary", False)
        severity_score = donor_payload.get("obstetrics_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("obstetrics_surgicalintervention_lab_marker", 10.0)
