"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - EndemicTravelExposure (1).
...
class OtolaryngologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Otolaryngology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Otolaryngology EndemicTravelExposure Screening Rule #1"
