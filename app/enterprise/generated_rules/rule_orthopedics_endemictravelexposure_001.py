"""
Enterprise Clinical Screening & Medical Rule Engine: Orthopedics - EndemicTravelExposure (1).
...
class OrthopedicsEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Orthopedics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ORTHOPEDICS_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Orthopedics EndemicTravelExposure Screening Rule #1"
