"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - ImmuneComplexRejection (1).
...
class EndocrinologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Endocrinology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Endocrinology ImmuneComplexRejection Screening Rule #1"
