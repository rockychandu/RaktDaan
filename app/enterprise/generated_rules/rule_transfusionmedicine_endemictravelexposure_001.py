"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - EndemicTravelExposure (1).
...
class TransfusionMedicineEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating TransfusionMedicine (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "TransfusionMedicine EndemicTravelExposure Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for TransfusionMedicine (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_transfusionmedicine_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("transfusionmedicine_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("transfusionmedicine_endemictravelexposure_lab_marker", 10.0)
