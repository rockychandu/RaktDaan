"""
Enterprise Clinical Screening & Medical Rule Engine: VascularSurgery - MedicationTherapy (1).
...
class VascularSurgeryMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating VascularSurgery (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_VASCULARSURGERY_MEDICATIONTHERAPY_001"
    rule_name = "VascularSurgery MedicationTherapy Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for VascularSurgery (MedicationTherapy)."""
        has_primary = donor_payload.get("has_vascularsurgery_medicationtherapy_primary", False)
        severity_score = donor_payload.get("vascularsurgery_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("vascularsurgery_medicationtherapy_lab_marker", 10.0)
