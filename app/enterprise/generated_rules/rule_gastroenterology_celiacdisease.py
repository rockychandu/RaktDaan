"""
Clinical Rule Processor for Gastroenterology - CeliacDisease.
...
class CeliacDiseaseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CeliacDisease.
    """
    rule_code = "RULE_GASTROENTEROLOGY_CELIACDISEASE"
    rule_name = "CeliacDisease Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_celiacdisease", False)
        is_active = data.get("is_celiacdisease_active", False)
        years_cured = data.get("years_cured_celiacdisease", 0.0)
