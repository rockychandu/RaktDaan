"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - PostOperativeRecovery (3).
...
class HematologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Hematology PostOperativeRecovery Screening Rule #3"
    category = "HEMATOLOGY"
