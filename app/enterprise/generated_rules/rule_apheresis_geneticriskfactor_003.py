"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - GeneticRiskFactor (3).
...
class ApheresisGeneticRiskFactorClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_GENETICRISKFACTOR_003"
    rule_name = "Apheresis GeneticRiskFactor Screening Rule #3"
    category = "APHERESIS"
