"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - GeriatricReserveEvaluation (3).
...
class CardiologyGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Cardiology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Cardiology GeriatricReserveEvaluation Screening Rule #3"
    category = "CARDIOLOGY"
