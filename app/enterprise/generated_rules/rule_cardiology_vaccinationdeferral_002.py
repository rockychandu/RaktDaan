"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - VaccinationDeferral (2).
...
class CardiologyVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Cardiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_VACCINATIONDEFERRAL_002"
    rule_name = "Cardiology VaccinationDeferral Screening Rule #2"
    category = "CARDIOLOGY"
