"""
Enterprise Clinical Screening & Medical Rule Engine: ClinicalPathology - EndemicTravelExposure (1).
...
class ClinicalPathologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating ClinicalPathology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CLINICALPATHOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "ClinicalPathology EndemicTravelExposure Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for ClinicalPathology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_clinicalpathology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("clinicalpathology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("clinicalpathology_endemictravelexposure_lab_marker", 10.0)
