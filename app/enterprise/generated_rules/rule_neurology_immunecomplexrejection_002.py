"""
Enterprise Clinical Screening & Medical Rule Engine: Neurology - ImmuneComplexRejection (2).
...
class NeurologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Neurology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEUROLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Neurology ImmuneComplexRejection Screening Rule #2"
    category = "NEUROLOGY"
