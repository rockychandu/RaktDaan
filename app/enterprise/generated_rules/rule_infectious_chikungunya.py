"""
Clinical Rule Processor for Infectious - Chikungunya.
...
class ChikungunyaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Chikungunya.
    """
    rule_code = "RULE_INFECTIOUS_CHIKUNGUNYA"
    rule_name = "Chikungunya Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_chikungunya", False)
        is_active = data.get("is_chikungunya_active", False)
        years_cured = data.get("years_cured_chikungunya", 0.0)
