"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - GeneticRiskFactor (2).
...
class GeneTherapyGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating GeneTherapy (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_GENETICRISKFACTOR_002"
    rule_name = "GeneTherapy GeneticRiskFactor Screening Rule #2"
