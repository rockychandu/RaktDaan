"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - AcuteCondition (3).
...
class HematologyAcuteConditionClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (AcuteCondition) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_ACUTECONDITION_003"
    rule_name = "Hematology AcuteCondition Screening Rule #3"
    category = "HEMATOLOGY"
