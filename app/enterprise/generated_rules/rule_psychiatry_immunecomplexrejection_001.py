"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - ImmuneComplexRejection (1).
...
class PsychiatryImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Psychiatry (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Psychiatry ImmuneComplexRejection Screening Rule #1"
    category = "PSYCHIATRY"
