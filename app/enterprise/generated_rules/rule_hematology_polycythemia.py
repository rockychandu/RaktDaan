"""
Clinical Rule Processor for Hematology - Polycythemia.
...
class PolycythemiaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Polycythemia.
    """
    rule_code = "RULE_HEMATOLOGY_POLYCYTHEMIA"
    rule_name = "Polycythemia Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_polycythemia", False)
        is_active = data.get("is_polycythemia_active", False)
        years_cured = data.get("years_cured_polycythemia", 0.0)
