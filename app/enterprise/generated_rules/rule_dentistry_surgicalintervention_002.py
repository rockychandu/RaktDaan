"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - SurgicalIntervention (2).
...
class DentistrySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Dentistry (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_SURGICALINTERVENTION_002"
    rule_name = "Dentistry SurgicalIntervention Screening Rule #2"
    category = "DENTISTRY"
