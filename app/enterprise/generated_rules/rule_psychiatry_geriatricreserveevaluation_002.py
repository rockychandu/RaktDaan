"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - GeriatricReserveEvaluation (2).
...
class PsychiatryGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_GERIATRICRESERVEEVALUATION_002"
    rule_name = "Psychiatry GeriatricReserveEvaluation Screening Rule #2"
    category = "PSYCHIATRY"
