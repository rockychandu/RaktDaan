"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - ImmuneComplexRejection (1).
...
class CryobiologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Cryobiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Cryobiology ImmuneComplexRejection Screening Rule #1"
