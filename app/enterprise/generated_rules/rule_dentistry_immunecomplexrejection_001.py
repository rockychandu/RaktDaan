"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - ImmuneComplexRejection (1).
...
class DentistryImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Dentistry (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Dentistry ImmuneComplexRejection Screening Rule #1"
    category = "DENTISTRY"
