"""
Enterprise Clinical Screening & Medical Rule Engine: Genetics - ImmuneComplexRejection (2).
...
class GeneticsImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Genetics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETICS_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Genetics ImmuneComplexRejection Screening Rule #2"
    category = "GENETICS"
