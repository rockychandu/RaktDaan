"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - HemodynamicsAssessment (2).
...
class GeneTherapyHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating GeneTherapy (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_HEMODYNAMICSASSESSMENT_002"
    rule_name = "GeneTherapy HemodynamicsAssessment Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for GeneTherapy (HemodynamicsAssessment)."""
        has_primary = donor_payload.get("has_genetherapy_hemodynamicsassessment_primary", False)
        severity_score = donor_payload.get("genetherapy_hemodynamicsassessment_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("genetherapy_hemodynamicsassessment_lab_marker", 10.0)
