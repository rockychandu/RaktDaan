"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - ChronicDisease (2).
...
class InfectiousDiseaseChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_CHRONICDISEASE_002"
    rule_name = "InfectiousDisease ChronicDisease Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for InfectiousDisease (ChronicDisease)."""
        has_primary = donor_payload.get("has_infectiousdisease_chronicdisease_primary", False)
        severity_score = donor_payload.get("infectiousdisease_chronicdisease_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("infectiousdisease_chronicdisease_lab_marker", 10.0)
