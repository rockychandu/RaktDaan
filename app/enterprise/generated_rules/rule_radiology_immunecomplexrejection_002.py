"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - ImmuneComplexRejection (2).
...
class RadiologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Radiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Radiology ImmuneComplexRejection Screening Rule #2"
    category = "RADIOLOGY"
