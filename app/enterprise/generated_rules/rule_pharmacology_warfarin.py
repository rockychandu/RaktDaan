"""
Clinical Rule Processor for Pharmacology - Warfarin.
...
class WarfarinClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Warfarin.
    """
    rule_code = "RULE_PHARMACOLOGY_WARFARIN"
    rule_name = "Warfarin Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_warfarin", False)
        is_active = data.get("is_warfarin_active", False)
        years_cured = data.get("years_cured_warfarin", 0.0)
