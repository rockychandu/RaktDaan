"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - SurgicalIntervention (2).
...
class OphthalmologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Ophthalmology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Ophthalmology SurgicalIntervention Screening Rule #2"
