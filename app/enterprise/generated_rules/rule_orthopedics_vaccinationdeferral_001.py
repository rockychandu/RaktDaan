"""
Enterprise Clinical Screening & Medical Rule Engine: Orthopedics - VaccinationDeferral (1).
...
class OrthopedicsVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Orthopedics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ORTHOPEDICS_VACCINATIONDEFERRAL_001"
    rule_name = "Orthopedics VaccinationDeferral Screening Rule #1"
