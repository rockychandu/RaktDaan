"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - EndemicTravelExposure (1).
...
class SurgeryEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Surgery (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Surgery EndemicTravelExposure Screening Rule #1"
    category = "SURGERY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Surgery (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_surgery_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("surgery_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("surgery_endemictravelexposure_lab_marker", 10.0)
