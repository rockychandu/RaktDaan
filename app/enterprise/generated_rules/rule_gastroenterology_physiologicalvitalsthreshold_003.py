"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - PhysiologicalVitalsThreshold (3).
...
class GastroenterologyPhysiologicalVitalsThresholdClinicalProcessor3:
    """
    Detailed decision processor evaluating Gastroenterology (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_PHYSIOLOGICALVITALSTHRESHOLD_003"
    rule_name = "Gastroenterology PhysiologicalVitalsThreshold Screening Rule #3"
