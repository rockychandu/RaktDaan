"""
Clinical Rule Processor for Surgery - DuraMaterGraft.
...
class DuraMaterGraftClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for DuraMaterGraft.
    """
    rule_code = "RULE_SURGERY_DURAMATERGRAFT"
    rule_name = "DuraMaterGraft Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_duramatergraft", False)
        is_active = data.get("is_duramatergraft_active", False)
        years_cured = data.get("years_cured_duramatergraft", 0.0)
