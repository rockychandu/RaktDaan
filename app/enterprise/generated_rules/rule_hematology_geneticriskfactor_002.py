"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - GeneticRiskFactor (2).
...
class HematologyGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_GENETICRISKFACTOR_002"
    rule_name = "Hematology GeneticRiskFactor Screening Rule #2"
    category = "HEMATOLOGY"
