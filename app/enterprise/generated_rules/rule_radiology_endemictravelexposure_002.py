"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - EndemicTravelExposure (2).
...
class RadiologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Radiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Radiology EndemicTravelExposure Screening Rule #2"
    category = "RADIOLOGY"
