"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - ImmuneComplexRejection (3).
...
class OncologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Oncology ImmuneComplexRejection Screening Rule #3"
    category = "ONCOLOGY"
