"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - VaccinationDeferral (2).
...
class HemovigilanceVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Hemovigilance (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_VACCINATIONDEFERRAL_002"
    rule_name = "Hemovigilance VaccinationDeferral Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hemovigilance (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_hemovigilance_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("hemovigilance_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hemovigilance_vaccinationdeferral_lab_marker", 10.0)
