"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - PostOperativeRecovery (1).
...
class OncologyPostOperativeRecoveryClinicalProcessor1:
    """
    Detailed decision processor evaluating Oncology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_POSTOPERATIVERECOVERY_001"
    rule_name = "Oncology PostOperativeRecovery Screening Rule #1"
    category = "ONCOLOGY"
