"""
Clinical Rule Processor for Infectious - QFever.
...
class QFeverClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for QFever.
    """
    rule_code = "RULE_INFECTIOUS_QFEVER"
    rule_name = "QFever Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_qfever", False)
        is_active = data.get("is_qfever_active", False)
        years_cured = data.get("years_cured_qfever", 0.0)
