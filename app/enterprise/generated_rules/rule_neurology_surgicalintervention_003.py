"""
Enterprise Clinical Screening & Medical Rule Engine: Neurology - SurgicalIntervention (3).
...
class NeurologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Neurology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEUROLOGY_SURGICALINTERVENTION_003"
    rule_name = "Neurology SurgicalIntervention Screening Rule #3"
    category = "NEUROLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Neurology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_neurology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("neurology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("neurology_surgicalintervention_lab_marker", 10.0)
