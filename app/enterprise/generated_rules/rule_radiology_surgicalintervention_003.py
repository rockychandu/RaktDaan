"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - SurgicalIntervention (3).
...
class RadiologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Radiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Radiology SurgicalIntervention Screening Rule #3"
    category = "RADIOLOGY"
