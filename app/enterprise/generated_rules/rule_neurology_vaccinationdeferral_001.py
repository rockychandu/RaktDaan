"""
Enterprise Clinical Screening & Medical Rule Engine: Neurology - VaccinationDeferral (1).
...
class NeurologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Neurology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEUROLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Neurology VaccinationDeferral Screening Rule #1"
    category = "NEUROLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Neurology (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_neurology_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("neurology_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("neurology_vaccinationdeferral_lab_marker", 10.0)
