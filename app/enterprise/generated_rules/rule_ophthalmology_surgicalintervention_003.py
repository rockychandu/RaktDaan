"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - SurgicalIntervention (3).
...
class OphthalmologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Ophthalmology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Ophthalmology SurgicalIntervention Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Ophthalmology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_ophthalmology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("ophthalmology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("ophthalmology_surgicalintervention_lab_marker", 10.0)
