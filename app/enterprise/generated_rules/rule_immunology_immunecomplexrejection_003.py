"""
Enterprise Clinical Screening & Medical Rule Engine: Immunology - ImmuneComplexRejection (3).
...
class ImmunologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Immunology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_IMMUNOLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Immunology ImmuneComplexRejection Screening Rule #3"
    category = "IMMUNOLOGY"
