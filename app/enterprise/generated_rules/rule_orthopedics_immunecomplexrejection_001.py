"""
Enterprise Clinical Screening & Medical Rule Engine: Orthopedics - ImmuneComplexRejection (1).
...
class OrthopedicsImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Orthopedics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ORTHOPEDICS_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Orthopedics ImmuneComplexRejection Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Orthopedics (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_orthopedics_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("orthopedics_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("orthopedics_immunecomplexrejection_lab_marker", 10.0)
