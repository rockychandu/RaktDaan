"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - GeriatricReserveEvaluation (1).
...
class InfectiousDiseaseGeriatricReserveEvaluationClinicalProcessor1:
    """
    Detailed decision processor evaluating InfectiousDisease (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_GERIATRICRESERVEEVALUATION_001"
    rule_name = "InfectiousDisease GeriatricReserveEvaluation Screening Rule #1"
