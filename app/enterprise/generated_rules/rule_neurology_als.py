"""
Clinical Rule Processor for Neurology - ALS.
...
class ALSClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for ALS.
    """
    rule_code = "RULE_NEUROLOGY_ALS"
    rule_name = "ALS Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_als", False)
        is_active = data.get("is_als_active", False)
        years_cured = data.get("years_cured_als", 0.0)
