"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - ChronicDisease (1).
...
class ApheresisChronicDiseaseClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_CHRONICDISEASE_001"
    rule_name = "Apheresis ChronicDisease Screening Rule #1"
    category = "APHERESIS"
