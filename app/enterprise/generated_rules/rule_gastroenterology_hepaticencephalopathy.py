"""
Clinical Rule Processor for Gastroenterology - HepaticEncephalopathy.
...
class HepaticEncephalopathyClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HepaticEncephalopathy.
    """
    rule_code = "RULE_GASTROENTEROLOGY_HEPATICENCEPHALOPATHY"
    rule_name = "HepaticEncephalopathy Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hepaticencephalopathy", False)
        is_active = data.get("is_hepaticencephalopathy_active", False)
        years_cured = data.get("years_cured_hepaticencephalopathy", 0.0)
