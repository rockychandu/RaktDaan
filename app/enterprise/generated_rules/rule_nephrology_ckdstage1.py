"""
Clinical Rule Processor for Nephrology - CKDStage1.
...
class CKDStage1ClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CKDStage1.
    """
    rule_code = "RULE_NEPHROLOGY_CKDSTAGE1"
    rule_name = "CKDStage1 Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ckdstage1", False)
        is_active = data.get("is_ckdstage1_active", False)
        years_cured = data.get("years_cured_ckdstage1", 0.0)
