"""
Clinical Rule Processor for Nephrology - PeritonealDialysis.
...
class PeritonealDialysisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for PeritonealDialysis.
    """
    rule_code = "RULE_NEPHROLOGY_PERITONEALDIALYSIS"
    rule_name = "PeritonealDialysis Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_peritonealdialysis", False)
        is_active = data.get("is_peritonealdialysis_active", False)
        years_cured = data.get("years_cured_peritonealdialysis", 0.0)
