"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - HemodynamicsAssessment (2).
...
class InfectiousDiseaseHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_HEMODYNAMICSASSESSMENT_002"
    rule_name = "InfectiousDisease HemodynamicsAssessment Screening Rule #2"
