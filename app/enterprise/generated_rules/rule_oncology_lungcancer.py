"""
Clinical Rule Processor for Oncology - LungCancer.
...
class LungCancerClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for LungCancer.
    """
    rule_code = "RULE_ONCOLOGY_LUNGCANCER"
    rule_name = "LungCancer Screening Rule"
    category = "ONCOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_lungcancer", False)
        is_active = data.get("is_lungcancer_active", False)
        years_cured = data.get("years_cured_lungcancer", 0.0)
