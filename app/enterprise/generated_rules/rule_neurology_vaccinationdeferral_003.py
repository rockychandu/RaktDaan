"""
Enterprise Clinical Screening & Medical Rule Engine: Neurology - VaccinationDeferral (3).
...
class NeurologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Neurology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEUROLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Neurology VaccinationDeferral Screening Rule #3"
    category = "NEUROLOGY"
