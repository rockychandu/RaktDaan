"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - HemodynamicsAssessment (3).
...
class CryobiologyHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Cryobiology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Cryobiology HemodynamicsAssessment Screening Rule #3"
