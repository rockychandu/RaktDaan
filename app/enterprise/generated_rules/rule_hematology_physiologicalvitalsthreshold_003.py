"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - PhysiologicalVitalsThreshold (3).
...
class HematologyPhysiologicalVitalsThresholdClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_PHYSIOLOGICALVITALSTHRESHOLD_003"
    rule_name = "Hematology PhysiologicalVitalsThreshold Screening Rule #3"
    category = "HEMATOLOGY"
