"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - PostOperativeRecovery (2).
...
class CellularTherapyPostOperativeRecoveryClinicalProcessor2:
    """
    Detailed decision processor evaluating CellularTherapy (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_POSTOPERATIVERECOVERY_002"
    rule_name = "CellularTherapy PostOperativeRecovery Screening Rule #2"
