"""
Enterprise Clinical Screening & Medical Rule Engine: VascularSurgery - EndemicTravelExposure (3).
...
class VascularSurgeryEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating VascularSurgery (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_VASCULARSURGERY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "VascularSurgery EndemicTravelExposure Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for VascularSurgery (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_vascularsurgery_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("vascularsurgery_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("vascularsurgery_endemictravelexposure_lab_marker", 10.0)
