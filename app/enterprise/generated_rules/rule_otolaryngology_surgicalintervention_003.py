"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - SurgicalIntervention (3).
...
class OtolaryngologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Otolaryngology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Otolaryngology SurgicalIntervention Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Otolaryngology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_otolaryngology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("otolaryngology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("otolaryngology_surgicalintervention_lab_marker", 10.0)
