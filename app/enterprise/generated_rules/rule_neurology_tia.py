"""
Clinical Rule Processor for Neurology - TIA.
...
class TIAClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for TIA.
    """
    rule_code = "RULE_NEUROLOGY_TIA"
    rule_name = "TIA Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_tia", False)
        is_active = data.get("is_tia_active", False)
        years_cured = data.get("years_cured_tia", 0.0)
