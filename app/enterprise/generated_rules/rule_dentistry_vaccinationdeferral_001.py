"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - VaccinationDeferral (1).
...
class DentistryVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Dentistry (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_VACCINATIONDEFERRAL_001"
    rule_name = "Dentistry VaccinationDeferral Screening Rule #1"
    category = "DENTISTRY"
