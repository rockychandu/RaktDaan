"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - GeriatricReserveEvaluation (3).
...
class GeriatricsGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Geriatrics (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Geriatrics GeriatricReserveEvaluation Screening Rule #3"
    category = "GERIATRICS"
