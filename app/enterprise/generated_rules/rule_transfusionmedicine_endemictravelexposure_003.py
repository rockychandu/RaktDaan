"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - EndemicTravelExposure (3).
...
class TransfusionMedicineEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating TransfusionMedicine (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "TransfusionMedicine EndemicTravelExposure Screening Rule #3"
