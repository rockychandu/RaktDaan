"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - ImmuneComplexRejection (2).
...
class GeriatricsImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Geriatrics (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Geriatrics ImmuneComplexRejection Screening Rule #2"
    category = "GERIATRICS"
