"""
Clinical Rule Processor for Pharmacology - Cyclosporine.
...
class CyclosporineClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Cyclosporine.
    """
    rule_code = "RULE_PHARMACOLOGY_CYCLOSPORINE"
    rule_name = "Cyclosporine Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_cyclosporine", False)
        is_active = data.get("is_cyclosporine_active", False)
        years_cured = data.get("years_cured_cyclosporine", 0.0)
