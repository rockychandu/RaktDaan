"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - AcuteCondition (3).
...
class ApheresisAcuteConditionClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (AcuteCondition) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_ACUTECONDITION_003"
    rule_name = "Apheresis AcuteCondition Screening Rule #3"
    category = "APHERESIS"
