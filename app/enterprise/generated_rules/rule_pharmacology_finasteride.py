"""
Clinical Rule Processor for Pharmacology - Finasteride.
...
class FinasterideClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Finasteride.
    """
    rule_code = "RULE_PHARMACOLOGY_FINASTERIDE"
    rule_name = "Finasteride Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_finasteride", False)
        is_active = data.get("is_finasteride_active", False)
        years_cured = data.get("years_cured_finasteride", 0.0)
