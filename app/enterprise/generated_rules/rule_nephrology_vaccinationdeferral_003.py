"""
Enterprise Clinical Screening & Medical Rule Engine: Nephrology - VaccinationDeferral (3).
...
class NephrologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Nephrology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEPHROLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Nephrology VaccinationDeferral Screening Rule #3"
    category = "NEPHROLOGY"
