"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - GeriatricReserveEvaluation (2).
...
class GeneTherapyGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating GeneTherapy (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_GERIATRICRESERVEEVALUATION_002"
    rule_name = "GeneTherapy GeriatricReserveEvaluation Screening Rule #2"
