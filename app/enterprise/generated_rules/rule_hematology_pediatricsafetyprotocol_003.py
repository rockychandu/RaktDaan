"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - PediatricSafetyProtocol (3).
...
class HematologyPediatricSafetyProtocolClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (PediatricSafetyProtocol) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_PEDIATRICSAFETYPROTOCOL_003"
    rule_name = "Hematology PediatricSafetyProtocol Screening Rule #3"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (PediatricSafetyProtocol)."""
        has_primary = donor_payload.get("has_hematology_pediatricsafetyprotocol_primary", False)
        severity_score = donor_payload.get("hematology_pediatricsafetyprotocol_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_pediatricsafetyprotocol_lab_marker", 10.0)
