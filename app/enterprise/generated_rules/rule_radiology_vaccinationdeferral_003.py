"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - VaccinationDeferral (3).
...
class RadiologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Radiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Radiology VaccinationDeferral Screening Rule #3"
    category = "RADIOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Radiology (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_radiology_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("radiology_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("radiology_vaccinationdeferral_lab_marker", 10.0)
