"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - MedicationTherapy (2).
...
class ApheresisMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_MEDICATIONTHERAPY_002"
    rule_name = "Apheresis MedicationTherapy Screening Rule #2"
    category = "APHERESIS"
