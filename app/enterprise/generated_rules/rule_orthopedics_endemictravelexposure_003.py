"""
Enterprise Clinical Screening & Medical Rule Engine: Orthopedics - EndemicTravelExposure (3).
...
class OrthopedicsEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Orthopedics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ORTHOPEDICS_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Orthopedics EndemicTravelExposure Screening Rule #3"
