"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - VaccinationDeferral (2).
...
class GastroenterologyVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Gastroenterology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_VACCINATIONDEFERRAL_002"
    rule_name = "Gastroenterology VaccinationDeferral Screening Rule #2"
