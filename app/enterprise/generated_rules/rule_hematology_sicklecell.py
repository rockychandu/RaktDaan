"""
Clinical Rule Processor for Hematology - SickleCell.
...
class SickleCellClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for SickleCell.
    """
    rule_code = "RULE_HEMATOLOGY_SICKLECELL"
    rule_name = "SickleCell Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_sicklecell", False)
        is_active = data.get("is_sicklecell_active", False)
        years_cured = data.get("years_cured_sicklecell", 0.0)
