"""
Clinical Rule Processor for Hematology - Hemophilia.
...
class HemophiliaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Hemophilia.
    """
    rule_code = "RULE_HEMATOLOGY_HEMOPHILIA"
    rule_name = "Hemophilia Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hemophilia", False)
        is_active = data.get("is_hemophilia_active", False)
        years_cured = data.get("years_cured_hemophilia", 0.0)
