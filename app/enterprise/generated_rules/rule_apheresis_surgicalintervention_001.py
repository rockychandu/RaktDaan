"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - SurgicalIntervention (1).
...
class ApheresisSurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_SURGICALINTERVENTION_001"
    rule_name = "Apheresis SurgicalIntervention Screening Rule #1"
    category = "APHERESIS"
