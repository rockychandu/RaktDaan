"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - EndemicTravelExposure (1).
...
class PsychiatryEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Psychiatry (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Psychiatry EndemicTravelExposure Screening Rule #1"
    category = "PSYCHIATRY"
