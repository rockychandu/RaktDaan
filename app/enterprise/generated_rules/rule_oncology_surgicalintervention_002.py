"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - SurgicalIntervention (2).
...
class OncologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Oncology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Oncology SurgicalIntervention Screening Rule #2"
    category = "ONCOLOGY"
