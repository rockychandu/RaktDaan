"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - VaccinationDeferral (2).
...
class SurgeryVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Surgery (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_VACCINATIONDEFERRAL_002"
    rule_name = "Surgery VaccinationDeferral Screening Rule #2"
    category = "SURGERY"
