"""
Clinical Rule Processor for Neurology - MultipleSclerosis.
...
class MultipleSclerosisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for MultipleSclerosis.
    """
    rule_code = "RULE_NEUROLOGY_MULTIPLESCLEROSIS"
    rule_name = "MultipleSclerosis Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_multiplesclerosis", False)
        is_active = data.get("is_multiplesclerosis_active", False)
        years_cured = data.get("years_cured_multiplesclerosis", 0.0)
