"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - EndemicTravelExposure (3).
...
class OncologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Oncology EndemicTravelExposure Screening Rule #3"
    category = "ONCOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Oncology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_oncology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("oncology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("oncology_endemictravelexposure_lab_marker", 10.0)
