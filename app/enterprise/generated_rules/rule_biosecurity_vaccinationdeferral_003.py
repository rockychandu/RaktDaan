"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - VaccinationDeferral (3).
...
class BiosecurityVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Biosecurity (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_VACCINATIONDEFERRAL_003"
    rule_name = "Biosecurity VaccinationDeferral Screening Rule #3"
