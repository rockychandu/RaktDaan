"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - ImmuneComplexRejection (2).
...
class ApheresisImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Apheresis ImmuneComplexRejection Screening Rule #2"
    category = "APHERESIS"
