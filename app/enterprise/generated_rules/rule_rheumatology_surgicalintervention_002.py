"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - SurgicalIntervention (2).
...
class RheumatologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Rheumatology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Rheumatology SurgicalIntervention Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Rheumatology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_rheumatology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("rheumatology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("rheumatology_surgicalintervention_lab_marker", 10.0)
