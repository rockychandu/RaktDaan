"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - SurgicalIntervention (3).
...
class HematologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_SURGICALINTERVENTION_003"
    rule_name = "Hematology SurgicalIntervention Screening Rule #3"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_hematology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("hematology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_surgicalintervention_lab_marker", 10.0)
