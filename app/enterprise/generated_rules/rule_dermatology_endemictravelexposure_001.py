"""
Enterprise Clinical Screening & Medical Rule Engine: Dermatology - EndemicTravelExposure (1).
...
class DermatologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Dermatology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DERMATOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Dermatology EndemicTravelExposure Screening Rule #1"
