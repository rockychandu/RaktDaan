"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - VaccinationDeferral (3).
...
class OphthalmologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Ophthalmology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Ophthalmology VaccinationDeferral Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Ophthalmology (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_ophthalmology_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("ophthalmology_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("ophthalmology_vaccinationdeferral_lab_marker", 10.0)
