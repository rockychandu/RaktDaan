"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - HemodynamicsAssessment (3).
...
class OncologyHemodynamicsAssessmentClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_HEMODYNAMICSASSESSMENT_003"
    rule_name = "Oncology HemodynamicsAssessment Screening Rule #3"
    category = "ONCOLOGY"
