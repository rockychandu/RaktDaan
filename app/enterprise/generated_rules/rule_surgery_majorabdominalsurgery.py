"""
Clinical Rule Processor for Surgery - MajorAbdominalSurgery.
...
class MajorAbdominalSurgeryClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for MajorAbdominalSurgery.
    """
    rule_code = "RULE_SURGERY_MAJORABDOMINALSURGERY"
    rule_name = "MajorAbdominalSurgery Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_majorabdominalsurgery", False)
        is_active = data.get("is_majorabdominalsurgery_active", False)
        years_cured = data.get("years_cured_majorabdominalsurgery", 0.0)
