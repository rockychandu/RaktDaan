"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - EndemicTravelExposure (3).
...
class GeriatricsEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Geriatrics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Geriatrics EndemicTravelExposure Screening Rule #3"
    category = "GERIATRICS"
