"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - VaccinationDeferral (3).
...
class DentistryVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Dentistry (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_VACCINATIONDEFERRAL_003"
    rule_name = "Dentistry VaccinationDeferral Screening Rule #3"
    category = "DENTISTRY"
