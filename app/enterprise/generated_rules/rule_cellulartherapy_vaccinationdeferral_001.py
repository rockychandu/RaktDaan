"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - VaccinationDeferral (1).
...
class CellularTherapyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating CellularTherapy (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_VACCINATIONDEFERRAL_001"
    rule_name = "CellularTherapy VaccinationDeferral Screening Rule #1"
