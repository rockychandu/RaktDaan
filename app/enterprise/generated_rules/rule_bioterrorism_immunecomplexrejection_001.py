"""
Enterprise Clinical Screening & Medical Rule Engine: Bioterrorism - ImmuneComplexRejection (1).
...
class BioterrorismImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Bioterrorism (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOTERRORISM_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Bioterrorism ImmuneComplexRejection Screening Rule #1"
