"""
Clinical Rule Processor for Endocrinology - GravesDisease.
...
class GravesDiseaseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for GravesDisease.
    """
    rule_code = "RULE_ENDOCRINOLOGY_GRAVESDISEASE"
    rule_name = "GravesDisease Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_gravesdisease", False)
        is_active = data.get("is_gravesdisease_active", False)
        years_cured = data.get("years_cured_gravesdisease", 0.0)
