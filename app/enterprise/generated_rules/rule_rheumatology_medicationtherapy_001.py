"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - MedicationTherapy (1).
...
class RheumatologyMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating Rheumatology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_MEDICATIONTHERAPY_001"
    rule_name = "Rheumatology MedicationTherapy Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Rheumatology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_rheumatology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("rheumatology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("rheumatology_medicationtherapy_lab_marker", 10.0)
