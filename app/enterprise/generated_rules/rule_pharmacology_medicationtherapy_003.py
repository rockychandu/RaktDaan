"""
Enterprise Clinical Screening & Medical Rule Engine: Pharmacology - MedicationTherapy (3).
...
class PharmacologyMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Pharmacology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PHARMACOLOGY_MEDICATIONTHERAPY_003"
    rule_name = "Pharmacology MedicationTherapy Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Pharmacology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_pharmacology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("pharmacology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("pharmacology_medicationtherapy_lab_marker", 10.0)
