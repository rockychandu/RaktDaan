"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - EndemicTravelExposure (2).
...
class CellularTherapyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating CellularTherapy (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "CellularTherapy EndemicTravelExposure Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for CellularTherapy (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_cellulartherapy_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("cellulartherapy_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cellulartherapy_endemictravelexposure_lab_marker", 10.0)
