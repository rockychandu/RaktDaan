"""
Enterprise Clinical Screening & Medical Rule Engine: Otolaryngology - VaccinationDeferral (3).
...
class OtolaryngologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Otolaryngology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OTOLARYNGOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Otolaryngology VaccinationDeferral Screening Rule #3"
