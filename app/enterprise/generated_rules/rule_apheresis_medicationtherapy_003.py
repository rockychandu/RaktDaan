"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - MedicationTherapy (3).
...
class ApheresisMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_MEDICATIONTHERAPY_003"
    rule_name = "Apheresis MedicationTherapy Screening Rule #3"
    category = "APHERESIS"
