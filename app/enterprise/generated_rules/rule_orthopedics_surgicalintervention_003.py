"""
Enterprise Clinical Screening & Medical Rule Engine: Orthopedics - SurgicalIntervention (3).
...
class OrthopedicsSurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Orthopedics (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ORTHOPEDICS_SURGICALINTERVENTION_003"
    rule_name = "Orthopedics SurgicalIntervention Screening Rule #3"
