"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - SurgicalIntervention (2).
...
class CellularTherapySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating CellularTherapy (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_SURGICALINTERVENTION_002"
    rule_name = "CellularTherapy SurgicalIntervention Screening Rule #2"
