"""
Clinical Rule Processor for Cardiology - Pericarditis.
...
class PericarditisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Pericarditis.
    """
    rule_code = "RULE_CARDIOLOGY_PERICARDITIS"
    rule_name = "Pericarditis Screening Rule"
    category = "CARDIOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_pericarditis", False)
        is_active = data.get("is_pericarditis_active", False)
        years_cured = data.get("years_cured_pericarditis", 0.0)
