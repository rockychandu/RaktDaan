"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - PhysiologicalVitalsThreshold (3).
...
class PsychiatryPhysiologicalVitalsThresholdClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_PHYSIOLOGICALVITALSTHRESHOLD_003"
    rule_name = "Psychiatry PhysiologicalVitalsThreshold Screening Rule #3"
    category = "PSYCHIATRY"
