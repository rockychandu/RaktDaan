"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - ChronicDisease (3).
...
class HematologyChronicDiseaseClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_CHRONICDISEASE_003"
    rule_name = "Hematology ChronicDisease Screening Rule #3"
    category = "HEMATOLOGY"
