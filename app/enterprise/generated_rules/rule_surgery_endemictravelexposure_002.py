"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - EndemicTravelExposure (2).
...
class SurgeryEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Surgery (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Surgery EndemicTravelExposure Screening Rule #2"
    category = "SURGERY"
