"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - GeriatricReserveEvaluation (3).
...
class OncologyGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Oncology GeriatricReserveEvaluation Screening Rule #3"
    category = "ONCOLOGY"
