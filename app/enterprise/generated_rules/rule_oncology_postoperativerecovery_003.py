"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - PostOperativeRecovery (3).
...
class OncologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Oncology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Oncology PostOperativeRecovery Screening Rule #3"
    category = "ONCOLOGY"
