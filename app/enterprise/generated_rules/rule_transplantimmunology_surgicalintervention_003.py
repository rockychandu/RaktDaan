"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - SurgicalIntervention (3).
...
class TransplantImmunologySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating TransplantImmunology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_SURGICALINTERVENTION_003"
    rule_name = "TransplantImmunology SurgicalIntervention Screening Rule #3"
    category = "TRANSPLANTIMMUNOLOGY"
    sub_category = "SURGICALINTERVENTION"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for TransplantImmunology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_transplantimmunology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("transplantimmunology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("transplantimmunology_surgicalintervention_lab_marker", 10.0)
