"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - EndemicTravelExposure (1).
...
class DentistryEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Dentistry (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Dentistry EndemicTravelExposure Screening Rule #1"
    category = "DENTISTRY"
