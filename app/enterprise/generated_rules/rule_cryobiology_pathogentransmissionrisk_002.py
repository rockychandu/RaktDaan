"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - PathogenTransmissionRisk (2).
...
class CryobiologyPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Cryobiology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Cryobiology PathogenTransmissionRisk Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Cryobiology (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_cryobiology_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("cryobiology_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cryobiology_pathogentransmissionrisk_lab_marker", 10.0)
