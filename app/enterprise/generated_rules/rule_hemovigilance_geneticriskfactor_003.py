"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - GeneticRiskFactor (3).
...
class HemovigilanceGeneticRiskFactorClinicalProcessor3:
    """
    Detailed decision processor evaluating Hemovigilance (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_GENETICRISKFACTOR_003"
    rule_name = "Hemovigilance GeneticRiskFactor Screening Rule #3"
