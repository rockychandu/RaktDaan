"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - PathogenTransmissionRisk (2).
...
class CellularTherapyPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating CellularTherapy (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "CellularTherapy PathogenTransmissionRisk Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for CellularTherapy (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_cellulartherapy_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("cellulartherapy_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cellulartherapy_pathogentransmissionrisk_lab_marker", 10.0)
