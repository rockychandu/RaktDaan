"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - GeneticRiskFactor (3).
...
class InfectiousDiseaseGeneticRiskFactorClinicalProcessor3:
    """
    Detailed decision processor evaluating InfectiousDisease (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_GENETICRISKFACTOR_003"
    rule_name = "InfectiousDisease GeneticRiskFactor Screening Rule #3"
