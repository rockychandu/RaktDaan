"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PostOperativeRecovery (3).
...
class ApheresisPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_POSTOPERATIVERECOVERY_003"
    rule_name = "Apheresis PostOperativeRecovery Screening Rule #3"
    category = "APHERESIS"
