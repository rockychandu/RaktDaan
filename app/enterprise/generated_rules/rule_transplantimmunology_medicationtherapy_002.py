"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - MedicationTherapy (2).
...
class TransplantImmunologyMedicationTherapyClinicalProcessor2:
    """
    Detailed decision processor evaluating TransplantImmunology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_MEDICATIONTHERAPY_002"
    rule_name = "TransplantImmunology MedicationTherapy Screening Rule #2"
    category = "TRANSPLANTIMMUNOLOGY"
    sub_category = "MEDICATIONTHERAPY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for TransplantImmunology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_transplantimmunology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("transplantimmunology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("transplantimmunology_medicationtherapy_lab_marker", 10.0)
