"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - GeriatricReserveEvaluation (3).
...
class InfectiousDiseaseGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating InfectiousDisease (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_GERIATRICRESERVEEVALUATION_003"
    rule_name = "InfectiousDisease GeriatricReserveEvaluation Screening Rule #3"
