"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - VaccinationDeferral (3).
...
class EpidemiologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Epidemiology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "Epidemiology VaccinationDeferral Screening Rule #3"
