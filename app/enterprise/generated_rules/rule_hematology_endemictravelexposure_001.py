"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - EndemicTravelExposure (1).
...
class HematologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Hematology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Hematology EndemicTravelExposure Screening Rule #1"
    category = "HEMATOLOGY"
