"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - GeriatricReserveEvaluation (3).
...
class CellularTherapyGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating CellularTherapy (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_GERIATRICRESERVEEVALUATION_003"
    rule_name = "CellularTherapy GeriatricReserveEvaluation Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for CellularTherapy (GeriatricReserveEvaluation)."""
        has_primary = donor_payload.get("has_cellulartherapy_geriatricreserveevaluation_primary", False)
        severity_score = donor_payload.get("cellulartherapy_geriatricreserveevaluation_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cellulartherapy_geriatricreserveevaluation_lab_marker", 10.0)
