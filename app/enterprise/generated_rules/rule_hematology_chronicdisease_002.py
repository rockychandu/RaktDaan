"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - ChronicDisease (2).
...
class HematologyChronicDiseaseClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (ChronicDisease) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_CHRONICDISEASE_002"
    rule_name = "Hematology ChronicDisease Screening Rule #2"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (ChronicDisease)."""
        has_primary = donor_payload.get("has_hematology_chronicdisease_primary", False)
        severity_score = donor_payload.get("hematology_chronicdisease_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_chronicdisease_lab_marker", 10.0)
