"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - EndemicTravelExposure (1).
...
class GeriatricsEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Geriatrics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Geriatrics EndemicTravelExposure Screening Rule #1"
    category = "GERIATRICS"
