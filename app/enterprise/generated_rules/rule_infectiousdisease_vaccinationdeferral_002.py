"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - VaccinationDeferral (2).
...
class InfectiousDiseaseVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating InfectiousDisease (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_VACCINATIONDEFERRAL_002"
    rule_name = "InfectiousDisease VaccinationDeferral Screening Rule #2"
