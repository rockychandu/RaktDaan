"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - EndemicTravelExposure (3).
...
class EpidemiologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Epidemiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Epidemiology EndemicTravelExposure Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Epidemiology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_epidemiology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("epidemiology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("epidemiology_endemictravelexposure_lab_marker", 10.0)
