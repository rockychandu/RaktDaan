"""
Clinical Rule Processor for Pharmacology - Acitretin.
...
class AcitretinClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Acitretin.
    """
    rule_code = "RULE_PHARMACOLOGY_ACITRETIN"
    rule_name = "Acitretin Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_acitretin", False)
        is_active = data.get("is_acitretin_active", False)
        years_cured = data.get("years_cured_acitretin", 0.0)
