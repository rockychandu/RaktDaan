"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - SurgicalIntervention (1).
...
class EndocrinologySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Endocrinology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_SURGICALINTERVENTION_001"
    rule_name = "Endocrinology SurgicalIntervention Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Endocrinology (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_endocrinology_surgicalintervention_primary", False)
        severity_score = donor_payload.get("endocrinology_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("endocrinology_surgicalintervention_lab_marker", 10.0)
