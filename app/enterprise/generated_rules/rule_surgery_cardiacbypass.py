"""
Clinical Rule Processor for Surgery - CardiacBypass.
...
class CardiacBypassClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CardiacBypass.
    """
    rule_code = "RULE_SURGERY_CARDIACBYPASS"
    rule_name = "CardiacBypass Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_cardiacbypass", False)
        is_active = data.get("is_cardiacbypass_active", False)
        years_cured = data.get("years_cured_cardiacbypass", 0.0)
