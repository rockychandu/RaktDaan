"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - VaccinationDeferral (3).
...
class PsychiatryVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_VACCINATIONDEFERRAL_003"
    rule_name = "Psychiatry VaccinationDeferral Screening Rule #3"
    category = "PSYCHIATRY"
