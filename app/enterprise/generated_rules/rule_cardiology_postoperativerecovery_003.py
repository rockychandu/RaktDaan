"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - PostOperativeRecovery (3).
...
class CardiologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Cardiology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Cardiology PostOperativeRecovery Screening Rule #3"
    category = "CARDIOLOGY"
