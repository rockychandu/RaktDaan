"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - MedicationTherapy (1).
...
class InfectiousDiseaseMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating InfectiousDisease (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_MEDICATIONTHERAPY_001"
    rule_name = "InfectiousDisease MedicationTherapy Screening Rule #1"
