"""
Clinical Rule Processor for Infectious - HTLV.
...
class HTLVClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HTLV.
    """
    rule_code = "RULE_INFECTIOUS_HTLV"
    rule_name = "HTLV Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_htlv", False)
        is_active = data.get("is_htlv_active", False)
        years_cured = data.get("years_cured_htlv", 0.0)
