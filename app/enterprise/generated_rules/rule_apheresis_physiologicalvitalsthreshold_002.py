"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PhysiologicalVitalsThreshold (2).
...
class ApheresisPhysiologicalVitalsThresholdClinicalProcessor2:
    """
    Detailed decision processor evaluating Apheresis (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_PHYSIOLOGICALVITALSTHRESHOLD_002"
    rule_name = "Apheresis PhysiologicalVitalsThreshold Screening Rule #2"
    category = "APHERESIS"
