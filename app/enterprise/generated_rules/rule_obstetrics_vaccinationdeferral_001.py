"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - VaccinationDeferral (1).
...
class ObstetricsVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Obstetrics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_VACCINATIONDEFERRAL_001"
    rule_name = "Obstetrics VaccinationDeferral Screening Rule #1"
    category = "OBSTETRICS"
