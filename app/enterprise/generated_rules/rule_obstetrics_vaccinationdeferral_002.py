"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - VaccinationDeferral (2).
...
class ObstetricsVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_VACCINATIONDEFERRAL_002"
    rule_name = "Obstetrics VaccinationDeferral Screening Rule #2"
    category = "OBSTETRICS"
