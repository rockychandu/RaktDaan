"""
Clinical Rule Processor for Toxicology - HeavyMetalToxicity.
...
class HeavyMetalToxicityClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HeavyMetalToxicity.
    """
    rule_code = "RULE_TOXICOLOGY_HEAVYMETALTOXICITY"
    rule_name = "HeavyMetalToxicity Screening Rule"
    category = "TOXICOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_heavymetaltoxicity", False)
        is_active = data.get("is_heavymetaltoxicity_active", False)
        years_cured = data.get("years_cured_heavymetaltoxicity", 0.0)
