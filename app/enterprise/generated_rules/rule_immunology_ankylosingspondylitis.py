"""
Clinical Rule Processor for Immunology - AnkylosingSpondylitis.
...
class AnkylosingSpondylitisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for AnkylosingSpondylitis.
    """
    rule_code = "RULE_IMMUNOLOGY_ANKYLOSINGSPONDYLITIS"
    rule_name = "AnkylosingSpondylitis Screening Rule"
    category = "IMMUNOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_ankylosingspondylitis", False)
        is_active = data.get("is_ankylosingspondylitis_active", False)
        years_cured = data.get("years_cured_ankylosingspondylitis", 0.0)
