"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - EndemicTravelExposure (1).
...
class InfectiousDiseaseEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating InfectiousDisease (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "InfectiousDisease EndemicTravelExposure Screening Rule #1"
