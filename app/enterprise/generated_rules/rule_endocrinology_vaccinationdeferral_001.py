"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - VaccinationDeferral (1).
...
class EndocrinologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Endocrinology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Endocrinology VaccinationDeferral Screening Rule #1"
