"""
Enterprise Clinical Screening & Medical Rule Engine: Genetics - SurgicalIntervention (2).
...
class GeneticsSurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Genetics (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETICS_SURGICALINTERVENTION_002"
    rule_name = "Genetics SurgicalIntervention Screening Rule #2"
    category = "GENETICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Genetics (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_genetics_surgicalintervention_primary", False)
        severity_score = donor_payload.get("genetics_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("genetics_surgicalintervention_lab_marker", 10.0)
