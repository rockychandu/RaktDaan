"""
Clinical Rule Processor for Oncology - ProstateCancer.
...
class ProstateCancerClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for ProstateCancer.
    """
    rule_code = "RULE_ONCOLOGY_PROSTATECANCER"
    rule_name = "ProstateCancer Screening Rule"
    category = "ONCOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_prostatecancer", False)
        is_active = data.get("is_prostatecancer_active", False)
        years_cured = data.get("years_cured_prostatecancer", 0.0)
