"""
Enterprise Clinical Screening & Medical Rule Engine: Dermatology - PostOperativeRecovery (3).
...
class DermatologyPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Dermatology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DERMATOLOGY_POSTOPERATIVERECOVERY_003"
    rule_name = "Dermatology PostOperativeRecovery Screening Rule #3"
