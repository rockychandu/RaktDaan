"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - EndemicTravelExposure (2).
...
class HematologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Hematology EndemicTravelExposure Screening Rule #2"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_hematology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("hematology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_endemictravelexposure_lab_marker", 10.0)
