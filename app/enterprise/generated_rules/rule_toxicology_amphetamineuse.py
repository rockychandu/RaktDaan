"""
Clinical Rule Processor for Toxicology - AmphetamineUse.
...
class AmphetamineUseClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for AmphetamineUse.
    """
    rule_code = "RULE_TOXICOLOGY_AMPHETAMINEUSE"
    rule_name = "AmphetamineUse Screening Rule"
    category = "TOXICOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_amphetamineuse", False)
        is_active = data.get("is_amphetamineuse_active", False)
        years_cured = data.get("years_cured_amphetamineuse", 0.0)
