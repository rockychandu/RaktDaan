"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - VaccinationDeferral (2).
...
class OncologyVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Oncology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_VACCINATIONDEFERRAL_002"
    rule_name = "Oncology VaccinationDeferral Screening Rule #2"
    category = "ONCOLOGY"
