"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - PathogenTransmissionRisk (3).
...
class PsychiatryPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Psychiatry PathogenTransmissionRisk Screening Rule #3"
    category = "PSYCHIATRY"
