"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - MedicationTherapy (1).
...
class OncologyMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating Oncology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_MEDICATIONTHERAPY_001"
    rule_name = "Oncology MedicationTherapy Screening Rule #1"
    category = "ONCOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Oncology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_oncology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("oncology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("oncology_medicationtherapy_lab_marker", 10.0)
