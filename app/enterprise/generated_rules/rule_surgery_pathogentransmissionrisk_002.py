"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - PathogenTransmissionRisk (2).
...
class SurgeryPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Surgery (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Surgery PathogenTransmissionRisk Screening Rule #2"
    category = "SURGERY"
