"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - EndemicTravelExposure (3).
...
class BiosecurityEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Biosecurity (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Biosecurity EndemicTravelExposure Screening Rule #3"
