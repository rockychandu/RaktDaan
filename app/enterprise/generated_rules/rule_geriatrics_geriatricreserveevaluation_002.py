"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - GeriatricReserveEvaluation (2).
...
class GeriatricsGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating Geriatrics (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_GERIATRICRESERVEEVALUATION_002"
    rule_name = "Geriatrics GeriatricReserveEvaluation Screening Rule #2"
    category = "GERIATRICS"
