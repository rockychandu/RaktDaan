"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - SurgicalIntervention (3).
...
class BiosecuritySurgicalInterventionClinicalProcessor3:
    """
    Detailed decision processor evaluating Biosecurity (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_SURGICALINTERVENTION_003"
    rule_name = "Biosecurity SurgicalIntervention Screening Rule #3"
