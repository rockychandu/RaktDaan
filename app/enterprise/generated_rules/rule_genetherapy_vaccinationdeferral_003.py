"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - VaccinationDeferral (3).
...
class GeneTherapyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating GeneTherapy (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_VACCINATIONDEFERRAL_003"
    rule_name = "GeneTherapy VaccinationDeferral Screening Rule #3"
