"""
Enterprise Clinical Screening & Medical Rule Engine: GeneTherapy - PathogenTransmissionRisk (3).
...
class GeneTherapyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating GeneTherapy (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GENETHERAPY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "GeneTherapy PathogenTransmissionRisk Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for GeneTherapy (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_genetherapy_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("genetherapy_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("genetherapy_pathogentransmissionrisk_lab_marker", 10.0)
