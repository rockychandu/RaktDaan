"""
Clinical Rule Processor for Infectious - HIV2.
...
class HIV2ClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for HIV2.
    """
    rule_code = "RULE_INFECTIOUS_HIV2"
    rule_name = "HIV2 Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hiv2", False)
        is_active = data.get("is_hiv2_active", False)
        years_cured = data.get("years_cured_hiv2", 0.0)
