"""
Enterprise Clinical Screening & Medical Rule Engine: Dermatology - ImmuneComplexRejection (2).
...
class DermatologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Dermatology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DERMATOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Dermatology ImmuneComplexRejection Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Dermatology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_dermatology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("dermatology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("dermatology_immunecomplexrejection_lab_marker", 10.0)
