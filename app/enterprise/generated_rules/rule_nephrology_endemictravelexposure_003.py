"""
Enterprise Clinical Screening & Medical Rule Engine: Nephrology - EndemicTravelExposure (3).
...
class NephrologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Nephrology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEPHROLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Nephrology EndemicTravelExposure Screening Rule #3"
    category = "NEPHROLOGY"
