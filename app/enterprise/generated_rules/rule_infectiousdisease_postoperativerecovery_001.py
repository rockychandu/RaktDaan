"""
Enterprise Clinical Screening & Medical Rule Engine: InfectiousDisease - PostOperativeRecovery (1).
...
class InfectiousDiseasePostOperativeRecoveryClinicalProcessor1:
    """
    Detailed decision processor evaluating InfectiousDisease (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_INFECTIOUSDISEASE_POSTOPERATIVERECOVERY_001"
    rule_name = "InfectiousDisease PostOperativeRecovery Screening Rule #1"
