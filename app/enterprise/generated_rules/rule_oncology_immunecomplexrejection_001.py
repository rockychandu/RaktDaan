"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - ImmuneComplexRejection (1).
...
class OncologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Oncology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Oncology ImmuneComplexRejection Screening Rule #1"
    category = "ONCOLOGY"
