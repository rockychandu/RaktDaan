"""
Enterprise Clinical Screening & Medical Rule Engine: Histocompatibility - VaccinationDeferral (3).
...
class HistocompatibilityVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Histocompatibility (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HISTOCOMPATIBILITY_VACCINATIONDEFERRAL_003"
    rule_name = "Histocompatibility VaccinationDeferral Screening Rule #3"
