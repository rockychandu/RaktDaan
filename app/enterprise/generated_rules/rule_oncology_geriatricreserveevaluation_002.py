"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - GeriatricReserveEvaluation (2).
...
class OncologyGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating Oncology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_GERIATRICRESERVEEVALUATION_002"
    rule_name = "Oncology GeriatricReserveEvaluation Screening Rule #2"
    category = "ONCOLOGY"
