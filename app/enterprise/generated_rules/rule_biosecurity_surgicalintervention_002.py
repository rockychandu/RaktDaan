"""
Enterprise Clinical Screening & Medical Rule Engine: Biosecurity - SurgicalIntervention (2).
...
class BiosecuritySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Biosecurity (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOSECURITY_SURGICALINTERVENTION_002"
    rule_name = "Biosecurity SurgicalIntervention Screening Rule #2"
