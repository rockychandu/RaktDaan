"""
Clinical Rule Processor for Gastroenterology - Pancreatitis.
...
class PancreatitisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Pancreatitis.
    """
    rule_code = "RULE_GASTROENTEROLOGY_PANCREATITIS"
    rule_name = "Pancreatitis Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_pancreatitis", False)
        is_active = data.get("is_pancreatitis_active", False)
        years_cured = data.get("years_cured_pancreatitis", 0.0)
