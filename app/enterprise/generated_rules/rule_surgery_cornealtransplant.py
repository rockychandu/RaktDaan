"""
Clinical Rule Processor for Surgery - CornealTransplant.
...
class CornealTransplantClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CornealTransplant.
    """
    rule_code = "RULE_SURGERY_CORNEALTRANSPLANT"
    rule_name = "CornealTransplant Screening Rule"
    category = "SURGERY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_cornealtransplant", False)
        is_active = data.get("is_cornealtransplant_active", False)
        years_cured = data.get("years_cured_cornealtransplant", 0.0)
