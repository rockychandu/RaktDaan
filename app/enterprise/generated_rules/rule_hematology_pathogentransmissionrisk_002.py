"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - PathogenTransmissionRisk (2).
...
class HematologyPathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Hematology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Hematology PathogenTransmissionRisk Screening Rule #2"
    category = "HEMATOLOGY"
