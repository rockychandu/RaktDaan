"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - HemodynamicsAssessment (2).
...
class ObstetricsHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_HEMODYNAMICSASSESSMENT_002"
    rule_name = "Obstetrics HemodynamicsAssessment Screening Rule #2"
    category = "OBSTETRICS"
