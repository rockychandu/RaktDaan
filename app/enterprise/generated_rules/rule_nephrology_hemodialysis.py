"""
Clinical Rule Processor for Nephrology - Hemodialysis.
...
class HemodialysisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Hemodialysis.
    """
    rule_code = "RULE_NEPHROLOGY_HEMODIALYSIS"
    rule_name = "Hemodialysis Screening Rule"
    category = "NEPHROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hemodialysis", False)
        is_active = data.get("is_hemodialysis_active", False)
        years_cured = data.get("years_cured_hemodialysis", 0.0)
