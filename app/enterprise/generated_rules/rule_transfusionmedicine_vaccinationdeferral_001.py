"""
Enterprise Clinical Screening & Medical Rule Engine: TransfusionMedicine - VaccinationDeferral (1).
...
class TransfusionMedicineVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating TransfusionMedicine (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSFUSIONMEDICINE_VACCINATIONDEFERRAL_001"
    rule_name = "TransfusionMedicine VaccinationDeferral Screening Rule #1"
