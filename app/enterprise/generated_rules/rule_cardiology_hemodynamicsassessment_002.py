"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - HemodynamicsAssessment (2).
...
class CardiologyHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating Cardiology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_HEMODYNAMICSASSESSMENT_002"
    rule_name = "Cardiology HemodynamicsAssessment Screening Rule #2"
    category = "CARDIOLOGY"
