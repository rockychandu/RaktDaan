"""
Enterprise Clinical Screening & Medical Rule Engine: Dentistry - SurgicalIntervention (1).
...
class DentistrySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Dentistry (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_DENTISTRY_SURGICALINTERVENTION_001"
    rule_name = "Dentistry SurgicalIntervention Screening Rule #1"
    category = "DENTISTRY"
