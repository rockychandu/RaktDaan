"""
Enterprise Clinical Screening & Medical Rule Engine: Endocrinology - MedicationTherapy (3).
...
class EndocrinologyMedicationTherapyClinicalProcessor3:
    """
    Detailed decision processor evaluating Endocrinology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ENDOCRINOLOGY_MEDICATIONTHERAPY_003"
    rule_name = "Endocrinology MedicationTherapy Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Endocrinology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_endocrinology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("endocrinology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("endocrinology_medicationtherapy_lab_marker", 10.0)
