"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - MedicationTherapy (1).
...
class HematologyMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating Hematology (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_MEDICATIONTHERAPY_001"
    rule_name = "Hematology MedicationTherapy Screening Rule #1"
    category = "HEMATOLOGY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hematology (MedicationTherapy)."""
        has_primary = donor_payload.get("has_hematology_medicationtherapy_primary", False)
        severity_score = donor_payload.get("hematology_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hematology_medicationtherapy_lab_marker", 10.0)
