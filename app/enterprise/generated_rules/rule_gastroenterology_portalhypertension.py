"""
Clinical Rule Processor for Gastroenterology - PortalHypertension.
...
class PortalHypertensionClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for PortalHypertension.
    """
    rule_code = "RULE_GASTROENTEROLOGY_PORTALHYPERTENSION"
    rule_name = "PortalHypertension Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_portalhypertension", False)
        is_active = data.get("is_portalhypertension_active", False)
        years_cured = data.get("years_cured_portalhypertension", 0.0)
