"""
Clinical Rule Processor for Endocrinology - Hypopituitarism.
...
class HypopituitarismClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Hypopituitarism.
    """
    rule_code = "RULE_ENDOCRINOLOGY_HYPOPITUITARISM"
    rule_name = "Hypopituitarism Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_hypopituitarism", False)
        is_active = data.get("is_hypopituitarism_active", False)
        years_cured = data.get("years_cured_hypopituitarism", 0.0)
