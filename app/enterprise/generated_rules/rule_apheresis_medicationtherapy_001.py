"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - MedicationTherapy (1).
...
class ApheresisMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_MEDICATIONTHERAPY_001"
    rule_name = "Apheresis MedicationTherapy Screening Rule #1"
    category = "APHERESIS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Apheresis (MedicationTherapy)."""
        has_primary = donor_payload.get("has_apheresis_medicationtherapy_primary", False)
        severity_score = donor_payload.get("apheresis_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("apheresis_medicationtherapy_lab_marker", 10.0)
