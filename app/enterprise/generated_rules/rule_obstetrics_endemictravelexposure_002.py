"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - EndemicTravelExposure (2).
...
class ObstetricsEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Obstetrics EndemicTravelExposure Screening Rule #2"
    category = "OBSTETRICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Obstetrics (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_obstetrics_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("obstetrics_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("obstetrics_endemictravelexposure_lab_marker", 10.0)
