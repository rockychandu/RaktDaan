"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - ImmuneComplexRejection (1).
...
class RadiologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Radiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Radiology ImmuneComplexRejection Screening Rule #1"
    category = "RADIOLOGY"
