"""
Enterprise Clinical Screening & Medical Rule Engine: Bioterrorism - GeriatricReserveEvaluation (2).
...
class BioterrorismGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating Bioterrorism (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_BIOTERRORISM_GERIATRICRESERVEEVALUATION_002"
    rule_name = "Bioterrorism GeriatricReserveEvaluation Screening Rule #2"
