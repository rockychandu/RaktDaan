"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - ImmuneComplexRejection (3).
...
class PsychiatryImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Psychiatry (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Psychiatry ImmuneComplexRejection Screening Rule #3"
    category = "PSYCHIATRY"
