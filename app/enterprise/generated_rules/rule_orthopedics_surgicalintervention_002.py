"""
Enterprise Clinical Screening & Medical Rule Engine: Orthopedics - SurgicalIntervention (2).
...
class OrthopedicsSurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Orthopedics (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ORTHOPEDICS_SURGICALINTERVENTION_002"
    rule_name = "Orthopedics SurgicalIntervention Screening Rule #2"
