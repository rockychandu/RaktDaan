"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - VaccinationDeferral (3).
...
class SurgeryVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_VACCINATIONDEFERRAL_003"
    rule_name = "Surgery VaccinationDeferral Screening Rule #3"
    category = "SURGERY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Surgery (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_surgery_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("surgery_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("surgery_vaccinationdeferral_lab_marker", 10.0)
