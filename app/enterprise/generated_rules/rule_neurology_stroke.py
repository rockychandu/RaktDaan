"""
Clinical Rule Processor for Neurology - Stroke.
...
class StrokeClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Stroke.
    """
    rule_code = "RULE_NEUROLOGY_STROKE"
    rule_name = "Stroke Screening Rule"
    category = "NEUROLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_stroke", False)
        is_active = data.get("is_stroke_active", False)
        years_cured = data.get("years_cured_stroke", 0.0)
