"""
Clinical Rule Processor for Hematology - Thalassemia.
...
class ThalassemiaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Thalassemia.
    """
    rule_code = "RULE_HEMATOLOGY_THALASSEMIA"
    rule_name = "Thalassemia Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_thalassemia", False)
        is_active = data.get("is_thalassemia_active", False)
        years_cured = data.get("years_cured_thalassemia", 0.0)
