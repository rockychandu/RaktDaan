"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - EndemicTravelExposure (1).
...
class EpidemiologyEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Epidemiology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Epidemiology EndemicTravelExposure Screening Rule #1"
