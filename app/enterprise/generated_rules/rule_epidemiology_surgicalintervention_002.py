"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - SurgicalIntervention (2).
...
class EpidemiologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Epidemiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Epidemiology SurgicalIntervention Screening Rule #2"
