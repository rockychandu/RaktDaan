"""
Clinical Rule Processor for Infectious - Tuberculosis.
...
class TuberculosisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Tuberculosis.
    """
    rule_code = "RULE_INFECTIOUS_TUBERCULOSIS"
    rule_name = "Tuberculosis Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_tuberculosis", False)
        is_active = data.get("is_tuberculosis_active", False)
        years_cured = data.get("years_cured_tuberculosis", 0.0)
