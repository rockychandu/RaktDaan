"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - GeneticRiskFactor (2).
...
class PsychiatryGeneticRiskFactorClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (GeneticRiskFactor) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_GENETICRISKFACTOR_002"
    rule_name = "Psychiatry GeneticRiskFactor Screening Rule #2"
    category = "PSYCHIATRY"
