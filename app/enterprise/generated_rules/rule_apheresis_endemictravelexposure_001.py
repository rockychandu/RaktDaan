"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - EndemicTravelExposure (1).
...
class ApheresisEndemicTravelExposureClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_ENDEMICTRAVELEXPOSURE_001"
    rule_name = "Apheresis EndemicTravelExposure Screening Rule #1"
    category = "APHERESIS"
