"""
Enterprise Clinical Screening & Medical Rule Engine: Geriatrics - VaccinationDeferral (1).
...
class GeriatricsVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Geriatrics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GERIATRICS_VACCINATIONDEFERRAL_001"
    rule_name = "Geriatrics VaccinationDeferral Screening Rule #1"
    category = "GERIATRICS"
