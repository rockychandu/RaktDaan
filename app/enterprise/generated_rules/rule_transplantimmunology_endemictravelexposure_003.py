"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - EndemicTravelExposure (3).
...
class TransplantImmunologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating TransplantImmunology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "TransplantImmunology EndemicTravelExposure Screening Rule #3"
    category = "TRANSPLANTIMMUNOLOGY"
    sub_category = "ENDEMICTRAVELEXPOSURE"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for TransplantImmunology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_transplantimmunology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("transplantimmunology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("transplantimmunology_endemictravelexposure_lab_marker", 10.0)
