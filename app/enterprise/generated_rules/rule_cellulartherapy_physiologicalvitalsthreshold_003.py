"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - PhysiologicalVitalsThreshold (3).
...
class CellularTherapyPhysiologicalVitalsThresholdClinicalProcessor3:
    """
    Detailed decision processor evaluating CellularTherapy (PhysiologicalVitalsThreshold) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_PHYSIOLOGICALVITALSTHRESHOLD_003"
    rule_name = "CellularTherapy PhysiologicalVitalsThreshold Screening Rule #3"
