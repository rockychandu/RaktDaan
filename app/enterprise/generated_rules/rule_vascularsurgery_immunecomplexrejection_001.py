"""
Enterprise Clinical Screening & Medical Rule Engine: VascularSurgery - ImmuneComplexRejection (1).
...
class VascularSurgeryImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating VascularSurgery (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_VASCULARSURGERY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "VascularSurgery ImmuneComplexRejection Screening Rule #1"
