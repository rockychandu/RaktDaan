"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - PathogenTransmissionRisk (3).
...
class ApheresisPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Apheresis (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Apheresis PathogenTransmissionRisk Screening Rule #3"
    category = "APHERESIS"
