"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - ImmuneComplexRejection (3).
...
class SurgeryImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Surgery ImmuneComplexRejection Screening Rule #3"
    category = "SURGERY"
