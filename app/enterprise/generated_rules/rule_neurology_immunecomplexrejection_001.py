"""
Enterprise Clinical Screening & Medical Rule Engine: Neurology - ImmuneComplexRejection (1).
...
class NeurologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Neurology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEUROLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Neurology ImmuneComplexRejection Screening Rule #1"
    category = "NEUROLOGY"
