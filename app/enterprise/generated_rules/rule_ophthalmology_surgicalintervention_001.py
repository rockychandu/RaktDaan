"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - SurgicalIntervention (1).
...
class OphthalmologySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Ophthalmology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_SURGICALINTERVENTION_001"
    rule_name = "Ophthalmology SurgicalIntervention Screening Rule #1"
