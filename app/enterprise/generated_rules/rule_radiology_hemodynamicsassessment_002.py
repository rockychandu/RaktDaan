"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - HemodynamicsAssessment (2).
...
class RadiologyHemodynamicsAssessmentClinicalProcessor2:
    """
    Detailed decision processor evaluating Radiology (HemodynamicsAssessment) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_HEMODYNAMICSASSESSMENT_002"
    rule_name = "Radiology HemodynamicsAssessment Screening Rule #2"
    category = "RADIOLOGY"
