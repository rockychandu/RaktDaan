"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - EndemicTravelExposure (3).
...
class OphthalmologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Ophthalmology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Ophthalmology EndemicTravelExposure Screening Rule #3"
