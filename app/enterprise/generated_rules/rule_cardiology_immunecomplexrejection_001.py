"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - ImmuneComplexRejection (1).
...
class CardiologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Cardiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Cardiology ImmuneComplexRejection Screening Rule #1"
    category = "CARDIOLOGY"
