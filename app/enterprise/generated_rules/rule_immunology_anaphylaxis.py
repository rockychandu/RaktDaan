"""
Clinical Rule Processor for Immunology - Anaphylaxis.
...
class AnaphylaxisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Anaphylaxis.
    """
    rule_code = "RULE_IMMUNOLOGY_ANAPHYLAXIS"
    rule_name = "Anaphylaxis Screening Rule"
    category = "IMMUNOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_anaphylaxis", False)
        is_active = data.get("is_anaphylaxis_active", False)
        years_cured = data.get("years_cured_anaphylaxis", 0.0)
