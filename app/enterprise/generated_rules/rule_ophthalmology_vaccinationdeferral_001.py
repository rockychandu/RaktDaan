"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - VaccinationDeferral (1).
...
class OphthalmologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Ophthalmology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Ophthalmology VaccinationDeferral Screening Rule #1"
