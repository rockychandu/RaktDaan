"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - SurgicalIntervention (2).
...
class HemovigilanceSurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Hemovigilance (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_SURGICALINTERVENTION_002"
    rule_name = "Hemovigilance SurgicalIntervention Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hemovigilance (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_hemovigilance_surgicalintervention_primary", False)
        severity_score = donor_payload.get("hemovigilance_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hemovigilance_surgicalintervention_lab_marker", 10.0)
