"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - VaccinationDeferral (3).
...
class ObstetricsVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating Obstetrics (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_VACCINATIONDEFERRAL_003"
    rule_name = "Obstetrics VaccinationDeferral Screening Rule #3"
    category = "OBSTETRICS"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Obstetrics (VaccinationDeferral)."""
        has_primary = donor_payload.get("has_obstetrics_vaccinationdeferral_primary", False)
        severity_score = donor_payload.get("obstetrics_vaccinationdeferral_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("obstetrics_vaccinationdeferral_lab_marker", 10.0)
