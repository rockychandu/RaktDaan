"""
Enterprise Clinical Screening & Medical Rule Engine: Oncology - VaccinationDeferral (1).
...
class OncologyVaccinationDeferralClinicalProcessor1:
    """
    Detailed decision processor evaluating Oncology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_ONCOLOGY_VACCINATIONDEFERRAL_001"
    rule_name = "Oncology VaccinationDeferral Screening Rule #1"
    category = "ONCOLOGY"
