"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - EndemicTravelExposure (3).
...
class HematologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Hematology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Hematology EndemicTravelExposure Screening Rule #3"
    category = "HEMATOLOGY"
