"""
Enterprise Clinical Screening & Medical Rule Engine: Cryobiology - ImmuneComplexRejection (2).
...
class CryobiologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Cryobiology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CRYOBIOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Cryobiology ImmuneComplexRejection Screening Rule #2"
