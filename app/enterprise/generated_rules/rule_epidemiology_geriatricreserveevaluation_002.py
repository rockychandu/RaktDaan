"""
Enterprise Clinical Screening & Medical Rule Engine: Epidemiology - GeriatricReserveEvaluation (2).
...
class EpidemiologyGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating Epidemiology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_EPIDEMIOLOGY_GERIATRICRESERVEEVALUATION_002"
    rule_name = "Epidemiology GeriatricReserveEvaluation Screening Rule #2"
