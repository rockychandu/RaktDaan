"""
Clinical Rule Processor for Infectious - Brucellosis.
...
class BrucellosisClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Brucellosis.
    """
    rule_code = "RULE_INFECTIOUS_BRUCELLOSIS"
    rule_name = "Brucellosis Screening Rule"
    category = "INFECTIOUS"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_brucellosis", False)
        is_active = data.get("is_brucellosis_active", False)
        years_cured = data.get("years_cured_brucellosis", 0.0)
