"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - ImmuneComplexRejection (3).
...
class OphthalmologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Ophthalmology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Ophthalmology ImmuneComplexRejection Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Ophthalmology (ImmuneComplexRejection)."""
        has_primary = donor_payload.get("has_ophthalmology_immunecomplexrejection_primary", False)
        severity_score = donor_payload.get("ophthalmology_immunecomplexrejection_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("ophthalmology_immunecomplexrejection_lab_marker", 10.0)
