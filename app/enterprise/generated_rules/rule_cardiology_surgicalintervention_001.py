"""
Enterprise Clinical Screening & Medical Rule Engine: Cardiology - SurgicalIntervention (1).
...
class CardiologySurgicalInterventionClinicalProcessor1:
    """
    Detailed decision processor evaluating Cardiology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CARDIOLOGY_SURGICALINTERVENTION_001"
    rule_name = "Cardiology SurgicalIntervention Screening Rule #1"
    category = "CARDIOLOGY"
