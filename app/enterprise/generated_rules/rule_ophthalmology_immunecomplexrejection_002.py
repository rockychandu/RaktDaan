"""
Enterprise Clinical Screening & Medical Rule Engine: Ophthalmology - ImmuneComplexRejection (2).
...
class OphthalmologyImmuneComplexRejectionClinicalProcessor2:
    """
    Detailed decision processor evaluating Ophthalmology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OPHTHALMOLOGY_IMMUNECOMPLEXREJECTION_002"
    rule_name = "Ophthalmology ImmuneComplexRejection Screening Rule #2"
