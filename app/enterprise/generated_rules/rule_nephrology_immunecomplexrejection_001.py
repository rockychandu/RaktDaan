"""
Enterprise Clinical Screening & Medical Rule Engine: Nephrology - ImmuneComplexRejection (1).
...
class NephrologyImmuneComplexRejectionClinicalProcessor1:
    """
    Detailed decision processor evaluating Nephrology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEPHROLOGY_IMMUNECOMPLEXREJECTION_001"
    rule_name = "Nephrology ImmuneComplexRejection Screening Rule #1"
    category = "NEPHROLOGY"
