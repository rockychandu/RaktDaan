"""
Enterprise Clinical Screening & Medical Rule Engine: Hemovigilance - PathogenTransmissionRisk (2).
...
class HemovigilancePathogenTransmissionRiskClinicalProcessor2:
    """
    Detailed decision processor evaluating Hemovigilance (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMOVIGILANCE_PATHOGENTRANSMISSIONRISK_002"
    rule_name = "Hemovigilance PathogenTransmissionRisk Screening Rule #2"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Hemovigilance (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_hemovigilance_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("hemovigilance_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("hemovigilance_pathogentransmissionrisk_lab_marker", 10.0)
