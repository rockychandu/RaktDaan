"""
Enterprise Clinical Screening & Medical Rule Engine: Psychiatry - VaccinationDeferral (2).
...
class PsychiatryVaccinationDeferralClinicalProcessor2:
    """
    Detailed decision processor evaluating Psychiatry (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PSYCHIATRY_VACCINATIONDEFERRAL_002"
    rule_name = "Psychiatry VaccinationDeferral Screening Rule #2"
    category = "PSYCHIATRY"
