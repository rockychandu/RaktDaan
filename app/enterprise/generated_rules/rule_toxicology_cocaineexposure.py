"""
Clinical Rule Processor for Toxicology - CocaineExposure.
...
class CocaineExposureClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CocaineExposure.
    """
    rule_code = "RULE_TOXICOLOGY_COCAINEEXPOSURE"
    rule_name = "CocaineExposure Screening Rule"
    category = "TOXICOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_cocaineexposure", False)
        is_active = data.get("is_cocaineexposure_active", False)
        years_cured = data.get("years_cured_cocaineexposure", 0.0)
