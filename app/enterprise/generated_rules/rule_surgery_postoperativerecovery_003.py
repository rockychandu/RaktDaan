"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - PostOperativeRecovery (3).
...
class SurgeryPostOperativeRecoveryClinicalProcessor3:
    """
    Detailed decision processor evaluating Surgery (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_POSTOPERATIVERECOVERY_003"
    rule_name = "Surgery PostOperativeRecovery Screening Rule #3"
    category = "SURGERY"
