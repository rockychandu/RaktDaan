"""
Enterprise Clinical Screening & Medical Rule Engine: Toxicology - SurgicalIntervention (2).
...
class ToxicologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Toxicology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TOXICOLOGY_SURGICALINTERVENTION_002"
    rule_name = "Toxicology SurgicalIntervention Screening Rule #2"
    category = "TOXICOLOGY"
