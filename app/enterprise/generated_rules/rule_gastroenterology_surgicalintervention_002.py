"""
Enterprise Clinical Screening & Medical Rule Engine: Gastroenterology - SurgicalIntervention (2).
...
class GastroenterologySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Gastroenterology (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_GASTROENTEROLOGY_SURGICALINTERVENTION_002"
    rule_name = "Gastroenterology SurgicalIntervention Screening Rule #2"
