"""
Enterprise Clinical Screening & Medical Rule Engine: Obstetrics - GeriatricReserveEvaluation (2).
...
class ObstetricsGeriatricReserveEvaluationClinicalProcessor2:
    """
    Detailed decision processor evaluating Obstetrics (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_OBSTETRICS_GERIATRICRESERVEEVALUATION_002"
    rule_name = "Obstetrics GeriatricReserveEvaluation Screening Rule #2"
    category = "OBSTETRICS"
