"""
Clinical Rule Processor for Endocrinology - CushingsSyndrome.
...
class CushingsSyndromeClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for CushingsSyndrome.
    """
    rule_code = "RULE_ENDOCRINOLOGY_CUSHINGSSYNDROME"
    rule_name = "CushingsSyndrome Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_cushingssyndrome", False)
        is_active = data.get("is_cushingssyndrome_active", False)
        years_cured = data.get("years_cured_cushingssyndrome", 0.0)
