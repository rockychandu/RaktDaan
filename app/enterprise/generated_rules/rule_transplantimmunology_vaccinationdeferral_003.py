"""
Enterprise Clinical Screening & Medical Rule Engine: TransplantImmunology - VaccinationDeferral (3).
...
class TransplantImmunologyVaccinationDeferralClinicalProcessor3:
    """
    Detailed decision processor evaluating TransplantImmunology (VaccinationDeferral) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TRANSPLANTIMMUNOLOGY_VACCINATIONDEFERRAL_003"
    rule_name = "TransplantImmunology VaccinationDeferral Screening Rule #3"
