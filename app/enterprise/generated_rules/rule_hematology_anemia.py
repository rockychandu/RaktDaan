"""
Clinical Rule Processor for Hematology - Anemia.
...
class AnemiaClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Anemia.
    """
    rule_code = "RULE_HEMATOLOGY_ANEMIA"
    rule_name = "Anemia Screening Rule"
    category = "HEMATOLOGY"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_anemia", False)
        is_active = data.get("is_anemia_active", False)
        years_cured = data.get("years_cured_anemia", 0.0)
