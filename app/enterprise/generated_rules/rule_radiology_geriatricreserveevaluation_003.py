"""
Enterprise Clinical Screening & Medical Rule Engine: Radiology - GeriatricReserveEvaluation (3).
...
class RadiologyGeriatricReserveEvaluationClinicalProcessor3:
    """
    Detailed decision processor evaluating Radiology (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RADIOLOGY_GERIATRICRESERVEEVALUATION_003"
    rule_name = "Radiology GeriatricReserveEvaluation Screening Rule #3"
    category = "RADIOLOGY"
