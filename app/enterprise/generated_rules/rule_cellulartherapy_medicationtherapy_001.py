"""
Enterprise Clinical Screening & Medical Rule Engine: CellularTherapy - MedicationTherapy (1).
...
class CellularTherapyMedicationTherapyClinicalProcessor1:
    """
    Detailed decision processor evaluating CellularTherapy (MedicationTherapy) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_CELLULARTHERAPY_MEDICATIONTHERAPY_001"
    rule_name = "CellularTherapy MedicationTherapy Screening Rule #1"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for CellularTherapy (MedicationTherapy)."""
        has_primary = donor_payload.get("has_cellulartherapy_medicationtherapy_primary", False)
        severity_score = donor_payload.get("cellulartherapy_medicationtherapy_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("cellulartherapy_medicationtherapy_lab_marker", 10.0)
