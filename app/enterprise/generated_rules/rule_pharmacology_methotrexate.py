"""
Clinical Rule Processor for Pharmacology - Methotrexate.
...
class MethotrexateClinicalRuleProcessor:
    """
    Evaluates donor safety and recipient transmission risk for Methotrexate.
    """
    rule_code = "RULE_PHARMACOLOGY_METHOTREXATE"
    rule_name = "Methotrexate Screening Rule"
    ...
    def evaluate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        has_condition = data.get("has_methotrexate", False)
        is_active = data.get("is_methotrexate_active", False)
        years_cured = data.get("years_cured_methotrexate", 0.0)
