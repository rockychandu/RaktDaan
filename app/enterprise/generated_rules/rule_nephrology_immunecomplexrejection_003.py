"""
Enterprise Clinical Screening & Medical Rule Engine: Nephrology - ImmuneComplexRejection (3).
...
class NephrologyImmuneComplexRejectionClinicalProcessor3:
    """
    Detailed decision processor evaluating Nephrology (ImmuneComplexRejection) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEPHROLOGY_IMMUNECOMPLEXREJECTION_003"
    rule_name = "Nephrology ImmuneComplexRejection Screening Rule #3"
    category = "NEPHROLOGY"
