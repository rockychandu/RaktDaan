"""
Enterprise Clinical Screening & Medical Rule Engine: Neurology - EndemicTravelExposure (3).
...
class NeurologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Neurology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_NEUROLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Neurology EndemicTravelExposure Screening Rule #3"
    category = "NEUROLOGY"
