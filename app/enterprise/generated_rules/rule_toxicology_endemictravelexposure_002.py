"""
Enterprise Clinical Screening & Medical Rule Engine: Toxicology - EndemicTravelExposure (2).
...
class ToxicologyEndemicTravelExposureClinicalProcessor2:
    """
    Detailed decision processor evaluating Toxicology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_TOXICOLOGY_ENDEMICTRAVELEXPOSURE_002"
    rule_name = "Toxicology EndemicTravelExposure Screening Rule #2"
    category = "TOXICOLOGY"
