"""
Enterprise Clinical Screening & Medical Rule Engine: Surgery - SurgicalIntervention (2).
...
class SurgerySurgicalInterventionClinicalProcessor2:
    """
    Detailed decision processor evaluating Surgery (SurgicalIntervention) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_SURGERY_SURGICALINTERVENTION_002"
    rule_name = "Surgery SurgicalIntervention Screening Rule #2"
    category = "SURGERY"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Surgery (SurgicalIntervention)."""
        has_primary = donor_payload.get("has_surgery_surgicalintervention_primary", False)
        severity_score = donor_payload.get("surgery_surgicalintervention_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("surgery_surgicalintervention_lab_marker", 10.0)
