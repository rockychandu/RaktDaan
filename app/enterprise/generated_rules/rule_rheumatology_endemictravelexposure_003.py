"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - EndemicTravelExposure (3).
...
class RheumatologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Rheumatology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Rheumatology EndemicTravelExposure Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Rheumatology (EndemicTravelExposure)."""
        has_primary = donor_payload.get("has_rheumatology_endemictravelexposure_primary", False)
        severity_score = donor_payload.get("rheumatology_endemictravelexposure_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("rheumatology_endemictravelexposure_lab_marker", 10.0)
