"""
Enterprise Clinical Screening & Medical Rule Engine: Apheresis - GeriatricReserveEvaluation (1).
...
class ApheresisGeriatricReserveEvaluationClinicalProcessor1:
    """
    Detailed decision processor evaluating Apheresis (GeriatricReserveEvaluation) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_APHERESIS_GERIATRICRESERVEEVALUATION_001"
    rule_name = "Apheresis GeriatricReserveEvaluation Screening Rule #1"
    category = "APHERESIS"
