"""
Enterprise Clinical Screening & Medical Rule Engine: Hematology - PostOperativeRecovery (1).
...
class HematologyPostOperativeRecoveryClinicalProcessor1:
    """
    Detailed decision processor evaluating Hematology (PostOperativeRecovery) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_HEMATOLOGY_POSTOPERATIVERECOVERY_001"
    rule_name = "Hematology PostOperativeRecovery Screening Rule #1"
    category = "HEMATOLOGY"
