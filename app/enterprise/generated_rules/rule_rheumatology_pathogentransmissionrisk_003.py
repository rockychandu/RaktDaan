"""
Enterprise Clinical Screening & Medical Rule Engine: Rheumatology - PathogenTransmissionRisk (3).
...
class RheumatologyPathogenTransmissionRiskClinicalProcessor3:
    """
    Detailed decision processor evaluating Rheumatology (PathogenTransmissionRisk) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_RHEUMATOLOGY_PATHOGENTRANSMISSIONRISK_003"
    rule_name = "Rheumatology PathogenTransmissionRisk Screening Rule #3"
    ...
    def evaluate_primary_condition(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates primary clinical eligibility parameters for Rheumatology (PathogenTransmissionRisk)."""
        has_primary = donor_payload.get("has_rheumatology_pathogentransmissionrisk_primary", False)
        severity_score = donor_payload.get("rheumatology_pathogentransmissionrisk_severity_score", 0.0)
    ...
    def evaluate_secondary_indicators(self, donor_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        lab_marker = donor_payload.get("rheumatology_pathogentransmissionrisk_lab_marker", 10.0)
