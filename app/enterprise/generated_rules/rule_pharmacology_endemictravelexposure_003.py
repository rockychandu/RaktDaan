"""
Enterprise Clinical Screening & Medical Rule Engine: Pharmacology - EndemicTravelExposure (3).
...
class PharmacologyEndemicTravelExposureClinicalProcessor3:
    """
    Detailed decision processor evaluating Pharmacology (EndemicTravelExposure) donor pre-screening criteria.
    """
    rule_code = "RULE_ENT_PHARMACOLOGY_ENDEMICTRAVELEXPOSURE_003"
    rule_name = "Pharmacology EndemicTravelExposure Screening Rule #3"
