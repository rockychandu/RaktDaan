"""
Automated Test Suite for Genetics - PediatricSafetyProtocol (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_genetics_pediatricsafetyprotocol_003 import GeneticsPediatricSafetyProtocolClinicalProcessor3


def test_genetics_pediatricsafetyprotocol_3_evaluation():
    processor = GeneticsPediatricSafetyProtocolClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_genetics_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GENETICS_PEDIATRICSAFETYPROTOCOL_003"
