"""
Automated Test Suite for InfectiousDisease - GeneticRiskFactor (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_infectiousdisease_geneticriskfactor_001 import InfectiousDiseaseGeneticRiskFactorClinicalProcessor1


def test_infectiousdisease_geneticriskfactor_1_evaluation():
    processor = InfectiousDiseaseGeneticRiskFactorClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_infectiousdisease_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_INFECTIOUSDISEASE_GENETICRISKFACTOR_001"
