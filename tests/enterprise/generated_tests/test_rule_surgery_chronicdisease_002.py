"""
Automated Test Suite for Surgery - ChronicDisease (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_surgery_chronicdisease_002 import SurgeryChronicDiseaseClinicalProcessor2


def test_surgery_chronicdisease_2_evaluation():
    processor = SurgeryChronicDiseaseClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_surgery_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_SURGERY_CHRONICDISEASE_002"
