"""
Automated Test Suite for Oncology - MedicationTherapy (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_oncology_medicationtherapy_002 import OncologyMedicationTherapyClinicalProcessor2


def test_oncology_medicationtherapy_2_evaluation():
    processor = OncologyMedicationTherapyClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_oncology_medicationtherapy_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ONCOLOGY_MEDICATIONTHERAPY_002"
