"""
Automated Test Suite for Dentistry - GeneticRiskFactor (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_dentistry_geneticriskfactor_002 import DentistryGeneticRiskFactorClinicalProcessor2


def test_dentistry_geneticriskfactor_2_evaluation():
    processor = DentistryGeneticRiskFactorClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_dentistry_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_DENTISTRY_GENETICRISKFACTOR_002"
