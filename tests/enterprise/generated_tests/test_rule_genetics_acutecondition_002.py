"""
Automated Test Suite for Genetics - AcuteCondition (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_genetics_acutecondition_002 import GeneticsAcuteConditionClinicalProcessor2


def test_genetics_acutecondition_2_evaluation():
    processor = GeneticsAcuteConditionClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_genetics_acutecondition_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GENETICS_ACUTECONDITION_002"
