"""
Automated Test Suite for Dermatology - AcuteCondition (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_dermatology_acutecondition_001 import DermatologyAcuteConditionClinicalProcessor1


def test_dermatology_acutecondition_1_evaluation():
    processor = DermatologyAcuteConditionClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_dermatology_acutecondition_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_DERMATOLOGY_ACUTECONDITION_001"
