"""
Automated Test Suite for Immunology - VaccinationDeferral (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_immunology_vaccinationdeferral_001 import ImmunologyVaccinationDeferralClinicalProcessor1


def test_immunology_vaccinationdeferral_1_evaluation():
    processor = ImmunologyVaccinationDeferralClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_immunology_vaccinationdeferral_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_IMMUNOLOGY_VACCINATIONDEFERRAL_001"
