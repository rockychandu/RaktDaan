"""
Automated Test Suite for Dermatology - ChronicDisease (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_dermatology_chronicdisease_001 import DermatologyChronicDiseaseClinicalProcessor1


def test_dermatology_chronicdisease_1_evaluation():
    processor = DermatologyChronicDiseaseClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_dermatology_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_DERMATOLOGY_CHRONICDISEASE_001"
