"""
Automated Test Suite for InfectiousDisease - GeneticRiskFactor (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_infectiousdisease_geneticriskfactor_002 import InfectiousDiseaseGeneticRiskFactorClinicalProcessor2


def test_infectiousdisease_geneticriskfactor_2_evaluation():
    processor = InfectiousDiseaseGeneticRiskFactorClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_infectiousdisease_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_INFECTIOUSDISEASE_GENETICRISKFACTOR_002"
