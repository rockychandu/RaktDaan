"""
Automated Test Suite for ClinicalPathology - PostOperativeRecovery (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_clinicalpathology_postoperativerecovery_003 import ClinicalPathologyPostOperativeRecoveryClinicalProcessor3


def test_clinicalpathology_postoperativerecovery_3_evaluation():
    processor = ClinicalPathologyPostOperativeRecoveryClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_clinicalpathology_postoperativerecovery_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_CLINICALPATHOLOGY_POSTOPERATIVERECOVERY_003"
