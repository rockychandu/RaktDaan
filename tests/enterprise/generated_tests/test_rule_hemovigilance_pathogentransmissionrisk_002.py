"""
Automated Test Suite for Hemovigilance - PathogenTransmissionRisk (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_hemovigilance_pathogentransmissionrisk_002 import HemovigilancePathogenTransmissionRiskClinicalProcessor2


def test_hemovigilance_pathogentransmissionrisk_2_evaluation():
    processor = HemovigilancePathogenTransmissionRiskClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_hemovigilance_pathogentransmissionrisk_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_HEMOVIGILANCE_PATHOGENTRANSMISSIONRISK_002"
