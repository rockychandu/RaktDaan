"""
Automated Test Suite for GeneTherapy - HemodynamicsAssessment (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_genetherapy_hemodynamicsassessment_001 import GeneTherapyHemodynamicsAssessmentClinicalProcessor1


def test_genetherapy_hemodynamicsassessment_1_evaluation():
    processor = GeneTherapyHemodynamicsAssessmentClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_genetherapy_hemodynamicsassessment_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GENETHERAPY_HEMODYNAMICSASSESSMENT_001"
