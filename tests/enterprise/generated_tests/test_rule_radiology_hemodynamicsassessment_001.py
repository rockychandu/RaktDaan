"""
Automated Test Suite for Radiology - HemodynamicsAssessment (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_radiology_hemodynamicsassessment_001 import RadiologyHemodynamicsAssessmentClinicalProcessor1


def test_radiology_hemodynamicsassessment_1_evaluation():
    processor = RadiologyHemodynamicsAssessmentClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_radiology_hemodynamicsassessment_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_RADIOLOGY_HEMODYNAMICSASSESSMENT_001"
