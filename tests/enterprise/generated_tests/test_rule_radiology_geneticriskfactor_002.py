"""
Automated Test Suite for Radiology - GeneticRiskFactor (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_radiology_geneticriskfactor_002 import RadiologyGeneticRiskFactorClinicalProcessor2


def test_radiology_geneticriskfactor_2_evaluation():
    processor = RadiologyGeneticRiskFactorClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_radiology_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_RADIOLOGY_GENETICRISKFACTOR_002"
