"""
Automated Test Suite for Surgery - ChronicDisease (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_surgery_chronicdisease_001 import SurgeryChronicDiseaseClinicalProcessor1


def test_surgery_chronicdisease_1_evaluation():
    processor = SurgeryChronicDiseaseClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_surgery_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_SURGERY_CHRONICDISEASE_001"
