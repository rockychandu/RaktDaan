"""
Automated Test Suite for Neurology - PhysiologicalVitalsThreshold (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_neurology_physiologicalvitalsthreshold_002 import NeurologyPhysiologicalVitalsThresholdClinicalProcessor2


def test_neurology_physiologicalvitalsthreshold_2_evaluation():
    processor = NeurologyPhysiologicalVitalsThresholdClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_neurology_physiologicalvitalsthreshold_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_NEUROLOGY_PHYSIOLOGICALVITALSTHRESHOLD_002"
