"""
Automated Test Suite for Hematology - GeneticRiskFactor (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_hematology_geneticriskfactor_002 import HematologyGeneticRiskFactorClinicalProcessor2


def test_hematology_geneticriskfactor_2_evaluation():
    processor = HematologyGeneticRiskFactorClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_hematology_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_HEMATOLOGY_GENETICRISKFACTOR_002"
