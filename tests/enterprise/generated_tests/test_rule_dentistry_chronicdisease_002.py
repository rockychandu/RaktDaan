"""
Automated Test Suite for Dentistry - ChronicDisease (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_dentistry_chronicdisease_002 import DentistryChronicDiseaseClinicalProcessor2


def test_dentistry_chronicdisease_2_evaluation():
    processor = DentistryChronicDiseaseClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_dentistry_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_DENTISTRY_CHRONICDISEASE_002"
