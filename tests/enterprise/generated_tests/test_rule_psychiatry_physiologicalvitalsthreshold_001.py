"""
Automated Test Suite for Psychiatry - PhysiologicalVitalsThreshold (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_psychiatry_physiologicalvitalsthreshold_001 import PsychiatryPhysiologicalVitalsThresholdClinicalProcessor1


def test_psychiatry_physiologicalvitalsthreshold_1_evaluation():
    processor = PsychiatryPhysiologicalVitalsThresholdClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_psychiatry_physiologicalvitalsthreshold_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_PSYCHIATRY_PHYSIOLOGICALVITALSTHRESHOLD_001"
