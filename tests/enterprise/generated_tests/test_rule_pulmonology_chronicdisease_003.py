"""
Automated Test Suite for Pulmonology - ChronicDisease (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_pulmonology_chronicdisease_003 import PulmonologyChronicDiseaseClinicalProcessor3


def test_pulmonology_chronicdisease_3_evaluation():
    processor = PulmonologyChronicDiseaseClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_pulmonology_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_PULMONOLOGY_CHRONICDISEASE_003"
