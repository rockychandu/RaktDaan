"""
Automated Test Suite for Obstetrics - GeneticRiskFactor (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_obstetrics_geneticriskfactor_003 import ObstetricsGeneticRiskFactorClinicalProcessor3


def test_obstetrics_geneticriskfactor_3_evaluation():
    processor = ObstetricsGeneticRiskFactorClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_obstetrics_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_OBSTETRICS_GENETICRISKFACTOR_003"
