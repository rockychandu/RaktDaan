"""
Automated Test Suite for Epidemiology - VaccinationDeferral (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_epidemiology_vaccinationdeferral_003 import EpidemiologyVaccinationDeferralClinicalProcessor3


def test_epidemiology_vaccinationdeferral_3_evaluation():
    processor = EpidemiologyVaccinationDeferralClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_epidemiology_vaccinationdeferral_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_EPIDEMIOLOGY_VACCINATIONDEFERRAL_003"
