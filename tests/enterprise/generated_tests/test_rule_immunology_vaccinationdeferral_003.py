"""
Automated Test Suite for Immunology - VaccinationDeferral (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_immunology_vaccinationdeferral_003 import ImmunologyVaccinationDeferralClinicalProcessor3


def test_immunology_vaccinationdeferral_3_evaluation():
    processor = ImmunologyVaccinationDeferralClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_immunology_vaccinationdeferral_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_IMMUNOLOGY_VACCINATIONDEFERRAL_003"
