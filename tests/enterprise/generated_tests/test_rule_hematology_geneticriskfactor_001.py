"""
Automated Test Suite for Hematology - GeneticRiskFactor (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_hematology_geneticriskfactor_001 import HematologyGeneticRiskFactorClinicalProcessor1


def test_hematology_geneticriskfactor_1_evaluation():
    processor = HematologyGeneticRiskFactorClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_hematology_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_HEMATOLOGY_GENETICRISKFACTOR_001"
