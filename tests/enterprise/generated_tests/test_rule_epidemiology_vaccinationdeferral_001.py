"""
Automated Test Suite for Epidemiology - VaccinationDeferral (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_epidemiology_vaccinationdeferral_001 import EpidemiologyVaccinationDeferralClinicalProcessor1


def test_epidemiology_vaccinationdeferral_1_evaluation():
    processor = EpidemiologyVaccinationDeferralClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_epidemiology_vaccinationdeferral_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_EPIDEMIOLOGY_VACCINATIONDEFERRAL_001"
