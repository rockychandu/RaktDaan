"""
Automated Test Suite for Geriatrics - PediatricSafetyProtocol (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_geriatrics_pediatricsafetyprotocol_002 import GeriatricsPediatricSafetyProtocolClinicalProcessor2


def test_geriatrics_pediatricsafetyprotocol_2_evaluation():
    processor = GeriatricsPediatricSafetyProtocolClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_geriatrics_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GERIATRICS_PEDIATRICSAFETYPROTOCOL_002"
