"""
Automated Test Suite for Cardiology - PostOperativeRecovery (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_cardiology_postoperativerecovery_002 import CardiologyPostOperativeRecoveryClinicalProcessor2


def test_cardiology_postoperativerecovery_2_evaluation():
    processor = CardiologyPostOperativeRecoveryClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_cardiology_postoperativerecovery_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_CARDIOLOGY_POSTOPERATIVERECOVERY_002"
