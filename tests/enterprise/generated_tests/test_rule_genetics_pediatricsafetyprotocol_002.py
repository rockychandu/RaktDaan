"""
Automated Test Suite for Genetics - PediatricSafetyProtocol (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_genetics_pediatricsafetyprotocol_002 import GeneticsPediatricSafetyProtocolClinicalProcessor2


def test_genetics_pediatricsafetyprotocol_2_evaluation():
    processor = GeneticsPediatricSafetyProtocolClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_genetics_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GENETICS_PEDIATRICSAFETYPROTOCOL_002"
