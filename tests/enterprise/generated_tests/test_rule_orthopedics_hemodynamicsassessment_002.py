"""
Automated Test Suite for Orthopedics - HemodynamicsAssessment (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_orthopedics_hemodynamicsassessment_002 import OrthopedicsHemodynamicsAssessmentClinicalProcessor2


def test_orthopedics_hemodynamicsassessment_2_evaluation():
    processor = OrthopedicsHemodynamicsAssessmentClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_orthopedics_hemodynamicsassessment_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ORTHOPEDICS_HEMODYNAMICSASSESSMENT_002"
