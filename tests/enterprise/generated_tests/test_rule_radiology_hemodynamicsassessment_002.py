"""
Automated Test Suite for Radiology - HemodynamicsAssessment (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_radiology_hemodynamicsassessment_002 import RadiologyHemodynamicsAssessmentClinicalProcessor2


def test_radiology_hemodynamicsassessment_2_evaluation():
    processor = RadiologyHemodynamicsAssessmentClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_radiology_hemodynamicsassessment_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_RADIOLOGY_HEMODYNAMICSASSESSMENT_002"
