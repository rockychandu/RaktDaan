"""
Automated Test Suite for Orthopedics - HemodynamicsAssessment (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_orthopedics_hemodynamicsassessment_001 import OrthopedicsHemodynamicsAssessmentClinicalProcessor1


def test_orthopedics_hemodynamicsassessment_1_evaluation():
    processor = OrthopedicsHemodynamicsAssessmentClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_orthopedics_hemodynamicsassessment_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ORTHOPEDICS_HEMODYNAMICSASSESSMENT_001"
