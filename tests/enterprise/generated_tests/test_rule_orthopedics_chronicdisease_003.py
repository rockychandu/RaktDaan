"""
Automated Test Suite for Orthopedics - ChronicDisease (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_orthopedics_chronicdisease_003 import OrthopedicsChronicDiseaseClinicalProcessor3


def test_orthopedics_chronicdisease_3_evaluation():
    processor = OrthopedicsChronicDiseaseClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_orthopedics_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ORTHOPEDICS_CHRONICDISEASE_003"
