"""
Automated Test Suite for Hemovigilance - PathogenTransmissionRisk (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_hemovigilance_pathogentransmissionrisk_001 import HemovigilancePathogenTransmissionRiskClinicalProcessor1


def test_hemovigilance_pathogentransmissionrisk_1_evaluation():
    processor = HemovigilancePathogenTransmissionRiskClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_hemovigilance_pathogentransmissionrisk_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_HEMOVIGILANCE_PATHOGENTRANSMISSIONRISK_001"
