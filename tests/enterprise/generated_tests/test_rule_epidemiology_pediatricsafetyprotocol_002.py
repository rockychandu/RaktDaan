"""
Automated Test Suite for Epidemiology - PediatricSafetyProtocol (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_epidemiology_pediatricsafetyprotocol_002 import EpidemiologyPediatricSafetyProtocolClinicalProcessor2


def test_epidemiology_pediatricsafetyprotocol_2_evaluation():
    processor = EpidemiologyPediatricSafetyProtocolClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_epidemiology_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_EPIDEMIOLOGY_PEDIATRICSAFETYPROTOCOL_002"
