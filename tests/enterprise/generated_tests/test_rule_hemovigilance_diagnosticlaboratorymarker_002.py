"""
Automated Test Suite for Hemovigilance - DiagnosticLaboratoryMarker (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_hemovigilance_diagnosticlaboratorymarker_002 import HemovigilanceDiagnosticLaboratoryMarkerClinicalProcessor2


def test_hemovigilance_diagnosticlaboratorymarker_2_evaluation():
    processor = HemovigilanceDiagnosticLaboratoryMarkerClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_hemovigilance_diagnosticlaboratorymarker_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_HEMOVIGILANCE_DIAGNOSTICLABORATORYMARKER_002"
