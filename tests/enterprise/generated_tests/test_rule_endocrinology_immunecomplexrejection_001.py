"""
Automated Test Suite for Endocrinology - ImmuneComplexRejection (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_endocrinology_immunecomplexrejection_001 import EndocrinologyImmuneComplexRejectionClinicalProcessor1


def test_endocrinology_immunecomplexrejection_1_evaluation():
    processor = EndocrinologyImmuneComplexRejectionClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_endocrinology_immunecomplexrejection_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ENDOCRINOLOGY_IMMUNECOMPLEXREJECTION_001"
