"""
Automated Test Suite for CellularTherapy - DiagnosticLaboratoryMarker (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_cellulartherapy_diagnosticlaboratorymarker_003 import CellularTherapyDiagnosticLaboratoryMarkerClinicalProcessor3


def test_cellulartherapy_diagnosticlaboratorymarker_3_evaluation():
    processor = CellularTherapyDiagnosticLaboratoryMarkerClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_cellulartherapy_diagnosticlaboratorymarker_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_CELLULARTHERAPY_DIAGNOSTICLABORATORYMARKER_003"
