"""
Automated Test Suite for Dentistry - ChronicDisease (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_dentistry_chronicdisease_001 import DentistryChronicDiseaseClinicalProcessor1


def test_dentistry_chronicdisease_1_evaluation():
    processor = DentistryChronicDiseaseClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_dentistry_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_DENTISTRY_CHRONICDISEASE_001"
