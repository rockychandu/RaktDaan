"""
Automated Test Suite for Geriatrics - PediatricSafetyProtocol (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_geriatrics_pediatricsafetyprotocol_001 import GeriatricsPediatricSafetyProtocolClinicalProcessor1


def test_geriatrics_pediatricsafetyprotocol_1_evaluation():
    processor = GeriatricsPediatricSafetyProtocolClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_geriatrics_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GERIATRICS_PEDIATRICSAFETYPROTOCOL_001"
