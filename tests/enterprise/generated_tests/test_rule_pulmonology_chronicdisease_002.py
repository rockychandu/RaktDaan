"""
Automated Test Suite for Pulmonology - ChronicDisease (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_pulmonology_chronicdisease_002 import PulmonologyChronicDiseaseClinicalProcessor2


def test_pulmonology_chronicdisease_2_evaluation():
    processor = PulmonologyChronicDiseaseClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_pulmonology_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_PULMONOLOGY_CHRONICDISEASE_002"
