"""
Automated Test Suite for Hemovigilance - DiagnosticLaboratoryMarker (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_hemovigilance_diagnosticlaboratorymarker_003 import HemovigilanceDiagnosticLaboratoryMarkerClinicalProcessor3


def test_hemovigilance_diagnosticlaboratorymarker_3_evaluation():
    processor = HemovigilanceDiagnosticLaboratoryMarkerClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_hemovigilance_diagnosticlaboratorymarker_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_HEMOVIGILANCE_DIAGNOSTICLABORATORYMARKER_003"
