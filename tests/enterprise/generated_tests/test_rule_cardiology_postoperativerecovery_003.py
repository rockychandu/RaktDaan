"""
Automated Test Suite for Cardiology - PostOperativeRecovery (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_cardiology_postoperativerecovery_003 import CardiologyPostOperativeRecoveryClinicalProcessor3


def test_cardiology_postoperativerecovery_3_evaluation():
    processor = CardiologyPostOperativeRecoveryClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_cardiology_postoperativerecovery_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_CARDIOLOGY_POSTOPERATIVERECOVERY_003"
