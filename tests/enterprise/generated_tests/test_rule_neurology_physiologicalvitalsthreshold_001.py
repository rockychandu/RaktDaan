"""
Automated Test Suite for Neurology - PhysiologicalVitalsThreshold (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_neurology_physiologicalvitalsthreshold_001 import NeurologyPhysiologicalVitalsThresholdClinicalProcessor1


def test_neurology_physiologicalvitalsthreshold_1_evaluation():
    processor = NeurologyPhysiologicalVitalsThresholdClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_neurology_physiologicalvitalsthreshold_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_NEUROLOGY_PHYSIOLOGICALVITALSTHRESHOLD_001"
