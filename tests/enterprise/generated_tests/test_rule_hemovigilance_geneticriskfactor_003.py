"""
Automated Test Suite for Hemovigilance - GeneticRiskFactor (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_hemovigilance_geneticriskfactor_003 import HemovigilanceGeneticRiskFactorClinicalProcessor3


def test_hemovigilance_geneticriskfactor_3_evaluation():
    processor = HemovigilanceGeneticRiskFactorClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_hemovigilance_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_HEMOVIGILANCE_GENETICRISKFACTOR_003"
