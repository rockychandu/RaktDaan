"""
Automated Test Suite for CellularTherapy - PediatricSafetyProtocol (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_cellulartherapy_pediatricsafetyprotocol_001 import CellularTherapyPediatricSafetyProtocolClinicalProcessor1


def test_cellulartherapy_pediatricsafetyprotocol_1_evaluation():
    processor = CellularTherapyPediatricSafetyProtocolClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_cellulartherapy_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_CELLULARTHERAPY_PEDIATRICSAFETYPROTOCOL_001"
