"""
Automated Test Suite for Endocrinology - PathogenTransmissionRisk (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_endocrinology_pathogentransmissionrisk_003 import EndocrinologyPathogenTransmissionRiskClinicalProcessor3


def test_endocrinology_pathogentransmissionrisk_3_evaluation():
    processor = EndocrinologyPathogenTransmissionRiskClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_endocrinology_pathogentransmissionrisk_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ENDOCRINOLOGY_PATHOGENTRANSMISSIONRISK_003"
