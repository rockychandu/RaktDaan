"""
Automated Test Suite for Genetics - AcuteCondition (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_genetics_acutecondition_003 import GeneticsAcuteConditionClinicalProcessor3


def test_genetics_acutecondition_3_evaluation():
    processor = GeneticsAcuteConditionClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_genetics_acutecondition_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GENETICS_ACUTECONDITION_003"
