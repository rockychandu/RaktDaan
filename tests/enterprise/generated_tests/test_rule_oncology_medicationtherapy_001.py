"""
Automated Test Suite for Oncology - MedicationTherapy (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_oncology_medicationtherapy_001 import OncologyMedicationTherapyClinicalProcessor1


def test_oncology_medicationtherapy_1_evaluation():
    processor = OncologyMedicationTherapyClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_oncology_medicationtherapy_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ONCOLOGY_MEDICATIONTHERAPY_001"
