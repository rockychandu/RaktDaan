"""
Automated Test Suite for Obstetrics - GeneticRiskFactor (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_obstetrics_geneticriskfactor_001 import ObstetricsGeneticRiskFactorClinicalProcessor1


def test_obstetrics_geneticriskfactor_1_evaluation():
    processor = ObstetricsGeneticRiskFactorClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_obstetrics_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_OBSTETRICS_GENETICRISKFACTOR_001"
