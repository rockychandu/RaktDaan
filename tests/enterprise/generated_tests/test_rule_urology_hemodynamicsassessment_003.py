"""
Automated Test Suite for Urology - HemodynamicsAssessment (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_urology_hemodynamicsassessment_003 import UrologyHemodynamicsAssessmentClinicalProcessor3


def test_urology_hemodynamicsassessment_3_evaluation():
    processor = UrologyHemodynamicsAssessmentClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_urology_hemodynamicsassessment_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_UROLOGY_HEMODYNAMICSASSESSMENT_003"
