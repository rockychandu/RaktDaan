"""
Automated Test Suite for Pharmacology - MedicationTherapy (1) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_pharmacology_medicationtherapy_001 import PharmacologyMedicationTherapyClinicalProcessor1


def test_pharmacology_medicationtherapy_1_evaluation():
    processor = PharmacologyMedicationTherapyClinicalProcessor1()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_pharmacology_medicationtherapy_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_PHARMACOLOGY_MEDICATIONTHERAPY_001"
