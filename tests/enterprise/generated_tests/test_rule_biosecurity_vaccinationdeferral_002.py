"""
Automated Test Suite for Biosecurity - VaccinationDeferral (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_biosecurity_vaccinationdeferral_002 import BiosecurityVaccinationDeferralClinicalProcessor2


def test_biosecurity_vaccinationdeferral_2_evaluation():
    processor = BiosecurityVaccinationDeferralClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_biosecurity_vaccinationdeferral_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_BIOSECURITY_VACCINATIONDEFERRAL_002"
