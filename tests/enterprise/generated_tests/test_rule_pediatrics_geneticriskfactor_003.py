"""
Automated Test Suite for Pediatrics - GeneticRiskFactor (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_pediatrics_geneticriskfactor_003 import PediatricsGeneticRiskFactorClinicalProcessor3


def test_pediatrics_geneticriskfactor_3_evaluation():
    processor = PediatricsGeneticRiskFactorClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_pediatrics_geneticriskfactor_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_PEDIATRICS_GENETICRISKFACTOR_003"
