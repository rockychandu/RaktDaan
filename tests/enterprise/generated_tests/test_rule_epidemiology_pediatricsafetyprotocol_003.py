"""
Automated Test Suite for Epidemiology - PediatricSafetyProtocol (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_epidemiology_pediatricsafetyprotocol_003 import EpidemiologyPediatricSafetyProtocolClinicalProcessor3


def test_epidemiology_pediatricsafetyprotocol_3_evaluation():
    processor = EpidemiologyPediatricSafetyProtocolClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_epidemiology_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_EPIDEMIOLOGY_PEDIATRICSAFETYPROTOCOL_003"
