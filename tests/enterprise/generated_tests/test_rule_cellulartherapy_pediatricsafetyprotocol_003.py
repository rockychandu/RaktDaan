"""
Automated Test Suite for CellularTherapy - PediatricSafetyProtocol (3) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_cellulartherapy_pediatricsafetyprotocol_003 import CellularTherapyPediatricSafetyProtocolClinicalProcessor3


def test_cellulartherapy_pediatricsafetyprotocol_3_evaluation():
    processor = CellularTherapyPediatricSafetyProtocolClinicalProcessor3()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_cellulartherapy_pediatricsafetyprotocol_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_CELLULARTHERAPY_PEDIATRICSAFETYPROTOCOL_003"
