"""
Automated Test Suite for GeneTherapy - HemodynamicsAssessment (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_genetherapy_hemodynamicsassessment_002 import GeneTherapyHemodynamicsAssessmentClinicalProcessor2


def test_genetherapy_hemodynamicsassessment_2_evaluation():
    processor = GeneTherapyHemodynamicsAssessmentClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_genetherapy_hemodynamicsassessment_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_GENETHERAPY_HEMODYNAMICSASSESSMENT_002"
