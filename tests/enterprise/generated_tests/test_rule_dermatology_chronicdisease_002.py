"""
Automated Test Suite for Dermatology - ChronicDisease (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_dermatology_chronicdisease_002 import DermatologyChronicDiseaseClinicalProcessor2


def test_dermatology_chronicdisease_2_evaluation():
    processor = DermatologyChronicDiseaseClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_dermatology_chronicdisease_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_DERMATOLOGY_CHRONICDISEASE_002"
