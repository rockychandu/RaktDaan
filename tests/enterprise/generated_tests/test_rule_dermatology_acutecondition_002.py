"""
Automated Test Suite for Dermatology - AcuteCondition (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_dermatology_acutecondition_002 import DermatologyAcuteConditionClinicalProcessor2


def test_dermatology_acutecondition_2_evaluation():
    processor = DermatologyAcuteConditionClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_dermatology_acutecondition_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_DERMATOLOGY_ACUTECONDITION_002"
