"""
Automated Test Suite for Endocrinology - PathogenTransmissionRisk (2) Clinical Rule Processor.
"""

from app.enterprise.generated_rules.rule_endocrinology_pathogentransmissionrisk_002 import EndocrinologyPathogenTransmissionRiskClinicalProcessor2


def test_endocrinology_pathogentransmissionrisk_2_evaluation():
    processor = EndocrinologyPathogenTransmissionRiskClinicalProcessor2()
    
    # Test primary fail
    res_fail = processor.evaluate_primary_condition({"has_endocrinology_pathogentransmissionrisk_primary": True})
    assert res_fail["passed"] is False
    assert res_fail["rule_code"] == "RULE_ENT_ENDOCRINOLOGY_PATHOGENTRANSMISSIONRISK_002"
